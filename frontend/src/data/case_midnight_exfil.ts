...
export const CASE_AGENTS_NPCS: BackendNPC[] = [
  {
    ...
    controversial_ideas: [],
    interested_topics: ["log analysis", "incident response", "forensics"],
    x: 2,
    y: 2,
    mood: "hopeful",
  ...
  },
  {
    ...
    controversial_ideas: [],
    interested_topics: ["network telemetry", "lateral movement", "routing"],
    x: 5,
    y: 2,
    mood: "hopeful",
  ...
  },
  {
    ...
    controversial_ideas: [],
    interested_topics: ["artifact recovery", "steganography", "disk forensics"],
    x: 8,
    y: 2,
    mood: "hopeful",
  ...
  },
  {
    ...
    controversial_ideas: [],
    interested_topics: ["timeline reconstruction", "causality", "event correlation"],
    x: 11,
    y: 2,
    mood: "hopeful",
