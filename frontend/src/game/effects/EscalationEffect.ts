...
/**
 * On severe escalation events: affected NPCs cluster near the command center.
 */
export class EscalationEffect {
  ...
  trigger(affectedNpcIds: string[]) {
    ...
    // Cluster NPCs in front of the command center (below it)
    ...
    // Add a floating escalation marker
