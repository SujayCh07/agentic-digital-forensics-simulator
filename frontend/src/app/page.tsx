  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        ...
        {/* ── Grid glow ────────────────────────────────────────── */}
        <div
          className="pointer-events-none absolute inset-x-0 top-[16%] z-[2] mx-auto h-64 w-[42rem] max-w-[92vw] blur-3xl"
          style={{
            background:
              "radial-gradient(circle, rgba(0,212,255,0.2) 0%, rgba(0,212,255,0.08) 38%, transparent 72%)",
          }}
        />
        ...
        <div
          ...
          style={{
            ...
            maskImage:
              "linear-gradient(180deg, rgba(0,0,0,0.3) 0%, rgba(0,0,0,0.85) 45%, rgba(0,0,0,1) 100%)",
          }}
        />

        {/* ── Perspective floor grid ───────────────────────────── */}
        <div
          className="pointer-events-none absolute inset-x-[-12%] bottom-[-18%] z-[3] h-[46vh] origin-bottom"
          style={{
            backgroundImage:
              "linear-gradient(rgba(0,212,255,0.18) 1px, transparent 1px), linear-gradient(90deg, rgba(0,212,255,0.14) 1px, transparent 1px)",
