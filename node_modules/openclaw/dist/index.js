...
import { t as installUnhandledRejectionHandler } from "./unhandled-rejections-B5n5YHnW.js";
...
async function loadLegacyCliDeps() {
	const [{ installGaxiosFetchCompat }, { runCli }] = await Promise.all([import("./gaxios-fetch-compat-DBxvKM0w.js"), import("./run-main-DnvUflns.js")]);
	return {
...
if (!isMain) ({applyTemplate, createDefaultDeps, deriveSessionKey, describePortOwner, ensureBinary, ensurePortAvailable, getReplyFromConfig, handlePortError, loadConfig, loadSessionStore, monitorWebChannel, normalizeE164, PortInUseError, promptYesNo, resolveSessionKey, resolveStorePath, runCommandWithTimeout, runExec, saveSessionStore, waitForever} = await import("./library-D7Ih3S7l.js"));
if (isMain) {
	const { restoreTerminalState } = await import("./restore-ADlpnb-M.js");
