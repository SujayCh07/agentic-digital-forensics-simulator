...
import { a as createWebhookInFlightLimiter, t as WEBHOOK_BODY_READ_DEFAULTS } from "./webhook-request-guards-cHG4GJsG.js";
import "./webhook-ingress-lquZa6ui.js";
import { t as zod_exports } from "./zod-BbINiS6U.js";
import "./api-vvyK7KBG.js";
import { a as deepMergeDefined, i as validateProviderConfig, n as normalizeVoiceCallConfig, r as resolveVoiceCallConfig } from "./config-BxAAniPE.js";
import { n as mapVoiceToPolly, t as escapeXml } from "./voice-mapping-CpCaBi6z.js";
import { a as convertPcmToMulaw8k, t as isProviderStatusTerminal } from "./call-status-B8A6HPiJ.js";
import { t as getHeader } from "./http-headers-CcLEtfMe.js";
...
var VoiceCallWebhookServer = class {
	...
	*/
	async initializeMediaStreaming() {
		...
		const { getRealtimeTranscriptionProvider, listRealtimeTranscriptionProviders } = await import("./realtime-transcription.runtime-CKSi86y7.js");
  ...
  <Play loop="0">https://s3.amazonaws.com/com.twilio.music.classical/BusyStrings.mp3</Play>
	...
	*/
	async handleInboundResponse(callId, userMessage) {
		...
		try {
			const { generateVoiceResponse } = await import("./response-generator-C2rGHZyw.js");
...
async function resolveProvider(config) {
	...
	switch (config.provider) {
		case "telnyx": {
			const { TelnyxProvider } = await import("./telnyx-1NnXg7In.js");
		...
		case "twilio": {
			const { TwilioProvider } = await import("./twilio-VwgXExj8.js");
		...
		case "plivo": {
			const { PlivoProvider } = await import("./plivo-B5Rfe-Br.js");
		...
		case "mock": {
			const { MockProvider } = await import("./mock-DjSUansr.js");
...
async function resolveRealtimeProvider(params) {
	const { getRealtimeVoiceProvider, listRealtimeVoiceProviders } = await import("./realtime-voice.runtime-7Tm5c6XJ.js");
	const resolution = resolveConfiguredCapabilityProvider({
...
async function createVoiceCallRuntime(params) {
	...
	if (realtimeProvider) {
		const { RealtimeCallHandler } = await import("./realtime-handler-KEQq92CU.js");
