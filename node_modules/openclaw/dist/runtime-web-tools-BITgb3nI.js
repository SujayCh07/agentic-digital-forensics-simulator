...
import { a as resolveManifestContractPluginIdsByCompatibilityRuntimePath, i as resolveManifestContractPluginIds } from "./manifest-registry-_lSkajSy.js";
import { h as resolveDefaultAgentId, m as resolveAgentWorkspaceDir } from "./agent-scope-BfV3ML7Z.js";
import { a as collectPluginConfigContractMatches, o as resolvePluginConfigContractsById } from "./setup-registry-B4foTAMM.js";
import { d as resolveSecretInputRef } from "./types.secrets-D-R9X_jm.js";
import { u as secretRefKey } from "./ref-contract-DOTysgVz.js";
import { n as getBootstrapChannelSecrets } from "./bootstrap-registry-C57YlKdF.js";
import { a as normalizePluginsConfig, c as resolveEnableState } from "./config-state-HDtzsRYk.js";
import { t as loadBundledChannelSecretContractApi } from "./channel-contract-api-Bm5QdFkt.js";
import "./shared-guYZSt85.js";
import { o as resolveSecretRefValues } from "./resolve-BS8YyKnx.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-CiNKqD_t.js";
import { t as createGatewayCredentialPlan } from "./credential-planner-Dx3s51s1.js";
import { a as createLazyRuntimeSurface, i as createLazyRuntimeNamedExport } from "./lazy-runtime-CnM-CcsI.js";
import { n as resolveEffectiveMediaEntryCapabilities, r as buildMediaUnderstandingRegistry, t as resolveConfiguredMediaEntryCapabilities } from "./entry-capabilities-C6YwKwow.js";
import { c as pushInactiveSurfaceWarning, l as pushWarning, n as collectSecretInputAssignment } from "./runtime-shared-BkCh59TV.js";
import { t as collectTtsApiKeyAssignments } from "./runtime-config-collectors-tts-LLq1U5-E.js";
import { r as sortWebSearchProvidersForAutoDetect } from "./web-search-providers.shared-BkXZ78AW.js";
import { r as sortWebFetchProvidersForAutoDetect } from "./web-fetch-providers.shared-Btd8qVg-.js";
import { i as resolveBundledExplicitWebSearchProvidersFromPublicArtifacts, r as resolveBundledExplicitWebFetchProvidersFromPublicArtifacts } from "./web-provider-public-artifacts.explicit-BSWUyiC9.js";
...
const loadResolveManifestContractOwnerPluginId = createLazyRuntimeNamedExport(() => import("./runtime-web-tools-manifest.runtime-DZuDTU4c.js"), "resolveManifestContractOwnerPluginId");
...
const loadRuntimeWebToolsFallbackProviders = createLazyRuntimeSurface(() => import("./runtime-web-tools-fallback.runtime-CM9xbYRS.js"), ({ runtimeWebToolsFallbackProviders }) => runtimeWebToolsFallbackProviders);
const loadRuntimeWebToolsPublicArtifacts = createLazyRuntimeSurface(() => import("./runtime-web-tools-public-artifacts.runtime-CYr2Q-c8.js"), (mod) => mod);
...
async function resolveRuntimeWebTools(params) {
	...
	const configuredBundledWebSearchPluginIdHint = rawProvider && hasPluginWebSearchConfig ? inferExactBundledPluginScopedWebToolConfigOwner({
		config: params.sourceConfig,
		key: "webSearch",
		pluginId: rawProvider
	}) ?? (!getHasCustomWebSearchRisk() ? inferSingleBundledPluginScopedWebToolConfigOwner(params.sourceConfig, "webSearch") : void 0) : void 0;
	const searchMetadata = {
		providerSource: "none",
		diagnostics: []
	};
	if (search || hasPluginWebSearchConfig) {
		const searchCompatibilityOnlyPluginIds = !rawProvider && !hasPluginWebSearchConfig && isRecord(search) && Object.prototype.hasOwnProperty.call(search, "apiKey") ? resolveManifestContractPluginIdsByCompatibilityRuntimePath({
			contract: "webSearchProviders",
		...
		const searchSurface = await resolveRuntimeWebProviderSurface({
			...
			resolveProviders: ({ configuredBundledPluginId }) => resolveBundledWebSearchProviders({
				sourceConfig: params.sourceConfig,
				context: params.context,
				configuredBundledPluginId,
				onlyPluginIds: configuredBundledPluginId === void 0 && searchCompatibilityOnlyPluginIds.length > 0 && !getHasCustomWebSearchRisk() ? searchCompatibilityOnlyPluginIds : void 0,
