...
import { n as normalizeAccountId, r as normalizeOptionalAccountId, t as DEFAULT_ACCOUNT_ID } from "./account-id-BfovDWrj.js";
import { c as normalizeResolvedSecretInputString, i as coerceSecretRef } from "./types.secrets-D-R9X_jm.js";
import { n as retryAsync } from "./retry-DcseOnly.js";
import "./text-runtime-dYMrRdFH.js";
import "./secret-input-Oc2bMbCI.js";
import { o as isPrivateNetworkOptInEnabled, t as assertHttpUrlTargetsPrivateNetwork, u as ssrfPolicyFromDangerouslyAllowPrivateNetwork } from "./ssrf-policy-DANBiMfe.js";
...
import { a as resolveMatrixDefaultOrOnlyAccountId, n as requiresExplicitMatrixDefaultAccount, o as resolveMatrixAccountStringValues } from "./account-selection-DPEAF43o.js";
import { t as getMatrixScopedEnvVarNames } from "./env-vars-B3xz7sFG.js";
import { c as resolveMatrixBaseConfig, i as findMatrixAccountConfig, o as listNormalizedMatrixAccountIds, t as resolveMatrixConfigFieldPath } from "./config-paths-CxAufx1r.js";
import { t as getMatrixRuntime } from "./runtime-DmMklTU8.js";
import { r as repairCurrentTokenStorageMetaDeviceId } from "./storage-DQVJCqpT.js";
...
async function loadMatrixAuthClientDeps() {
	matrixAuthClientDepsPromise ??= Promise.all([import("./sdk-BjzpY7g8.js"), import("./logging-DlMkIv0o.js")]).then(([sdkModule, loggingModule]) => ({
...
async function loadMatrixCredentialsReadDeps() {
	matrixCredentialsReadDepsPromise ??= import("./credentials-read-BLTWhjOH.js").then((credentialsReadModule) => ({
...
async function loadMatrixSecretInputDeps() {
	matrixSecretInputDepsPromise ??= import("./config-secret-input.runtime-BpGjXegL.js").then((runtime) => ({ resolveConfiguredSecretInputString: runtime.resolveConfiguredSecretInputString }));
...
async function resolveMatrixAuth(params) {
	...
	const loadCredentialsWriter = async () => {
		credentialsWriter ??= await import("./credentials-write.runtime-CMYhEsBj.js");
...
async function backfillMatrixAuthDeviceIdAfterStartup(params) {
	...
	if (isAbortSignalTriggered(params.abortSignal)) return;
	return await (await import("./credentials-write.runtime-CMYhEsBj.js")).saveBackfilledMatrixDeviceId({
		homeserver: params.auth.homeserver,
		userId: params.auth.userId,
		accessToken: params.auth.accessToken,
		deviceId
...
//#endregion
export { resolveMatrixAuthContext as a, resolveScopedMatrixEnvConfig as c, resolveMatrixAuth as i, resolveValidatedMatrixHomeserverUrl as l, hasReadyMatrixEnvAuth as n, resolveMatrixConfigForAccount as o, resolveGlobalMatrixEnvConfig as r, resolveMatrixEnvAuthReadiness as s, backfillMatrixAuthDeviceIdAfterStartup as t, validateMatrixHomeserverUrl as u };
