...
import { u as resolveGatewayPort } from "./paths-nQmEmngS.js";
import { h as writeConfigFile, l as readConfigFileSnapshot } from "./io-BxA9F2P4.js";
...
import { n as buildPluginCompatibilityNotices, s as formatPluginCompatibilityNotice } from "./status-DX9bE8uU.js";
...
async function resolveAuthChoiceModelSelectionPolicy(params) {
	...
	const { resolvePluginProviders, resolveProviderPluginChoice } = await import("./provider-auth-choice.runtime-DNqTUi2u.js");
...
async function runSetupWizard(opts, runtime = defaultRuntime, prompter) {
	const onboardHelpers = await import("./onboard-helpers-CueSEEaF.js");
	...
	if (mode === "remote") {
		const { promptRemoteGatewayConfig } = await import("./onboard-remote-DQHMnFRt.js");
		const { logConfigUpdated } = await import("./logging-Bdr19rtT.js");
	...
	const { applyLocalSetupWorkspaceConfig } = await import("./onboard-config-Bt_xhpYJ.js");
	let nextConfig = applyLocalSetupWorkspaceConfig(baseConfig, workspaceDir);
	const { ensureAuthProfileStore } = await import("./agents/auth-profiles.runtime.js");
	const { promptAuthChoiceGrouped } = await import("./auth-choice-prompt-CoGHQR1J.js");
	const { promptCustomApiConfig } = await import("./onboard-custom-AEgXO9vV.js");
	const { applyAuthChoice, resolvePreferredProviderForAuthChoice, warnIfModelConfigLooksOff } = await import("./auth-choice-Ca0oPy74.js");
	const { applyPrimaryModel, promptDefaultModel } = await import("./model-picker-CG2uT7tF.js");
	...
	const { configureGatewayForSetup } = await import("./setup.gateway-config-BT5jrjVR.js");
	...
	if (opts.skipChannels ?? opts.skipProviders) await prompter.note("Skipping channel setup.", "Channels");
		...
		const { listChannelPlugins } = await import("./plugins-w8dw43re.js");
		const { setupChannels } = await import("./onboard-channels-BGkK_Obc.js");
	...
	if (opts.skipSearch) await prompter.note("Skipping search setup.", "Search");
		...
		const { setupSearch } = await import("./onboard-search-CFJz8lEt.js");
	...
	if (opts.skipSkills) await prompter.note("Skipping skills setup.", "Skills");
		...
		const { setupSkills } = await import("./onboard-skills-CDMrWYig.js");
		nextConfig = await setupSkills(nextConfig, workspaceDir, runtime, prompter);
	}
	if (flow !== "quickstart") {
		const { setupPluginConfig } = await import("./setup.plugin-config-C07oUGwK.js");
	...
	const { setupInternalHooks } = await import("./onboard-hooks-49cCYIpH.js");
	...
	await writeConfigFile(nextConfig);
	const { finalizeSetupWizard } = await import("./setup.finalize-DrYIeeDB.js");
