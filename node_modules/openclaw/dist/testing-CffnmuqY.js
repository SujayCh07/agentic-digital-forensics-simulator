...
import { y as setActivePluginRegistry } from "./runtime-BrxjAC6F.js";
import { t as resolveBundledPluginsDir } from "./bundled-dir-CmxivWWK.js";
import { t as isTruthyEnvValue } from "./env-WgjbeXMN.js";
import { l as resolveLoaderPackageRoot } from "./sdk-alias-Pc_bYsyi.js";
import { t as findBundledPluginMetadataById } from "./bundled-plugin-metadata-A29NoUcJ.js";
import { a as listBundledChannelPlugins, s as setBundledChannelRuntime } from "./bundled-BK4_aJhU.js";
import { t as normalizeBundledPluginArtifactSubpath } from "./public-surface-runtime-Cm98y6Ak.js";
import "./safe-text-DKoTIFsS.js";
import "./loader-DtbRRnBD.js";
...
import { h as ssrf_exports, m as resolvePinnedHostnameWithPolicy, p as resolvePinnedHostname } from "./ssrf-C2YYZEse.js";
import "./call-CZD7wgnV.js";
import "./system-events-Bc8HfhQ3.js";
import { i as toAcpRuntimeError } from "./errors-B33qztHf.js";
import "./manager-CZK8ESdk.js";
...
import { a as it, i as beforeEach, n as vi, r as afterEach, t as globalExpect } from "./test.D1JkM1w4-Dbju4Uts.js";
import "./provider-auth-choice.runtime-DUgwcJbR.js";
import { n as cleanupSessionStateForTest, o as withFetchPreconnect, r as captureEnv } from "./temp-home-BpeE5fOU.js";
import "./commands-acp-NrCJokm8.js";
...
async function writeSkill(params) {
	...
	await fs$1.writeFile(path.join(dir, "SKILL.md"), `---\n${frontmatter}\n---
...
async function createWindowsCmdShimFixture(params) {
	await fs$1.mkdir(path.dirname(params.scriptPath), { recursive: true });
	await fs$1.mkdir(path.dirname(params.shimPath), { recursive: true });
	await fs$1.writeFile(params.scriptPath, "module.exports = {};\n", "utf8");
	await fs$1.writeFile(params.shimPath, `@echo off\r\n${params.shimLine}\r\n`, "utf8");
}
//#endregion
...
async function withStateDirEnv(prefix, fn) {
	...
	const tempRoot = await fs$1.mkdtemp(path.join(os.tmpdir(), prefix));
