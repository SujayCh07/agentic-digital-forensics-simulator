import { a as formatUncaughtError, i as formatErrorMessage } from "./errors-DcAstocv.js";
...
import { i as getChildLogger } from "./logger-ChPQoo5e.js";
import { t as createNonExitingRuntime } from "./runtime-BXaxArxm.js";
import { t as createSubsystemLogger } from "./subsystem-DX_oTata.js";
import { p as resolveDefaultModelForAgent } from "./model-selection-JHakuCn9.js";
import { _ as resolveStateDir } from "./paths-nQmEmngS.js";
import { d as resolveThreadSessionKeys, f as sanitizeAgentId, r as buildAgentMainSessionKey, u as resolveAgentIdFromSessionKey } from "./session-key-BMb3Kc4r.js";
import { n as normalizeAccountId } from "./account-id-BfovDWrj.js";
import { a as resolveAgentDir, h as resolveDefaultAgentId } from "./agent-scope-BfV3ML7Z.js";
import { a as shouldLogVerbose, r as logVerbose, s as warn, t as danger } from "./globals-dovsmtt4.js";
import { a as loadConfig, h as writeConfigFile } from "./io-BxA9F2P4.js";
import { r as getRuntimeConfigSnapshot } from "./runtime-snapshot-jOoymAHW.js";
import { s as getPluginCommandSpecs } from "./command-registration-CRTW-TnN.js";
import { t as createDedupeCache } from "./dedupe-MmEr1T7f.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-CbzQncoV.js";
import { a as resolveSessionStoreEntry, c as updateSessionStore } from "./store-ZWCZ_LZI.js";
import { u as resolveStorePath } from "./paths-DgoT9gfU.js";
import { t as loadSessionStore } from "./store-load-DlllQPOX.js";
import { a as resolveNativeSkillsEnabled, i as resolveNativeCommandsEnabled, n as isNativeCommandsExplicitlyDisabled } from "./commands-DRkOcZyK.js";
import { a as modelSupportsVision, n as findModelInCatalog, r as loadModelCatalog } from "./model-catalog-Jxv_Vdyq.js";
import { t as resolveAckReaction } from "./identity-D_zFlCIB.js";
import { n as sleepWithAbort, t as computeBackoff } from "./backoff-B9kdzMlx.js";
import { c as resolveTextChunkLimit, s as resolveChunkMode } from "./chunk-BRF5Bnyz.js";
import { p as resolveSendableOutboundReplyParts } from "./reply-payload-CPJQ0UIg.js";
import { c as stripReasoningTagsFromText, d as isInsideCode, u as findCodeRegions } from "./assistant-visible-text-KiIaWnQV.js";
import { o as formatReasoningMessage } from "./pi-embedded-utils-Cr5nYiZd.js";
import { d as parseExecApprovalCommandText } from "./exec-approval-reply-B4ng3Kgc.js";
import { r as enqueueSystemEvent } from "./system-events-Bc8HfhQ3.js";
import { i as resolveChannelStreamingBlockEnabled } from "./channel-streaming-C_umKBSU.js";
import { f as fireAndForgetHook, i as toInternalMessageReceivedContext } from "./message-hook-mappers-D3Z-srJj.js";
import { n as resolveChannelGroupRequireMention, t as resolveChannelGroupPolicy } from "./group-policy-BOK9r2Js.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-D0wkyf-C.js";
import { g as resolveChannelConfigWrites } from "./channel-config-helpers-BcgzHVD7.js";
import { t as MediaFetchError } from "./fetch-CraQ-PKa.js";
import { t as loadWebMedia } from "./web-media-DqvsPtjN.js";
import { i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-BWZgM2t0.js";
import { r as getSessionBindingService } from "./session-binding-service-CFQbst7d.js";
...
import { f as parsePluginBindingApprovalCustomId, i as buildPluginBindingResolvedText, m as resolvePluginConversationBindingApproval, u as isPluginOwnedSessionBindingRecord } from "./conversation-binding-DR3YJDsR.js";
import "./error-runtime-Huw13EA-.js";
import { d as listNativeCommandSpecsForConfig, g as resolveCommandArgMenu, m as parseCommandArgs, n as buildCommandTextFromArgs, p as normalizeCommandBody, r as findCommandByNativeName, u as listNativeCommandSpecs } from "./commands-registry-CuZmchBs.js";
import { n as isAbortRequestText } from "./abort-primitives-DR4ciFkv.js";
import { t as hasControlCommand } from "./command-detection-sjcr0KU4.js";
import { a as resolveEnvelopeFormatOptions, r as formatInboundEnvelope } from "./envelope-jjsUhYyN.js";
import { n as resolveInboundDebounceMs, t as createInboundDebouncer } from "./inbound-debounce-CCzo2l46.js";
import { i as matchesMentionWithExplicit, n as buildMentionRegexes } from "./mentions-BBGX5kEf.js";
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./provider-dispatcher-RhkgL42J.js";
import { n as shouldAckReaction, t as removeAckReactionAfterReply } from "./ack-reactions-CW4w1AXt.js";
import { n as resolveControlCommandGate, t as resolveCommandAuthorizedFromAuthorizers } from "./command-gating-490WNvMI.js";
import { n as resolveInboundMentionDecision, t as implicitMentionKindWhen } from "./mention-gating-BVl28cwK.js";
import { t as resolveMarkdownTableMode } from "./markdown-tables-DgLnIvPZ.js";
import { a as readChannelAllowFromStore, d as upsertChannelPairingRequest } from "./pairing-store-Bn186jyL.js";
import { t as firstDefined } from "./allow-from-2JnLluoN.js";
import { a as buildPendingHistoryContextFromMap, s as clearHistoryEntriesIfEnabled, u as recordPendingHistoryEntryIfEnabled } from "./history-CIfU7bDI.js";
import "./reply-history-Cvm_oiqR.js";
import { n as logInboundDrop, r as logTypingFailure, t as logAckFailure } from "./logging-DqD2afVE.js";
import { t as createChannelReplyPipeline } from "./channel-reply-pipeline-tHqXP07h.js";
import { t as createChannelPairingChallengeIssuer } from "./channel-pairing-B4BhGbz7.js";
import "./runtime-env-BeEpAa51.js";
import { t as resolveApprovalOverGateway } from "./approval-gateway-resolver-qAf6fWIb.js";
import "./approval-gateway-runtime-Du5LNkt4.js";
import { t as evaluateSupplementalContextVisibility } from "./context-visibility-Ccoaoyrv.js";
import { t as resolveChannelContextVisibilityMode } from "./context-visibility-BFfgNy9z.js";
import "./config-runtime-MrY1WAZr.js";
import { t as resolveCommandAuthorization } from "./command-auth-DYJ_vQmJ.js";
import { t as resolveStoredModelOverride } from "./stored-model-override-8VlnIY8x.js";
import { n as isBtwRequestText } from "./btw-command-B4S_drz9.js";
import { t as generateConversationLabel } from "./reply-runtime-CHSEdiMI.js";
import "./reply-dispatch-runtime-BL9_odaB.js";
import "./reply-chunking-CrNRGj6l.js";
import "./web-media-Bh3YWiOa.js";
import "./infra-runtime-DzGODV0M.js";
import "./media-runtime-C7JDE1My.js";
import { n as resolveConfiguredBindingRoute } from "./binding-routing-CSgGBfMd.js";
import "./conversation-runtime-DyA8YCJp.js";
import { d as resolveThreadBindingSpawnPolicy, l as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel } from "./thread-bindings-policy-CU2O6UPm.js";
import "./agent-runtime-z9jj2DSi.js";
import { n as createInteractiveConversationBindingHelpers, t as dispatchPluginInteractiveHandler } from "./plugin-runtime-BBFGn0Gi.js";
import "./security-runtime-B867q7Wo.js";
import "./hook-runtime-CIHiNDoV.js";
import "./markdown-table-runtime-CYKJKCIV.js";
import { n as buildCommandsMessagePaginated } from "./command-status-builders-CJYXNA-o.js";
import "./command-auth-CcDSi1HK.js";
import { t as resolveNativeCommandSessionTargets } from "./native-command-session-targets-DuiFOmBe.js";
import { t as listSkillCommandsForAgents } from "./skill-commands-CV2ehgds.js";
import { n as formatModelsAvailableHeader, t as buildModelsProviderData } from "./commands-models-xqfv0kuR.js";
import "./command-auth-native-C-WgYDZh.js";
import "./command-status-sTCWJb2Y.js";
import "./command-detection-NeYLST0X.js";
import "./command-surface-C3YRB0-q.js";
import { n as DEFAULT_EMOJIS } from "./channel-feedback-BUm9r02v.js";
import { n as shouldDebounceTextInbound } from "./channel-inbound-DKgmBCwM.js";
import { n as toLocationContext, t as formatLocationText } from "./location-DBQg_X--.js";
import { i as createFinalizableDraftLifecycle } from "./channel-lifecycle-BxCvRHUt.js";
import "./state-paths-DIfHNRvf.js";
import "./models-provider-runtime-Dm_PH6DZ.js";
import "./skill-commands-runtime-CGa1evKw.js";
import { c as resolveTelegramAccount, u as resolveTelegramMediaRuntimeOptions } from "./preview-streaming-DlkIvlwp.js";
import { t as normalizeTelegramReplyToMessageId } from "./outbound-params-rUDXJhJt.js";
import { r as resolveTelegramTransport } from "./fetch-DAnPMSri.js";
import { r as resolveTelegramInlineButtonsScope } from "./inline-buttons-DLNT7Jp_.js";
import { f as shouldSuppressLocalTelegramExecApprovalPrompt, l as shouldEnableTelegramExecApprovalButtons, n as isTelegramExecApprovalApprover, r as isTelegramExecApprovalAuthorizedSender } from "./exec-approvals-BAVVzNR5.js";
import { A as withResolvedTelegramForumFlag, B as isSenderAllowed, C as resolveTelegramDirectPeerId, E as resolveTelegramGroupAllowFromContext, F as getTelegramTextParts, H as normalizeDmAllowFromWithStore, I as hasBotMention, L as normalizeForwardedContext, M as buildSenderName, N as expandTextLinks, O as resolveTelegramStreamMode, P as extractTelegramLocation, S as extractTelegramForumFlag, T as resolveTelegramForumThreadId, U as resolveSenderAllowMatch, V as normalizeAllowFrom, _ as buildTelegramParentPeer, b as buildTypingThreadParams, c as isSafeToRetrySendError, g as buildTelegramGroupPeerId, h as buildTelegramGroupFrom, i as renderTelegramHtmlText, j as buildSenderLabel, k as resolveTelegramThreadSpec, l as isTelegramClientRejection, m as buildGroupLabel, p as tagTelegramNetworkError, s as isRecoverableTelegramNetworkError, v as buildTelegramRoutingTarget, w as resolveTelegramForumFlag, x as describeReplyTarget, y as buildTelegramThreadParams, z as resolveTelegramPrimaryMedia } from "./format-D8nOop8X.js";
import { c as buildModelsKeyboard, d as getModelsPageSize, f as parseModelCallbackData, l as buildProviderKeyboard, p as resolveModelSelection, t as buildCommandsPaginationKeyboard, u as calculateTotalPages } from "./command-ui-DZ7a-ne2.js";
import { i as resolveTelegramCustomCommands, r as normalizeTelegramCommandName, t as TELEGRAM_COMMAND_NAME_PATTERN } from "./command-config-C52P5eLI.js";
import { t as createTelegramThreadBindingManager } from "./thread-bindings-Awn6-uQ1.js";
import { n as cacheSticker, t as describeStickerImage } from "./sticker-cache-CrORvm9f.js";
import { n as evaluateTelegramGroupPolicyAccess, t as evaluateTelegramGroupBaseAccess } from "./group-access-BFbBNRd1.js";
import { _ as wasSentByBot, a as editMessageTelegram, b as withTelegramApiErrorLogging, g as recordSentMessage, v as buildInlineKeyboard } from "./send-CQ-7T2Eu.js";
import { n as deliverReplies, r as emitInternalMessageSentHook, t as resolveMedia } from "./delivery-BSJQ0lLb.js";
...
async function loadTelegramSendRuntime() {
	telegramSendRuntimePromise ??= import("./send-q0fH1CYt.js");
...
async function loadTelegramNativeCommandDeliveryRuntime() {
	telegramNativeCommandDeliveryRuntimePromise ??= import("./bot-native-commands.delivery.runtime-Blx7VA-E.js");
...
async function loadTelegramNativeCommandRuntime() {
	telegramNativeCommandRuntimePromise ??= import("./bot-native-commands.runtime-D_lCPVG5.js");
...
async function resolveStickerVisionSupport$1(params) {
	try {
		const { resolveStickerVisionSupportRuntime } = await import("./sticker-vision.runtime-BLpYq6jh.js");
...
async function resolveTelegramInboundBody(params) {
	...
	if (hasAudio && !hasUserText && (!isGroup || requireMention && mentionRegexes.length > 0 && !disableAudioPreflight && senderAllowedForAudioPreflight)) try {
		const { transcribeFirstAudio } = await import("./media-understanding.runtime-DByWPQdS.js");
...
async function buildTelegramInboundContextPayload(params) {
	...
	const sessionRuntime = await import("./bot-message-context.session.runtime-pTc9paPC.js");
...
async function loadTelegramMessageContextRuntime() {
	telegramMessageContextRuntimePromise ??= import("./bot-message-context.runtime-CZIg2J5V.js");
