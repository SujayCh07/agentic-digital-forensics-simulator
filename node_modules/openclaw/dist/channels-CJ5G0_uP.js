...
import { D as isChannelVisibleInConfiguredLists } from "./message-channel-DKMzUOS9.js";
import { t as formatDocsLink } from "./links-BFFMr2UK.js";
import { r as theme } from "./theme-M8d3WnX0.js";
import { a as loadAuthProfileStore } from "./store-C6K7theB.js";
...
import { t as danger } from "./globals-dovsmtt4.js";
import { a as loadConfig, l as readConfigFileSnapshot } from "./io-BxA9F2P4.js";
import { i as normalizeChannelId, r as listChannelPlugins, t as getChannelPlugin } from "./registry-FZxml0NK.js";
import { c as moveSingleAccountChannelSectionToDefaultAccount } from "./setup-helpers-CwEENaWo.js";
...
import { o as resolveMessageActionDiscoveryForPlugin, r as createMessageActionDiscoveryContext } from "./message-action-discovery-CJiXcvIz.js";
...
import { n as getChannelsCommandSecretTargetIds } from "./command-secret-targets-CwmU9KOt.js";
import { i as resolveChannelDefaultAccountId, r as parseOptionalDelimitedEntries } from "./helpers-CkwALjL8.js";
import { n as formatTimeAgo } from "./format-relative-D1ro1QnA.js";
import { n as hasResolvedCredentialValue, t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-YHvulasF.js";
...
import { n as formatUsageReportLines, t as loadProviderUsageSummary } from "./provider-usage-Day8pfOo.js";
import { t as createClackPrompter } from "./clack-prompter-B9S9Qthn.js";
import { r as listChannelPluginCatalogEntries } from "./catalog-B1t4Dv5b.js";
import { t as resolveInstallableChannelPlugin } from "./channel-plugin-resolution-B5WnttT_.js";
import { t as parseLogLine } from "./parse-log-line-BBoqytpm.js";
import { a as describeBinding, n as requireValidConfigSnapshot, r as applyAgentBindings, t as requireValidConfigFileSnapshot } from "./config-validation-CxARXd8p.js";
import { n as createChannelOnboardingPostWriteHookCollector, o as isCatalogChannelInstalled, r as runCollectedChannelOnboardingPostWriteHooks } from "./onboard-channels-26O9wfcY.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-D4CnH4nI.js";
import { n as buildReadOnlySourceChannelAccountSnapshot, t as buildChannelAccountSnapshot } from "./status-DbqZJF42.js";
...
async function channelsAddCommand(opts, runtime = defaultRuntime, params) {
	...
	if (shouldUseWizard(params)) {
		const [{ buildAgentSummaries }, { setupChannels }] = await Promise.all([import("./agents.config-HiE9stRR.js"), import("./onboard-channels-BGkK_Obc.js")]);
	...
	const loadScopedPlugin = async (channelId, pluginId) => {
		...
		const { loadChannelSetupPluginRegistrySnapshotForChannel } = await import("./plugin-install-SX9wXHAX.js");
	...
	if (!channel && catalogEntry) {
		...
		if (!isCatalogChannelInstalled({
			...
			const { ensureChannelSetupPluginInstalled } = await import("./plugin-install-SX9wXHAX.js");
			const prompter = createClackPrompter();
...
function buildChannelAccountLine(provider, account, bits) {
	return `- ${formatChannelAccountLabel({
		...
		name: (normalizeOptionalString(account.name) ?? "") || void 0
	})}: ${bits.join(", ")}`;
}
