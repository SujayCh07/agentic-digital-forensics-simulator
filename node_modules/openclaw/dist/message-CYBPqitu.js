...
import { a as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-BA26RCnu.js";
...
import { n as resolveOutboundChannelPlugin } from "./channel-resolution-I6cvW7bN.js";
...
function loadMessageConfigRuntime() {
	messageConfigRuntimePromise ??= import("./message.config.runtime-BhYMpr9A.js");
	return messageConfigRuntimePromise;
}
function loadMessageGatewayRuntime() {
	messageGatewayRuntimePromise ??= import("./message.gateway.runtime-DVN5LL9b.js");
