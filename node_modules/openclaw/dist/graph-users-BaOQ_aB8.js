...
async function loadMSTeamsSdk() {
	const [appsModule, apiModule] = await Promise.all([import("./dist-BSkekzJ7.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1)), import("./dist-nGILpP2F.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1))]);
	return {
		App: appsModule.App,
...
async function createBotFrameworkJwtValidator(creds) {
	const jwt = await import("./jsonwebtoken-CMS1oAE4.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
	const { JwksClient } = await import("./src-JqPq2JZ_.js").then((m) => /* @__PURE__ */ __toESM(m.default, 1));
...
//#endregion
export { inferPlaceholder as A, safeHostForUrl as B, ATTACHMENT_TAG_RE as C, encodeGraphShareId as D, applyAuthorizationHeaderForUrl as E, readNestedString as F, hasConfiguredMSTeamsCredentials as H, resolveAttachmentFetchPolicy as I, resolveMediaSsrfPolicy as L, isLikelyImageAttachment as M, isUrlAllowed as N, extractHtmlFromAttachment as O, normalizeContentType as P, resolveRequestUrl as R, isRevokedProxyError as S, IMG_SRC_RE as T, resolveMSTeamsCredentials as U, tryBuildGraphSharesUrlForSharedLink as V, buildUserAgent as _, fetchGraphJson as a, formatMSTeamsSendErrorHint as b, normalizeQuery as c, resolveGraphToken as d, readAccessToken as f, loadMSTeamsSdkWithAuth as g, createMSTeamsTokenProvider as h, fetchGraphAbsoluteUrl as i, isDownloadableAttachment as j, extractInlineImageCandidates as k, postGraphBetaJson as l, createMSTeamsAdapter as m, deleteGraphRequest as n, listChannelsForTeam as o, createBotFrameworkJwtValidator as p, escapeOData as r, listTeamsByName as s, searchGraphUsers as t, postGraphJson as u, ensureUserAgentHeader as v, GRAPH_ROOT as w, formatUnknownError as x, classifyMSTeamsSendError as y, safeFetchWithPolicy as z };
