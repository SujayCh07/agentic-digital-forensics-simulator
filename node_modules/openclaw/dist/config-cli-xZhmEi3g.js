...
import { t as CONFIG_PATH } from "./paths-nQmEmngS.js";
import { t as isBlockedObjectKey } from "./prototype-keys-BWjW0VW8.js";
import { n as info, o as success, t as danger } from "./globals-dovsmtt4.js";
import { _ as collectUnsupportedSecretRefPolicyIssues, l as readConfigFileSnapshot, y as validateConfigObjectRaw } from "./io-BxA9F2P4.js";
import { d as resolveSecretInputRef, i as coerceSecretRef, s as isValidEnvSecretRefId } from "./types.secrets-D-R9X_jm.js";
import { a as formatExecSecretRefIdValidationMessage, c as isValidSecretProviderAlias, d as validateExecSecretRefId, o as isValidExecSecretRefId, s as isValidFileSecretRefId, u as secretRefKey } from "./ref-contract-DOTysgVz.js";
import { w as SecretProviderSchema } from "./zod-schema.core-I7FUdZft.js";
import { r as replaceConfigFile } from "./config-BgwTLDRu.js";
import { a as resolveSecretRefValue } from "./resolve-BS8YyKnx.js";
import { t as formatCliCommand } from "./command-format-Ct8eiFod.js";
import { a as normalizeConfigIssues, n as formatConfigIssueLines } from "./issue-format-CeJLh9Ud.js";
import { c as resolveConfigSecretTargetByPath, n as discoverConfigSecretTargets } from "./target-registry-D1_9kJS6.js";
import { i as redactConfigObject, n as readBestEffortRuntimeConfigSchema } from "./runtime-schema-Dtb7RtZd.js";
import { n as setCommandJsonMode } from "./json-mode-CDpTUznY.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Non-interactive config helpers (get/set/unset/file/schema/validate). Run without subcommand for guided setup.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configuration sections for guided setup (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { configureCommandFromSectionsArg } = await import("./configure-Dj2SkrDB.js");
