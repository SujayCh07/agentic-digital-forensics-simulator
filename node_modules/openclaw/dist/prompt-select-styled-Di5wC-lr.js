...
import { d as readStringValue, f as resolvePrimaryStringValue, i as normalizeLowercaseStringOrEmpty, o as normalizeOptionalLowercaseString, s as normalizeOptionalString } from "./string-coerce-CIT1-v_a.js";
import { o as getResolvedLoggerSettings } from "./logger-ChPQoo5e.js";
import { o as resolveRequiredHomeDir } from "./home-dir-B1jAgGgF.js";
import { n as defaultRuntime } from "./runtime-BXaxArxm.js";
import { _ as shortenHomePath, l as isRecord, m as resolveUserPath, v as sleep } from "./utils-Supr9KvU.js";
import { l as normalizeTrimmedStringList, s as normalizeStringEntries } from "./string-normalization-IdjIlZzV.js";
import { r as normalizeChatChannelId } from "./ids-BSkPonH4.js";
import { n as resolveOpenClawPackageRootSync, t as resolveOpenClawPackageRoot } from "./openclaw-root-aQp7vffj.js";
import { t as sanitizeForLog } from "./ansi-B_y-Sue5.js";
import { t as isTruthyEnvValue$1 } from "./env-WgjbeXMN.js";
import { C as CLAUDE_CLI_PROFILE_ID, g as resolveAuthStorePathForDisplay, n as ensureAuthProfileStore, y as readClaudeCliCredentialsCached } from "./store-C6K7theB.js";
import { n as formatAuthDoctorHint, t as resolveApiKeyForProfile } from "./auth-profiles-DCfLLJE5.js";
import { a as getModelRefStatus, f as resolveConfiguredModelRef, m as resolveHooksGmailModel } from "./model-selection-JHakuCn9.js";
import { n as loadPluginManifestRegistry } from "./manifest-registry-_lSkajSy.js";
import { _ as resolveStateDir, d as resolveIsNixMode, h as resolveOAuthDir, t as CONFIG_PATH, u as resolveGatewayPort } from "./paths-nQmEmngS.js";
import { x as parseAgentSessionKey } from "./session-key-BMb3Kc4r.js";
import { n as normalizeAccountId, r as normalizeOptionalAccountId } from "./account-id-BfovDWrj.js";
import { a as resolveAgentDir, h as resolveDefaultAgentId, m as resolveAgentWorkspaceDir } from "./agent-scope-BfV3ML7Z.js";
import { i as runExec, r as runCommandWithTimeout } from "./exec-uTlaAO3l.js";
import { t as DEFAULT_AGENTS_FILENAME } from "./workspace-BPG_m9MI.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-CF547YAW.js";
import { $ as collectChannelDoctorStaleConfigMutations, B as normalizeCompatibilityConfigValues, L as findLegacyConfigIssues, Q as collectChannelDoctorRepairMutations, X as collectChannelDoctorMutableAllowlistWarnings, Y as collectChannelDoctorEmptyAllowlistExtraWarnings, Z as collectChannelDoctorPreviewWarnings, et as runChannelDoctorConfigSequences, h as writeConfigFile, it as listPluginDoctorLegacyConfigRules, l as readConfigFileSnapshot, nt as applyLegacyDoctorMigrations, tt as shouldSkipChannelDoctorDefaultEmptyGroupAllowlistWarning, x as validateConfigObjectWithPlugins } from "./io-BxA9F2P4.js";
import { t as asNullableObjectRecord } from "./record-coerce-BDH91-dk.js";
import { a as hasConfiguredSecretInput, d as resolveSecretInputRef } from "./types.secrets-D-R9X_jm.js";
import { t as getBundledChannelPlugin } from "./bundled-BK4_aJhU.js";
import { r as listChannelPlugins, t as getChannelPlugin } from "./registry-FZxml0NK.js";
import { i as listBundledChannelPluginIds } from "./bootstrap-registry-C57YlKdF.js";
import { b as resolveExecutablePath, i as normalizeTrustedSafeBinDirs, n as isTrustedSafeBinPath, o as listRiskyConfiguredSafeBins, p as resolveCommandResolutionFromArgv, t as getTrustedSafeBinDirs } from "./exec-safe-bin-trust-Bx-S8dBH.js";
import { a as normalizePluginsConfig, i as normalizePluginId, s as resolveEffectivePluginActivationState } from "./config-state-HDtzsRYk.js";
import "./config-BgwTLDRu.js";
import { n as parseToolsBySenderTypedKey } from "./types.tools-Cm3PdXY3.js";
import { d as resolveProfileUnusableUntilForDisplay } from "./order-DuUOViI_.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-DL0LcytF.js";
import { t as hasBundledChannelPersistedAuthState } from "./persisted-auth-state-CA_Y6KWR.js";
import { n as listPotentialConfiguredChannelIds } from "./config-presence-DnNFIU-O.js";
import "./plugins-BUdv0ZMS.js";
import "./logging-CAD-eG9-.js";
import { n as resolvePluginProviders } from "./providers.runtime-KO25kiSD.js";
import { t as repairOAuthProfileIdMismatch } from "./repair-BM6HeDvJ.js";
import { t as formatCliCommand } from "./command-format-Ct8eiFod.js";
import { d as resolveGatewayLaunchAgentLabel, g as resolveNodeLaunchAgentLabel, m as resolveGatewayWindowsTaskName, p as resolveGatewaySystemdServiceName } from "./paths-DMIWQCKU.js";
import { t as resolveGatewayAuthToken } from "./auth-token-resolution-BkDYbhVz.js";
import { a as resolveSystemNodeInfo, r as renderSystemNodeWarning } from "./runtime-paths-CD_jnoQ3.js";
import { n as buildGatewayInstallPlan, r as gatewayInstallErrorHint, t as resolveGatewayInstallToken } from "./gateway-install-token-DF6aQfEo.js";
import { n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CpWHq7uR.js";
import { n as hasAmbiguousGatewayAuthModeConfig } from "./auth-mode-policy-BnGCJ-ZQ.js";
import { a as isLoopbackHost, m as resolveGatewayBindHost } from "./net-Gtz838RS.js";
import { o as resolveGatewayAuth } from "./auth-CMmjOHxZ.js";
import { n as isPrimarySessionTranscriptFileName, t as formatSessionArchiveTimestamp } from "./artifacts-DZNRQQib.js";
import { i as resolveMainSessionKey } from "./main-session-DIxrImRz.js";
import "./sessions-DmA78qkx.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, l as resolveSessionTranscriptsDirForAgent, u as resolveStorePath } from "./paths-DgoT9gfU.js";
import { i as loadBundledPluginPublicSurfaceModuleSync } from "./facade-loader-DS1TpdW2.js";
import { n as cleanStaleLockFiles } from "./session-write-lock-CKHKyASn.js";
import { t as loadSessionStore } from "./store-load-DlllQPOX.js";
import { i as resolveAgentSessionDirs } from "./targets-CCzE5Q4H.js";
import { n as safeParseWithSchema, t as safeParseJsonWithSchema } from "./zod-parse-CJnMZ4n1.js";
import { r as isWSLEnv, t as isWSL } from "./wsl-Bt9lALab.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-DGpEXTZH.js";
import { a as guardCancel, d as randomToken, l as printWizardHeader, n as applyWizardMetadata } from "./onboard-helpers-Dkw5XEfG.js";
import { i as launchAgentPlistExists, n as isLaunchAgentListed, r as isLaunchAgentLoaded, s as repairLaunchAgentBootstrap } from "./launchd-d1MBI5QE.js";
import { a as inspectPortUsage, s as formatPortDiagnostics } from "./ports-CF9KS2uR.js";
import { d as uninstallLegacySystemdUnits, i as isSystemdUserServiceAvailable, p as classifySystemdUnavailableDetail } from "./systemd-OZY5dMCh.js";
import { r as resolveGatewayService, t as describeGatewayServiceRestart } from "./service-CBRQBUg4.js";
import { a as formatRuntimeStatus, n as renderSystemdUnavailableHints, o as resolveDaemonContainerContext, r as buildPlatformRuntimeLogHints, t as isSystemdUnavailableDetail } from "./systemd-hints-BK-zTfCn.js";
import { n as formatConfigIssueLines } from "./issue-format-CeJLh9Ud.js";
import { a as readEmbeddedGatewayToken, i as needsNodeRuntimeMigration, n as auditGatewayServiceConfig, t as SERVICE_AUDIT_CODES } from "./service-audit-BigC-SPl.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-BcAC3_2x.js";
import { n as findExtraGatewayServices, r as renderGatewayServiceCleanupHints } from "./inspect-Ahp01SOu.js";
import { r as loadModelCatalog } from "./model-catalog-Jxv_Vdyq.js";
import { i as resolveBootstrapContextForRun } from "./bootstrap-files-DoSStHCJ.js";
import { g as resolveBootstrapMaxChars, v as resolveBootstrapTotalMaxChars } from "./pi-embedded-helpers-C6AEBQ28.js";
import { n as classifyOAuthRefreshFailure, t as buildOAuthRefreshFailureLoginCommand } from "./oauth-refresh-failure-Bs7NJulg.js";
import { d as DEFAULT_SANDBOX_IMAGE, l as DEFAULT_SANDBOX_BROWSER_IMAGE, r as resolveSandboxScope } from "./config-CoJWsso_.js";
import { n as buildBootstrapInjectionStats, t as analyzeBootstrapBudget } from "./bootstrap-budget-DjYfMmvw.js";
import { s as resolveApiKeyForProvider } from "./model-auth-D5Ak_Bm7.js";
import { l as loadExecApprovals } from "./exec-approvals-DT4-ZzBV.js";
import { n as buildGatewayConnectionDetails, r as callGateway } from "./call-CZD7wgnV.js";
import { i as resolveMergedSafeBinProfileFixtures, n as listInterpreterLikeSafeBins } from "./exec-safe-bin-runtime-policy-CaEkF0Me.js";
import { a as DeliveryThreadIdFieldSchema, c as TrimmedNonEmptyStringFieldSchema, o as LowercaseNonEmptyStringFieldSchema, t as inferLegacyName, u as parseOptionalField } from "./normalize-CmxhuXwJ.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-CV05Nz97.js";
import { i as listRouteBindings } from "./bindings-BeOT6qJx.js";
import { M as listTaskFlowRecords, d as listTasksForFlowId } from "./task-registry-C9aRX_4L.js";
import "./runtime-internal-DMClajE6.js";
import "./sandbox-DGCZI78L.js";
import { n as getActiveMemorySearchManager, r as resolveActiveMemoryBackendConfig } from "./memory-runtime-CtjumRKk.js";
import { t as resolveMemorySearchConfig } from "./memory-search-BgqYjoKP.js";
import { n as formatSetExplicitDefaultInstruction, r as formatSetExplicitDefaultToConfiguredInstruction, t as formatChannelAccountsDefaultPath } from "./default-account-warnings-CPW4MtSF.js";
import { a as readChannelAllowFromStore } from "./pairing-store-Bn186jyL.js";
import { r as resolveDmAllowState } from "./dm-policy-shared-1zVsdEGf.js";
import { n as logConfigUpdated } from "./logging-B0pOymR8.js";
import { n as resolveCronStorePath, r as saveCronStore, t as loadCronStore } from "./store-BizIUbo7.js";
import { i as resolveBundledPluginSources } from "./bundled-sources-Oov367hg.js";
import { t as note$1 } from "./note-LcGeKHAC.js";
import { a as listBuiltinAutoSelectMemoryEmbeddingProviderDoctorMetadata, n as auditShortTermPromotionArtifacts, o as repairShortTermPromotionArtifacts, r as getBuiltinMemoryEmbeddingProviderDoctorMetadata } from "./memory-core-engine-runtime-DnLDo_Ix.js";
import { t as resolveMemoryBackendConfig } from "./backend-config-Dd45Inug.js";
import "./engine-embeddings-wD4PeBdA.js";
import { t as hasConfiguredMemorySecretInput } from "./secret-input-DC3YfVY1.js";
import { t as checkQmdBinaryAvailability } from "./engine-qmd-D-VKvDV8.js";
import "./engine-storage-CGGr65kV.js";
import "./secret-DNntuf_i.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-CtkGARK2.js";
import { i as buildPluginDiagnosticsReport, r as buildPluginCompatibilityWarnings } from "./status-DX9bE8uU.js";
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-Dq3uw5Ar.js";
import { t as buildProviderAuthRecoveryHint } from "./provider-auth-guidance-JWhFar7i.js";
import { n as resolveExecPolicyScopeSnapshot } from "./exec-approvals-effective-Cx35zIV3.js";
import { r as healthCommand } from "./health-BwJb7omm.js";
import { i as resolveControlUiDistIndexPathForRoot, r as resolveControlUiDistIndexHealth } from "./control-ui-assets-DZVfNObD.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-Cfak0Z-C.js";
import { t as formatHealthCheckFailure } from "./health-format-D-GTPEwn.js";
import { a as stripUnknownConfigKeys, i as resolveConfigPathTarget, n as formatConfigPath, r as noteOpencodeProviderOverrides, t as runDoctorConfigPreflight } from "./doctor-config-preflight-BPBmcxTl.js";
import { a as runChannelPluginStartupMaintenance, i as normalizeCronJobIdentityFields, o as runGatewayUpdate, t as coerceFiniteScheduleNumber } from "./schedule-CHcgTniZ.js";
import { n as doctorShellCompletion } from "./doctor-completion-C6vs2qxT.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-D4CnH4nI.js";
import { t as resolveDefaultChannelAccountContext } from "./channel-account-context-Dapop5mx.js";
import { a as runLegacyStateMigrations, n as detectLegacyStateMigrations } from "./state-migrations-DzEq0HFx.js";
import "./doctor-state-migrations-Df7imBG8.js";
import { n as noteOpenAIOAuthTlsPrerequisites } from "./provider-openai-codex-oauth-tls-CzfEjG_m.js";
...
function getDoctorChannelCapabilities(channelName) {
	...
	const pluginDoctor = getChannelPlugin(channelName)?.doctor ?? getBundledChannelPlugin(channelName)?.doctor;
...
async function launchctlGetenv(name) {
	try {
		const value = normalizeOptionalString((await execFileAsync$1("/bin/launchctl", ["getenv", name], { encoding: "utf8" })).stdout ?? "") ?? "";
...
async function maybeOfferUpdateBeforeDoctor(params) {
	if (!(!isTruthyEnvValue$1(process.env.OPENCLAW_UPDATE_IN_PROGRESS) && params.options.nonInteractive !== true && params.options.yes !== true && params.options.repair !== true && process.stdin.isTTY) || !params.root) return { updated: false };
...
function noteLegacyCodexProviderOverride(cfg) {
	...
	note$1(buildCodexProviderOverrideWarning(providerOverride), CODEX_OAUTH_WARNING_TITLE);
}
...
async function noteChromeMcpBrowserReadiness(cfg, deps) {
	try {
		...
		(deps?.noteFn ?? note$1)(`- Browser health check is unavailable: ${error instanceof Error ? error.message : String(error)}`, "Browser");
	}
}
//#endregion
...
function noteClaudeCliHealth(cfg, deps) {
	...
	if (!hasClaudeCliConfigSignals(cfg) && !hasClaudeCliStoreSignals(store) && !credential) return;
...
async function noteMemoryRecallHealth(cfg) {
	try {
		...
		note$1(`Memory recall audit could not be completed: ${formatErrorMessage(err)}`, "Memory search");
	}
}
async function maybeRepairMemoryRecallHealth(params) {
	try {
		...
		note$1(`Memory recall repair could not be completed: ${formatErrorMessage(err)}`, "Memory search");
	}
}
/**
...
async function noteStateIntegrity(cfg, prompter, configPath) {
	const warnings = [];
	const changes = [];
	const noteFn = prompter.note ?? note$1;
