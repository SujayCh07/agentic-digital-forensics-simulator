import { c as resolveOllamaApiBase, i as fetchOllamaModels, l as OLLAMA_DEFAULT_BASE_URL, n as buildOllamaModelDefinition, r as enrichOllamaModelsWithContext } from "../../provider-models-DM8HS0B-.js";
...
function resolveOllamaDiscoveryApiKey(params) {
	return (params.env.OLLAMA_API_KEY?.trim() ? "OLLAMA_API_KEY" : void 0) ?? params.explicitApiKey ?? params.resolvedApiKey ?? DEFAULT_API_KEY;
}
