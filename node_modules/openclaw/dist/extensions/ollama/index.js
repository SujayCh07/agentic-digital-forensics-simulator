...
import { c as resolveOllamaApiBase, l as OLLAMA_DEFAULT_BASE_URL } from "../../provider-models-DM8HS0B-.js";
import { a as promptAndConfigureOllama, i as ensureOllamaModelPulled, r as configureOllamaNonInteractive, t as buildOllamaProvider } from "../../setup-BOzm1FIZ.js";
import { d as resolveConfiguredOllamaProviderConfig, o as createConfiguredOllamaCompatStreamWrapper, s as createConfiguredOllamaStreamFn } from "../../stream-ZmAeO4u6.js";
import "../../api-BWHjj6Jf.js";
import { n as createOllamaEmbeddingProvider, t as DEFAULT_OLLAMA_EMBEDDING_MODEL } from "../../embedding-provider-wgYXcX3k.js";
import { t as createOllamaWebSearchProvider } from "../../web-search-provider-BjGUSclY.js";
		...
		api.registerProvider({
			...
			discovery: {
				...
				run: async (ctx) => {
					...
					const hasRealOllamaKey = typeof ollamaKey === "string" && ollamaKey.trim().length > 0 && ollamaKey.trim() !== DEFAULT_API_KEY;
					...
					if (!hasRealOllamaKey && !hasMeaningfulExplicitConfig && shouldSkipAmbientOllamaDiscovery(ctx.env)) return null;
					const provider = await buildOllamaProvider(explicit?.baseUrl, { quiet: !hasRealOllamaKey && !hasMeaningfulExplicitConfig });
