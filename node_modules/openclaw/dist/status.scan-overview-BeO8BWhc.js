...
import { r as normalizeControlUiBasePath } from "./control-ui-shared-DtKb_Hnc.js";
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-BkUtIr4F.js";
import { t as createEmptyTaskRegistrySummary } from "./task-registry.summary-DvwwDIE6.js";
import { t as pickGatewaySelfPresence } from "./gateway-presence-Cv8q4oD1.js";
import { t as createEmptyTaskAuditSummary } from "./task-registry.audit.shared-Diz8VIDJ.js";
import { t as resolveGatewayProbeTarget } from "./probe-target-B960NJvp.js";
...
function loadGatewayProbeModule() {
	gatewayProbeModulePromise ??= import("./status.gateway-probe-DAGOK0Wz.js");
	return gatewayProbeModulePromise;
}
function loadProbeGatewayModule() {
	probeGatewayModulePromise ??= import("./probe-CKHjsoN-.js");
...
function loadStatusScanDepsRuntimeModule() {
	statusScanDepsRuntimeModulePromise ??= import("./status.scan.deps.runtime-CGmwjj1H.js");
	return statusScanDepsRuntimeModulePromise;
}
function loadStatusAgentLocalModule() {
	statusAgentLocalModulePromise ??= import("./status.agent-local-SZ7drNSG.js");
	return statusAgentLocalModulePromise;
}
function loadStatusUpdateModule() {
	statusUpdateModulePromise ??= import("./status.update-q_zydKan.js");
	return statusUpdateModulePromise;
}
function loadStatusScanRuntimeModule() {
	statusScanRuntimeModulePromise ??= import("./status.scan.runtime-CXINpVM6.js");
	return statusScanRuntimeModulePromise;
}
function loadGatewayCallModule() {
	gatewayCallModulePromise ??= import("./call-CTD_GJcD.js");
	return gatewayCallModulePromise;
}
function loadStatusSummaryModule() {
	statusSummaryModulePromise ??= import("./status.summary-buWit48F.js");
...
function loadCommandConfigResolutionModule() {
	commandConfigResolutionModulePromise ??= import("./command-config-resolution-DxzXZmbv.js");
	return commandConfigResolutionModulePromise;
}
function loadCommandSecretTargetsModule() {
	commandSecretTargetsModulePromise ??= import("./command-secret-targets-DYqFtr-T.js");
