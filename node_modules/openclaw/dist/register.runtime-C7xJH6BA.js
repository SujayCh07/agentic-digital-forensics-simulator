...
import { a as upsertAuthProfile, n as listProfilesForProvider } from "./profiles-BpuHvuWc.js";
import { n as suggestOAuthProfileIdForLegacyDefault } from "./repair-BM6HeDvJ.js";
import { t as formatCliCommand } from "./command-format-Ct8eiFod.js";
import { i as cloneFirstTemplateModel } from "./provider-model-shared-CJJooY3e.js";
...
import { n as validateAnthropicSetupToken, t as buildTokenProfileId } from "./provider-auth-token-DxE954qU.js";
import { t as createProviderApiKeyAuthMethod } from "./provider-api-key-auth-DYrKJLvb.js";
import "./provider-auth-CUgkNKj0.js";
import { a as fetchClaudeUsage } from "./provider-usage-DkQbwVjq.js";
import { n as readClaudeCliCredentialsForSetup, r as readClaudeCliCredentialsForSetupNonInteractive, t as readClaudeCliCredentialsForRuntime } from "./cli-auth-seam-DubcxaLQ.js";
import { i as CLAUDE_CLI_DEFAULT_MODEL_REF, r as CLAUDE_CLI_DEFAULT_ALLOWLIST_REFS, t as CLAUDE_CLI_BACKEND_ID } from "./cli-shared-BTZ-OccP.js";
import { t as buildAnthropicCliBackend } from "./cli-backend-CaqccilH.js";
import { t as buildAnthropicCliMigrationResult } from "./cli-migration-CJdMFxNd.js";
import { n as normalizeAnthropicProviderConfig, t as applyAnthropicConfigDefaults } from "./config-defaults-tnqStTSx.js";
import { t as anthropicMediaUnderstandingProvider } from "./media-understanding-provider-hF5u1ZnJ.js";
import { t as buildAnthropicReplayPolicy } from "./replay-policy-Bnuigd3i.js";
import { c as wrapAnthropicProviderStream } from "./stream-wrappers-lSUkljNz.js";
...
function registerAnthropicPlugin(api) {
	...
	api.registerProvider({
		...
		resolveDefaultThinkingLevel: ({ modelId }) => matchesAnthropicModernModel(modelId) && shouldUseAnthropicAdaptiveThinkingDefault(modelId) ? "adaptive" : void 0,
