...
import { s as isValidEnvSecretRefId } from "./types.secrets-D-R9X_jm.js";
...
import "./daemon-runtime-CpWHq7uR.js";
import { t as resolveControlUiLinks } from "./control-ui-links-r41EcVUf.js";
import { c as normalizeGatewayTokenInput, d as randomToken, h as waitForGatewayReachable, n as applyWizardMetadata, o as handleReset, r as ensureWorkspaceAndSessions, t as DEFAULT_WORKSPACE } from "./onboard-helpers-Dkw5XEfG.js";
...
import { c as resolveManifestProviderOnboardAuthFlags, i as resolveDeprecatedAuthChoiceReplacement, n as isDeprecatedAuthChoice, r as normalizeLegacyOnboardAuthChoice, t as formatDeprecatedNonInteractiveAuthChoiceError } from "./auth-choice-legacy-6fhWTOsi.js";
import { t as runSetupWizard } from "./setup-Nh1FsuZI.js";
import { r as applyLocalSetupWorkspaceConfig } from "./onboard-config-BKmM5oXd.js";
...
async function collectGatewayHealthFailureDiagnostics() {
	const diagnostics = {};
	try {
		const { resolveGatewayService } = await import("./service-DWtc-JBo.js");
	...
	try {
		const { readLastGatewayErrorLine } = await import("./diagnostics-Bler34v8.js");
...
async function runNonInteractiveLocalSetup(params) {
	...
	if (authChoice !== "skip") {
		const { applyNonInteractiveAuthChoice } = await import("./auth-choice-0zTdPrpV.js");
	...
	if (opts.installDaemon) {
		const { installGatewayDaemonNonInteractive } = await import("./daemon-install-iL4uEtje.js");
