...
import { n as loadOpenClawPluginCliRegistry, r as loadOpenClawPlugins } from "./loader-DtbRRnBD.js";
import { i as resolvePluginRuntimeLoadContext, r as createPluginRuntimeLoaderLogger, t as buildPluginRuntimeLoadOptions } from "./load-context-B991RQiw.js";
import { a as registerLazyCommandGroup, c as collectUniqueCommandDescriptors, n as getCommandGroupNames, o as removeCommandGroupNames, t as findCommandGroupEntry } from "./register-command-groups-CkTNLkX8.js";
...
function buildPluginCliLoaderParams(context, loaderOptions) {
...
async function loadPluginCliMetadataRegistryWithContext(context, loaderOptions) {
	return {
		...context,
		registry: await loadOpenClawPluginCliRegistry(buildPluginCliLoaderParams(context, loaderOptions))
	};
}
async function loadPluginCliCommandRegistryWithContext(params) {
	const runtimeRegistry = loadOpenClawPlugins(buildPluginCliLoaderParams(params.context, params.loaderOptions));
	if (!hasIgnoredAsyncPluginRegistration(runtimeRegistry)) return {
		...params.context,
		registry: runtimeRegistry
	};
	try {
		const metadataRegistry = await loadOpenClawPluginCliRegistry(buildPluginCliLoaderParams(params.context, params.loaderOptions));
		return {
			...params.context,
			registry: {
				...runtimeRegistry,
