...
import { _ as resolveStateDir, o as resolveConfigPath } from "./paths-nQmEmngS.js";
import { t as DEFAULT_AGENT_ID } from "./session-key-BMb3Kc4r.js";
...
import { i as normalizeTrustedSafeBinDirs, o as listRiskyConfiguredSafeBins } from "./exec-safe-bin-trust-Bx-S8dBH.js";
import { n as formatPermissionRemediation, r as inspectPathPermissions, t as formatPermissionDetail } from "./audit-fs-BSuIgIi5.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-DL0LcytF.js";
import { i as hasNonEmptyString } from "./channel-target-Bg3H23OH.js";
import { t as hasPotentialConfiguredChannels } from "./config-presence-DnNFIU-O.js";
...
import { H as isInterpreterLikeAllowlistPattern, l as loadExecApprovals } from "./exec-approvals-DT4-ZzBV.js";
...
import { n as collectEnabledInsecureOrDangerousFlags, t as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-cKI4QHBp.js";
import path from "node:path";
import { isIP } from "node:net";
//#region src/security/audit-deep-code-safety.ts
let auditDeepModulePromise;
async function loadAuditDeepModule() {
	auditDeepModulePromise ??= import("./audit.deep.runtime-CrUgkSNY.js");
...
async function loadChannelPlugins() {
	channelPluginsModulePromise ??= import("./plugins-w8dw43re.js");
	return await channelPluginsModulePromise;
}
async function loadAuditNonDeepModule() {
	auditNonDeepModulePromise ??= import("./audit.nondeep.runtime-BvjQDYyj.js");
	return await auditNonDeepModulePromise;
}
async function loadAuditChannelModule() {
	auditChannelModulePromise ??= import("./audit-channel.collect.runtime-DVaUHdTQ.js");
...
async function loadPluginMetadataRegistryLoaderModule() {
	pluginMetadataRegistryLoaderModulePromise ??= import("./metadata-registry-loader-BClXXQAl.js");
...
async function loadGatewayProbeDeps() {
	gatewayProbeDepsPromise ??= Promise.all([
		import("./call-CTD_GJcD.js"),
		import("./probe-auth-bqrN0AKW.js"),
		import("./probe-CKHjsoN-.js")
