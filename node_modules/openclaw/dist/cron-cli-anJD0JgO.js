...
import { f as sanitizeAgentId } from "./session-key-BMb3Kc4r.js";
...
import { n as formatDurationHuman } from "./format-duration-DEtUcYVv.js";
import { i as parseAbsoluteTimeMs, n as resolveCronStaggerMs } from "./stagger-CV05Nz97.js";
		...
		try {
			...
			const payload = (() => {
				...
				return {
					...
					toolsAllow: typeof opts.tools === "string" && opts.tools.trim() ? opts.tools.split(",").map((t) => normalizeOptionalString(t)).filter((t) => Boolean(t)) : void 0
				};
			})();
