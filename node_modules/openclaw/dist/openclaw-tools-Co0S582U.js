import { r as redactSensitiveText, t as getDefaultRedactPatterns } from "./redact-D2rMISX2.js";
import { i as formatErrorMessage } from "./errors-DcAstocv.js";
import { c as normalizeOptionalStringifiedId, d as readStringValue, i as normalizeLowercaseStringOrEmpty, o as normalizeOptionalLowercaseString, s as normalizeOptionalString } from "./string-coerce-CIT1-v_a.js";
import { x as readLoggingConfig } from "./logger-ChPQoo5e.js";
import { b as truncateUtf16Safe, l as isRecord, m as resolveUserPath } from "./utils-Supr9KvU.js";
import { C as normalizeChannelId, d as normalizeMessageChannel, g as GATEWAY_CLIENT_MODES, h as GATEWAY_CLIENT_IDS, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-DKMzUOS9.js";
import { t as sanitizeForLog } from "./ansi-B_y-Sue5.js";
import { t as createSubsystemLogger } from "./subsystem-DX_oTata.js";
import { n as ensureAuthProfileStore, o as loadAuthProfileStoreForRuntime } from "./store-C6K7theB.js";
import { n as resolveAgentModelPrimaryValue, t as resolveAgentModelFallbackValues } from "./model-input-BeL2x3zu.js";
import { T as normalizeModelRef, f as resolveConfiguredModelRef, h as resolveModelRefFromString, i as buildModelAliasIndex, n as buildConfiguredAllowlistKeys, p as resolveDefaultModelForAgent, t as buildAllowedModelSet, w as modelKey } from "./model-selection-JHakuCn9.js";
import { r as normalizeProviderId } from "./provider-id-C2ErhgDG.js";
import { r as resolveManifestContractOwnerPluginId } from "./manifest-registry-_lSkajSy.js";
import { C as parseThreadSessionSuffix, c as normalizeAgentId, f as sanitizeAgentId, r as buildAgentMainSessionKey, t as DEFAULT_AGENT_ID, u as resolveAgentIdFromSessionKey, x as parseAgentSessionKey } from "./session-key-BMb3Kc4r.js";
import { n as normalizeAccountId } from "./account-id-BfovDWrj.js";
import { b as resolveSessionAgentIds, i as resolveAgentConfig, m as resolveAgentWorkspaceDir, s as resolveAgentExecutionContract, y as resolveSessionAgentId } from "./agent-scope-BfV3ML7Z.js";
import { a as shouldLogVerbose, r as logVerbose } from "./globals-dovsmtt4.js";
import { t as logDebug } from "./logger-BDhhZXxv.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-CF547YAW.js";
import { a as loadConfig, m as resolveConfigSnapshotHash, o as parseConfigJson5 } from "./io-BxA9F2P4.js";
import { i as normalizeChannelId$1, r as listChannelPlugins, t as getChannelPlugin } from "./registry-FZxml0NK.js";
import { i as applyMergePatch } from "./schema-validator-GRNuA_Cl.js";
import { t as getProviderEnvVars } from "./provider-env-vars-CJ5VQ_ih.js";
import { t as parseDurationMs } from "./parse-duration-BED1xH5w.js";
import { t as isInboundPathAllowed } from "./inbound-path-policy-Cicf_VeK.js";
import "./config-BgwTLDRu.js";
import { f as resolveProfilesUnavailableReason, n as resolveAuthProfileOrder, o as getSoonestCooldownExpiry, s as isProfileInCooldown } from "./order-DuUOViI_.js";
import { n as normalizeSecretInput } from "./normalize-secret-input-CiNKqD_t.js";
import { y as normalizeProviderTransportWithPlugin } from "./provider-runtime-CVZlG3kK.js";
import "./plugins-BUdv0ZMS.js";
import { t as redactIdentifier } from "./redact-identifier-BESF6Xm6.js";
import { c as updateSessionStore } from "./store-ZWCZ_LZI.js";
import { t as extractDeliveryInfo } from "./sessions-DmA78qkx.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, u as resolveStorePath } from "./paths-DgoT9gfU.js";
import { n as resolveSessionConversationRef } from "./session-conversation-Bi635TKW.js";
import { a as normalizeDeliveryContext } from "./delivery-context-ymOZ0DxO.js";
import { t as loadSessionStore } from "./store-load-DlllQPOX.js";
import { r as isRestartEnabled } from "./commands-DRkOcZyK.js";
import { t as ensureOpenClawModelsJson } from "./models-config-D3FH3I9Q.js";
import { t as requireApiKey } from "./model-auth-runtime-shared-DYhs3pFO.js";
import { r as loadModelCatalog } from "./model-catalog-Jxv_Vdyq.js";
import { a as discoverModels, i as discoverAuthStorage } from "./pi-model-discovery-CD8Pk9o9.js";
import { f as resolveSessionModelIdentityRef } from "./session-utils-CWK8x2LN.js";
import { l as jsonUtf8Bytes, n as capArrayByJsonBytes } from "./session-utils.fs-CRRgWucy.js";
import { n as SILENT_REPLY_TOKEN } from "./tokens-fmnHbQeT.js";
import { w as textToSpeech } from "./tts-Diwjgt15.js";
import "./pi-embedded-helpers-C6AEBQ28.js";
import { i as parseApiErrorInfo } from "./assistant-error-format-BBUuuX3T.js";
import { O as stableStringify, c as getApiErrorPayloadFingerprint, g as isLikelyContextOverflowError, i as classifyProviderRuntimeFailureKind } from "./errors-C4D11NsW.js";
import { C as UPDATE_PLAN_TOOL_DISPLAY_SUMMARY, D as describeSessionsSendTool, E as describeSessionsListTool, O as describeSessionsSpawnTool, S as SESSION_STATUS_TOOL_DISPLAY_SUMMARY, T as describeSessionsHistoryTool, b as SESSIONS_SEND_TOOL_DISPLAY_SUMMARY, h as CRON_TOOL_DISPLAY_SUMMARY, k as describeUpdatePlanTool, v as SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY, w as describeSessionStatusTool, x as SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY, y as SESSIONS_LIST_TOOL_DISPLAY_SUMMARY } from "./tool-policy-Pf1EE_aO.js";
import { a as getImageMetadata } from "./image-ops-Bdlr5m93.js";
import { i as resolveImageSanitizationLimits, r as sanitizeToolResultImages } from "./tool-images-DmlD3d_S.js";
import { i as resolveChannelMessageToolSchemaProperties, n as channelSupportsMessageCapabilityForChannel, t as channelSupportsMessageCapability } from "./message-action-discovery-CJiXcvIz.js";
import { c as listChannelSupportedActions, o as listAllChannelSupportedActions, r as resolvePluginTools } from "./tools-VzW23P3y.js";
import { i as imageMimeFromFormat, t as detectMime } from "./mime-0OurzcCb.js";
import { a as isTimeoutError, i as isFailoverError, n as coerceToFailoverError, r as describeFailoverError, t as FailoverError } from "./failover-error-B7MtP_GM.js";
import { r as getApiKeyForModel } from "./model-auth-D5Ak_Bm7.js";
import { t as SsrFBlockedError } from "./ssrf-C2YYZEse.js";
import { b as toRelativeWorkspacePath, c as normalizeWorkspaceDir, l as resolveWorkspaceRoot, x as parseReplyDirectives } from "./deliver-BA26RCnu.js";
import { t as extractTextFromChatContent } from "./chat-content-C-A8z-wj.js";
import { c as stripReasoningTagsFromText } from "./assistant-visible-text-KiIaWnQV.js";
import { t as extractAssistantText } from "./pi-embedded-utils-Cr5nYiZd.js";
import { r as callGateway } from "./call-CZD7wgnV.js";
import { c as jsonResult, d as readNumberParam, h as readStringParam$1, o as imageResult, p as readStringArrayParam, r as ToolInputError, y as readSnakeCaseParamRaw } from "./common-ub5s4Xdi.js";
import { n as readGatewayCallOptions, r as resolveGatewayOptions, t as callGatewayTool } from "./gateway-BRUlEFvm.js";
import { h as writeFileWithinRoot, l as readFileWithinRoot, r as appendFileWithinRoot, s as openFileWithinRoot, t as SafeOpenError } from "./fs-safe-DQfR1Er7.js";
import { a as trySafeFileURLToPath } from "./local-file-access-sNeIekEK.js";
import { n as assertSandboxPath } from "./sandbox-paths-CyfULaCc.js";
import { A as AGENT_LANE_NESTED, D as REPLY_SKIP_TOKEN, E as ANNOUNCE_SKIP_TOKEN, N as deliverSubagentAnnouncement, O as isAnnounceSkip, P as formatAgentInternalEventsForPrompt, T as runAgentStep, k as isReplySkip, m as registerSubagentRun } from "./subagent-registry-o0amFUMK.js";
import { a as getDefaultMediaLocalRoots } from "./local-roots-D0wkyf-C.js";
import { t as sendMessage } from "./message-CYBPqitu.js";
import { n as resolveNode, r as resolveNodeId } from "./nodes-utils-VlNTLqBf.js";
import { n as getActiveRuntimeWebToolsMetadata } from "./runtime-web-tools-state-CN9M1dbQ.js";
import { i as getActiveSecretsRuntimeSnapshot, r as getActiveRuntimeWebToolsMetadata$1 } from "./runtime-B-1Vt5_c.js";
import { a as createSessionVisibilityGuard, c as resolveDisplaySessionKey, d as resolveSessionReference, f as resolveVisibleSessionReference, i as createAgentToAgentPolicy, l as resolveInternalSessionKey, n as deriveChannel, o as resolveEffectiveSessionToolsVisibility, p as shouldResolveSessionIdInput, r as resolveSessionToolContext, s as resolveSandboxedSessionToolContext, t as classifySessionKind, u as resolveMainSessionAlias } from "./sessions-helpers-BnRmB9gS.js";
import { i as stripToolMessages } from "./chat-history-text-DoPSbUOY.js";
import { a as parseCanvasSnapshotPayload, c as parseCameraSnapPayload, d as writeCameraPayloadToFile, i as canvasSnapshotTempPath, l as writeBase64ToFile, n as screenRecordTempPath, o as cameraTempPath, r as writeScreenRecordToFile, s as parseCameraClipPayload, t as parseScreenRecordPayload, u as writeCameraClipPayloadToFile } from "./nodes-screen-DCEMfn4c.js";
import { i as stringEnum, n as channelTargetsSchema, r as optionalStringEnum, t as channelTargetSchema } from "./typebox-SqwBJCFe.js";
import { c as TrimmedNonEmptyStringFieldSchema, l as parseDeliveryInput, s as TimeoutSecondsFieldSchema, t as inferLegacyName, u as parseOptionalField } from "./normalize-CmxhuXwJ.js";
import { i as parseAbsoluteTimeMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-CV05Nz97.js";
import { n as formatDoctorNonInteractiveHint, s as writeRestartSentinel } from "./restart-sentinel-DNIg3Fo-.js";
import { o as scheduleGatewaySigusr1Restart } from "./restart-BU9hPRes.js";
import { r as parseImageGenerationModelRef } from "./provider-registry-BDEA9H95.js";
import { n as listRuntimeImageGenerationProviders, t as generateImage } from "./runtime-cJP5Z-yW.js";
import { l as saveMediaBuffer } from "./store-dly0-xmm.js";
import { n as loadWebMediaRaw, o as getDefaultLocalRoots, t as loadWebMedia } from "./web-media-DqvsPtjN.js";
import { a as coerceImageModelConfig, c as buildToolModelConfigFromCandidates, d as hasToolModelConfig, f as resolveDefaultModelRef, l as coerceToolModelConfig, n as isMinimaxVlmProvider, o as decodeDataUrl, s as resolveProviderVisionModelFromConfig, u as hasAuthForProvider } from "./minimax-vlm-CJ_qZdXa.js";
import { n as resolveSandboxedBridgeMediaPath, t as createSandboxBridgeReadFile } from "./sandbox-media-paths-DxyxL_PI.js";
import { i as getMediaUnderstandingProvider } from "./entry-capabilities-C6YwKwow.js";
import { C as resolveBundledAutoMediaKeyProviders, S as bundledProviderSupportsNativePdfDocument, b as resolveAutoMediaKeyProviders, w as resolveBundledDefaultMediaModel, x as resolveDefaultMediaModel } from "./resolve-CsZzCFjt.js";
import { n as describeImagesWithModel, t as describeImageWithModel } from "./image-runtime-DQKrFOHC.js";
import { t as buildProviderRegistry } from "./runner-Cul8J0kX.js";
import "./media-understanding-BnPImMNS.js";
import { n as CHANNEL_MESSAGE_ACTION_NAMES, t as resolveMessageSecretScope } from "./message-secret-scope-BfHO8cwH.js";
import { t as resolveCommandSecretRefsViaGateway } from "./command-secret-gateway-C-GFh_8s.js";
import { r as sortWebFetchProvidersForAutoDetect } from "./web-fetch-providers.shared-Btd8qVg-.js";
import { a as getScopedChannelsCommandSecretTargets } from "./command-secret-targets-CwmU9KOt.js";
import { c as POLL_CREATION_PARAM_DEFS, l as SHARED_POLL_CREATION_PARAM_NAMES, n as runMessageAction, t as getToolResult } from "./message-action-runner-1jKqal46.js";
import { i as resolveMusicGenerationModeCapabilities, n as listRuntimeMusicGenerationProviders, r as listSupportedMusicGenerationModes, t as generateMusic } from "./runtime-XAcGuPRK.js";
import { r as parseMusicGenerationModelRef } from "./provider-registry-CBZ5dKEI.js";
import { n as formatTaskStatusDetail, r as formatTaskStatusTitle } from "./task-status-BmJw1BPW.js";
import { f as listTasksForOwnerKey } from "./task-registry-C9aRX_4L.js";
import "./runtime-internal-DMClajE6.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, r as completeTaskRunByRunId, s as recordTaskRunProgressByRunId } from "./task-executor-DOYhQe5J.js";
import "./task-registry-delivery-runtime-CAuMSzTR.js";
import { t as resolveNodePairApprovalScopes } from "./node-pairing-authz-DmjGLxqv.js";
import { t as parseTimeoutMs } from "./parse-timeout-Ct6bXATC.js";
import { t as extractPdfContent } from "./pdf-extract-oiSxD7Pn.js";
import { t as applyModelOverrideToSessionEntry } from "./model-overrides-DTy0-qnF.js";
import { t as buildTaskStatusSnapshotForRelatedSessionKeyForOwner } from "./task-owner-access-CCg_8s5G.js";
import { i as waitForAgentRunAndReadUpdatedAssistantReply, n as readLatestAssistantReplySnapshot, r as waitForAgentRun, t as readLatestAssistantReply } from "./run-wait-DYlekpxL.js";
import { n as SUBAGENT_SPAWN_MODES, t as spawnSubagentDirect } from "./subagent-spawn-Cy0SSGcN.js";
import { i as isActiveSubagentRun, n as buildSubagentList, r as createPendingDescendantCounter } from "./subagent-list-CulL_5M-.js";
import { c as resolveSubagentController, i as killControlledSubagentRun, n as MAX_STEER_MESSAGE_CHARS, o as listControlledSubagentRuns, r as killAllControlledSubagentRuns, s as resolveControlledSubagentTarget, t as MAX_RECENT_MINUTES, u as steerControlledSubagentRun } from "./subagent-control-rr3Pijjq.js";
import { a as resolveVideoGenerationModeCapabilities, i as resolveVideoGenerationMode, n as listRuntimeVideoGenerationProviders, r as listSupportedVideoGenerationModes, t as generateVideo } from "./runtime-CAiaB-t1.js";
import { r as parseVideoGenerationModelRef } from "./provider-registry-Bq-J6JYY.js";
import { c as wrapWebContent, s as wrapExternalContent } from "./external-content-DZdKqcfx.js";
import { t as resolvePluginWebFetchProviders } from "./web-fetch-providers.runtime-CIU8KB3O.js";
import { a as runWebSearch, c as readWebProviderEnvValue, i as resolveWebSearchDefinition, l as resolveWebProviderConfig, o as hasWebProviderEntryCredential, s as providerRequiresCredential, u as resolveWebProviderDefinition } from "./runtime-DGf183HT.js";
import { _ as truncateText$1, a as readResponseText, g as markdownToText, h as htmlToMarkdown, i as readCache, l as writeCache, m as extractReadableContent, o as resolveCacheTtlMs, p as extractBasicHtmlContent, r as normalizeCacheKey, s as resolveTimeoutSeconds, u as fetchWithWebToolsNetworkGuard } from "./web-shared-CgdCBrwh.js";
import "./web-search-provider-common-BDqEWHr-.js";
...
function isStrictAgenticExecutionContractActive(params) {
	...
	if (resolveAgentExecutionContract(params.config, sessionAgentId) !== "strict-agentic") return false;
...
function logModelFallbackDecision(params) {
	...
	decisionLog.warn("model fallback decision", {
		...
		consoleMessage: `model fallback decision: decision=${params.decision} requested=${sanitizeForLog(params.requestedProvider)}/${sanitizeForLog(params.requestedModel)} candidate=${sanitizeForLog(params.candidate.provider)}/${sanitizeForLog(params.candidate.model)} reason=${reasonText} next=${nextText}${detailSuffix}`
	});
}
//#endregion
...
function loadCommandsStatusRuntime() {
	commandsStatusRuntimePromise ??= import("./commands-status.runtime-CVm93ALy.js");
...
let sessionsSendA2ADeps = { callGateway };
...
async function loadAcpSpawnModule() {
	acpSpawnModulePromise ??= import("./acp-spawn-Bw688BcM.js");
...
async function executeVideoGenerationJob(params) {
	...
	const savedVideos = await Promise.all(result.videos.map((video) => saveMediaBuffer(video.buffer, video.mimeType, "tool-video-generation", void 0, params.filename || video.fileName)));
	const requestedDurationSeconds = result.normalization?.durationSeconds?.requested ?? (typeof result.metadata?.requestedDurationSeconds === "number" && Number.isFinite(result.metadata.requestedDurationSeconds) ? result.metadata.requestedDurationSeconds : params.durationSeconds);
	const ignoredOverrides = result.ignoredOverrides ?? [];
	const ignoredOverrideKeys = new Set(ignoredOverrides.map((entry) => entry.key));
	...
	return {
		...
		details: {
			...
			media: { mediaUrls: savedVideos.map((video) => video.path) },
...
//#endregion
export { createSandboxedWriteTool as C, sniffMimeFromBase64 as D, wrapToolWorkspaceRootGuardWithOptions as E, buildApiErrorObservationFields as O, createSandboxedReadTool as S, wrapToolWorkspaceRootGuard as T, isStrictAgenticExecutionContractActive as _, buildActiveVideoGenerationTaskPromptContextForSession as a, createOpenClawReadTool as b, runWithModelFallback as c, normalizeHttpWebhookUrl as d, normalizeCronJobCreate as f, isInvalidCronSessionTargetIdError as g, assertSafeCronSessionTargetId as h, resolveWebFetchDefinition as i, buildTextObservationFields as k, LiveSessionModelSwitchError as l, normalizeCronJobPatch as m, isWebFetchProviderConfigured as n, buildActiveMusicGenerationTaskPromptContextForSession as o, normalizeCronJobInput as p, listWebFetchProviders as r, isFallbackSummaryError as s, createOpenClawTools as t, shouldAllowCooldownProbeForReason as u, createHostWorkspaceEditTool as v, wrapToolMemoryFlushAppendOnlyWrite as w, createSandboxedEditTool as x, createHostWorkspaceWriteTool as y };
