...
const loadProviderApiKeyAuthRuntime = createLazyRuntimeSurface(() => import("./provider-api-key-auth.runtime-D3a2CUmo.js"), ({ providerApiKeyAuthRuntime }) => providerApiKeyAuthRuntime);
		...
		run: async (ctx) => {
			...
			return {
				profiles: resolveProfileIds(params).map((profileId) => ({
					profileId,
					credential: buildApiKeyCredential(normalizeOptionalString(profileId.split(":", 1)[0]) || params.providerId, credentialInput, params.metadata, capturedMode ? { secretInputMode: capturedMode } : void 0)
				})),
