import { a as normalizeNullableString, i as normalizeLowercaseStringOrEmpty, s as normalizeOptionalString } from "./string-coerce-CIT1-v_a.js";
import { n as defaultRuntime } from "./runtime-BXaxArxm.js";
import { r as getActivePluginRegistry } from "./runtime-BrxjAC6F.js";
import { o as sameFileIdentity } from "./boundary-file-read-wXLXKYbz.js";
...
import { r as theme, t as colorize } from "./theme-M8d3WnX0.js";
import { n as VERSION } from "./version-BnlvIG4z.js";
import { i as resolveAgentConfig } from "./agent-scope-BfV3ML7Z.js";
import { a as logWarn } from "./logger-BDhhZXxv.js";
import { a as loadConfig } from "./io-BxA9F2P4.js";
import { c as sanitizeSystemRunEnvOverrides, o as sanitizeHostExecEnv, t as inspectHostExecEnvOverrides } from "./host-env-security-CFlHILzU.js";
import { A as POSIX_INLINE_COMMAND_FLAGS, F as unwrapKnownDispatchWrapperInvocation, I as normalizeExecutableToken, M as resolveInlineCommandMatch, O as resolveShellWrapperTransportArgv, S as POSIX_SHELL_WRAPPERS, d as resolveApprovalAuditCandidatePath, k as unwrapKnownShellMultiplexerInvocation, p as resolveCommandResolutionFromArgv, y as resolveExecutableFromPathEnv } from "./exec-safe-bin-trust-Bx-S8dBH.js";
import "./config-BgwTLDRu.js";
import { i as NODE_SYSTEM_RUN_COMMANDS, n as NODE_EXEC_APPROVALS_COMMANDS } from "./node-commands-C6svssoQ.js";
import { t as formatCliCommand } from "./command-format-Ct8eiFod.js";
import { _ as resolveNodeSystemdServiceName, g as resolveNodeLaunchAgentLabel, u as formatNodeServiceDescription, v as resolveNodeWindowsTaskName } from "./paths-DMIWQCKU.js";
import { i as resolveDaemonNodeBinDir, n as emitDaemonInstallRuntimeWarning, o as resolveNodeProgramArguments, r as resolveDaemonInstallRuntimeInputs } from "./auth-token-resolution-BkDYbhVz.js";
import { s as buildNodeServiceEnvironment } from "./runtime-paths-CD_jnoQ3.js";
import { r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-CpWHq7uR.js";
import { f as GatewayClient } from "./method-scopes-Cgh_6px_.js";
import { n as loadOrCreateDeviceIdentity } from "./device-identity-DNEx-cD9.js";
import { d as resolveRuntimeStatusColor, g as installDaemonServiceAndEmit, m as buildDaemonServiceSnapshot, n as createDaemonInstallActionContext, p as parsePort, r as failIfNixDaemonInstallMode, t as createCliStatusTextStyles } from "./shared-CIcJTnAY.js";
import { a as formatRuntimeStatus, i as buildPlatformServiceStartHints, r as buildPlatformRuntimeLogHints } from "./systemd-hints-BK-zTfCn.js";
import { i as runServiceUninstall, r as runServiceStop, t as runServiceRestart } from "./lifecycle-core-DbqvR19j.js";
import { t as getMachineDisplayName } from "./machine-name-BJy0DdGb.js";
import { t as splitShellArgs } from "./shell-argv-A1qxuvMJ.js";
import { B as describeInterpreterInlineEval, C as requiresExecApproval, E as resolveExecApprovals, M as requestJsonlSocket, N as evaluateExecAllowlist, P as evaluateShellAllowlist, U as analyzeArgvCommand, V as detectInterpreterInlineEvalArgv, Y as resolvePlannedSegmentArgv, a as addDurableCommandApproval, b as recordAllowlistMatchesUse, d as mergeExecApprovalsSocketDefaults, j as saveExecApprovals, o as ensureExecApprovals, p as normalizeExecApprovals, s as hasDurableExecApproval, v as persistAllowAlwaysPatterns, y as readExecApprovalsSnapshot } from "./exec-approvals-DT4-ZzBV.js";
import { r as resolveExecSafeBinRuntimePolicy, t as isInterpreterLikeSafeBin } from "./exec-safe-bin-runtime-policy-CaEkF0Me.js";
import { n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand } from "./system-run-command-epGu4XTy.js";
import { t as resolveGatewayConnectionAuth } from "./connection-auth-QIIHfv5F.js";
import { t as formatHelpExamples } from "./help-format-DrCUsEHo.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-BX9gj_hd.js";
import { n as loadNodeHostConfig, r as saveNodeHostConfig, t as ensureNodeHostConfig } from "./config-BN00WiPQ.js";
import { t as resolveNodeService } from "./node-service-CbsHQHWH.js";
...
function shellPayloadNeedsStableBinding(shellCommand, cwd) {
	...
	return resolvesToExistingFileSync(readTrimmedArgToken(argv, 0), cwd);
}
...
async function loadPluginRegistryLoaderModule() {
	pluginRegistryLoaderModulePromise ??= import("./runtime-registry-loader-2Cx0BcBL.js");
