...
import { d as resolveCodexAppServerRuntimeOptions, n as listCodexAppServerModels, r as clearSharedCodexAppServerClient, u as readCodexPluginConfig } from "./harness-uOoDA-Wv.js";
...
async function buildCodexProviderCatalog(options = {}) {
	...
	let discovered = [];
	if (config.discovery?.enabled !== false && !shouldSkipLiveDiscovery(options.env)) try {
