...
import { n as getBridgeAuthForPort } from "./bridge-auth-registry-CviQemxN.js";
...
async function fetchBrowserJson(url, init) {
	...
	try {
		...
		const { dispatchBrowserControlRequest } = await import("./local-dispatch.runtime-Bs24_A7N.js");
