...
import { x as getActivePluginRegistryWorkspaceDirFromState } from "./runtime-BrxjAC6F.js";
import { s as resolvePluginCacheInputs } from "./ids-BSkPonH4.js";
import { r as normalizeProviderId } from "./provider-id-C2ErhgDG.js";
import { K as resolveBundledProviderPolicySurface } from "./io-BxA9F2P4.js";
import { i as resolveCatalogHookProviderPluginIds } from "./plugin-auto-enable-DL0LcytF.js";
import { n as resolvePluginProviders, t as isPluginProvidersLoadInFlight } from "./providers.runtime-KO25kiSD.js";
...
function resolveRuntimeTextTransforms() {
	return mergePluginTextTransforms(...loadPluginRuntime()?.getActivePluginRegistry()?.textTransforms?.map((entry) => entry.transforms) ?? []);
}
//#endregion
...
//#endregion
export { applyPluginTextReplacements as $, resolveProviderConfigApiKeyWithPlugin as A, resolveProviderTransportTurnStateWithPlugin as B, refreshProviderOAuthCredentialWithPlugin as C, resolveProviderBinaryThinking as D, resolveExternalOAuthProfilesWithPlugins as E, resolveProviderRuntimePlugin as F, runProviderDynamicModel as G, resolveProviderUsageSnapshotWithPlugin as H, resolveProviderStreamFn as I, shouldPreferProviderRuntimeResolvedModel as J, sanitizeProviderReplayHistoryWithPlugin as K, resolveProviderSyntheticAuthWithPlugin as L, resolveProviderModernModelRef as M, resolveProviderReasoningOutputModeWithPlugin as N, resolveProviderBuiltInModelSuppression as O, resolveProviderReplayPolicyWithPlugin as P, resolveRuntimeTextTransforms as Q, resolveProviderSystemPromptContribution as R, prepareProviderRuntimeAuth as S, resolveExternalAuthProfilesWithPlugins as T, resolveProviderWebSocketSessionPolicyWithPlugin as U, resolveProviderUsageAuthWithPlugin as V, resolveProviderXHighThinking as W, validateProviderReplayTurnsWithPlugin as X, transformProviderSystemPrompt as Y, wrapProviderStreamFn as Z, normalizeProviderResolvedModelWithPlugin as _, augmentModelCatalogWithProviderPlugins as a, prepareProviderDynamicModel as b, buildProviderUnknownModelHintWithPlugin as c, createProviderEmbeddingProvider as d, mergePluginTextTransforms as et, formatProviderAuthProfileApiKeyWithPlugin as f, normalizeProviderModelIdWithPlugin as g, normalizeProviderConfigWithPlugin as h, applyProviderResolvedTransportWithPlugin as i, resolveProviderDefaultThinkingLevel as j, resolveProviderCacheTtlEligibility as k, classifyProviderFailoverReasonWithPlugin as l, matchesProviderContextOverflowWithPlugin as m, applyProviderNativeStreamingUsageCompatWithPlugin as n, buildProviderAuthDoctorHintWithPlugin as o, inspectProviderToolSchemasWithPlugin as p, shouldDeferProviderSyntheticProfileAuthWithPlugin as q, applyProviderResolvedModelCompatWithPlugins as r, buildProviderMissingAuthMessageWithPlugin as s, applyProviderConfigDefaultsWithPlugin as t, wrapStreamFnTextTransforms as tt, clearProviderRuntimeHookCache as u, normalizeProviderToolSchemasWithPlugin as v, resetProviderRuntimeHookCacheForTest as w, prepareProviderExtraParams as x, normalizeProviderTransportWithPlugin as y, resolveProviderTextTransforms as z };
