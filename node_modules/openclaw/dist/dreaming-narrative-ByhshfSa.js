import { c as readErrorName, i as formatErrorMessage, r as extractErrorCode } from "./errors-DcAstocv.js";
...
async function writeBackfillDiaryEntries(params) {
	...
	const stripped = stripBackfillDiaryBlocks(await readDreamsFile(dreamsPath));
	...
	await writeDreamsFileAtomic(dreamsPath, replaceDiaryContent(stripped.updated, joinDiaryBlocks(nextBlocks)));
	return {
		dreamsPath,
...
//#endregion
export { removeBackfillDiaryEntries as n, writeBackfillDiaryEntries as r, generateAndAppendDreamNarrative as t };
