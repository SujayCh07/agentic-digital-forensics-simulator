...
function resolveSessionPluginDebugLines(entry) {
	return Array.isArray(entry?.pluginDebugEntries) ? entry.pluginDebugEntries.flatMap((pluginEntry) => Array.isArray(pluginEntry?.lines) ? pluginEntry.lines.filter((line) => typeof line === "string" && line.trim().length > 0) : []) : [];
}
...
//#endregion
export { normalizeSessionRuntimeModelFields as a, setSessionRuntimeModel as c, mergeSessionEntryWithPolicy as i, mergeSessionEntry as n, resolveFreshSessionTotalTokens as o, mergeSessionEntryPreserveActivity as r, resolveSessionPluginDebugLines as s, DEFAULT_RESET_TRIGGERS as t };
