...
import { n as estimateBase64DecodedBytes } from "./base64-CWIK4zLa.js";
...
import { a as recordKnownUser, c as matchSlashCommand, d as formatQQBotAllowFrom, l as TEXT_CHUNK_LIMIT, n as flushKnownUsers, u as chunkText } from "./known-users-Co7AJd8Z.js";
import { t as getQQBotRuntime } from "./runtime-BX6Unf9x.js";
	...
	const connect = async () => {
		...
		try {
			...
			const handleMessage = async (event) => {
				...
				const normalizedAllowFrom = formatQQBotAllowFrom({ allowFrom: account.config?.allowFrom ?? [] });
