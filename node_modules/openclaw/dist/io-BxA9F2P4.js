...
import { l as isRecord, m as resolveUserPath, x as isPlainObject } from "./utils-Supr9KvU.js";
import { o as discoverOpenClawPlugins, r as normalizeChatChannelId, s as resolvePluginCacheInputs, t as CHANNEL_IDS } from "./ids-BSkPonH4.js";
import "./model-selection-JHakuCn9.js";
import { r as normalizeProviderId } from "./provider-id-C2ErhgDG.js";
import { n as VERSION } from "./version-BnlvIG4z.js";
import { i as resolveManifestContractPluginIds, n as loadPluginManifestRegistry, r as resolveManifestContractOwnerPluginId } from "./manifest-registry-_lSkajSy.js";
import { r as hasKind } from "./slots-V5i3G255.js";
import { _ as resolveStateDir, n as DEFAULT_GATEWAY_PORT, o as resolveConfigPath } from "./paths-nQmEmngS.js";
...
import { h as resolveDefaultAgentId, m as resolveAgentWorkspaceDir } from "./agent-scope-BfV3ML7Z.js";
import { t as DEFAULT_CONTEXT_TOKENS } from "./defaults-CF547YAW.js";
import { n as asNullableRecord } from "./record-coerce-BDH91-dk.js";
import { i as runPluginSetupConfigMigrations, s as getCachedPluginJitiLoader } from "./setup-registry-B4foTAMM.js";
import { t as isSafeExecutableValue } from "./exec-safety-BD1FUk_z.js";
import { i as coerceSecretRef } from "./types.secrets-D-R9X_jm.js";
import { a as listBundledChannelPlugins, t as getBundledChannelPlugin } from "./bundled-BK4_aJhU.js";
import { r as listChannelPlugins, t as getChannelPlugin } from "./registry-FZxml0NK.js";
import { d as resolveSingleAccountKeysToMove } from "./setup-helpers-CwEENaWo.js";
import { t as loadBundledPluginPublicArtifactModuleSync } from "./public-surface-loader-BNUFx9xR.js";
import { t as resolveProviderEndpoint } from "./provider-attribution-CsssnIri.js";
import { i as normalizeEnvVarKey, n as isDangerousHostEnvOverrideVarName, r as isDangerousHostEnvVarName } from "./host-env-security-CFlHILzU.js";
import { t as loadDotEnv } from "./dotenv-vhK8GMAV.js";
import { a as shouldDeferShellEnvFallback, i as resolveShellEnvFallbackTimeoutMs, o as shouldEnableShellEnvFallback, r as loadShellEnvFallback } from "./shell-env-B9q5f8cs.js";
import { t as sanitizeTerminalText } from "./safe-text-DKoTIFsS.js";
import { n as containsEnvVarReference, r as resolveConfigEnvVars } from "./env-substitution-D2r79z3W.js";
import { a as resolveConfigIncludes, i as readConfigIncludeFileWithGuards, n as ConfigIncludeError } from "./includes-BINmk011.js";
import { i as applyMergePatch, n as appendAllowedValuesHint, r as summarizeAllowedValues, t as validateJsonSchemaValue } from "./schema-validator-GRNuA_Cl.js";
import { t as getBootstrapChannelPlugin } from "./bootstrap-registry-C57YlKdF.js";
import { i as normalizeTrustedSafeBinDirs, z as normalizeSafeBinProfileFixtures } from "./exec-safe-bin-trust-Bx-S8dBH.js";
import { a as loadPinnedRuntimeConfig, i as getRuntimeConfigSourceSnapshot, n as finalizeRuntimeSnapshotWrite, o as notifyRuntimeConfigWriteListeners, r as getRuntimeConfigSnapshot, s as registerRuntimeConfigWriteListener } from "./runtime-snapshot-jOoymAHW.js";
import { a as normalizePluginsConfig, l as resolveMemorySlotDecision, s as resolveEffectivePluginActivationState } from "./config-state-HDtzsRYk.js";
import { n as listKnownProviderAuthEnvVarNames } from "./provider-env-vars-CJ5VQ_ih.js";
import { t as withBundledPluginAllowlistCompat } from "./bundled-compat-UbHjJ4bk.js";
import { t as resolveManifestCommandAliasOwner } from "./manifest-command-aliases.runtime-D7W1wyPM.js";
import { n as loadBundledChannelSecurityContractApi } from "./channel-contract-api-Bm5QdFkt.js";
import { c as isWindowsAbsolutePath, i as isAvatarHttpUrl, n as hasAvatarUriScheme, o as isPathWithinRoot, r as isAvatarDataUrl } from "./avatar-policy-rsgxMU7d.js";
import { i as isCanonicalDottedDecimalIPv4, u as isLoopbackIpAddress } from "./ip-CoB9knDi.js";
import { t as OpenClawSchema } from "./zod-schema-CzPtd3Ip.js";
import { n as comparePrereleaseIdentifiers, r as normalizeLegacyDotBetaVersion } from "./semver-compare-4ZDXNvzC.js";
...
function resolvePluginDoctorContracts(params) {
	...
	for (const record of manifestRegistry.plugins) {
		...
		if (rules.length === 0 && !normalizeCompatibilityConfig) continue;
		entries.push({
			pluginId: record.id,
			rules,
	...
	defineLegacyConfigMigration({
		...
		legacyRules: [
			...
			},
			{
				...
				message: "channels.discord.streamMode, channels.discord.streaming (scalar), chunkMode, blockStreaming, draftChunk, and blockStreamingCoalesce are legacy; use channels.discord.streaming.{mode,chunkMode,preview.chunk,block.enabled,block.coalesce} instead. Run \"openclaw doctor --fix\".",
			...
			},
			{
				...
				message: "channels.discord.accounts.<id>.streamMode, streaming (scalar), chunkMode, blockStreaming, draftChunk, and blockStreamingCoalesce are legacy; use channels.discord.accounts.<id>.streaming.{mode,chunkMode,preview.chunk,block.enabled,block.coalesce} instead. Run \"openclaw doctor --fix\".",
...
function normalizeLegacyCrossContextMessageConfig(cfg, changes) {
	...
	if (!isRecord(rawTools)) return cfg;
	const rawMessage = rawTools.message;
	if (!isRecord(rawMessage) || !("allowCrossContextSend" in rawMessage)) return cfg;
...
function normalizeLegacyMediaProviderOptions(cfg, changes) {
	...
	if (!isRecord(rawMedia)) return cfg;
...
function migratePluginWebFetchConfig(params) {
	...
	const config = ensureRecord$2(entry, "config");
	const hadEnabled = entry.enabled !== void 0;
	const existing = isRecord(config.webFetch) ? cloneRecord$1(config.webFetch) : void 0;
	if (!hadEnabled) entry.enabled = true;
	if (!existing) {
...
function collectUnsupportedSecretRefConfigCandidates(raw) {
	...
	if (isRecord(raw.channels)) for (const channelId of Object.keys(raw.channels)) {
