...
import { m as requireActivePluginChannelRegistry, n as getActivePluginChannelRegistryVersion } from "./runtime-BrxjAC6F.js";
import { n as normalizeAtHashSlug, s as normalizeStringEntries } from "./string-normalization-IdjIlZzV.js";
import { n as CHAT_CHANNEL_ORDER } from "./ids-BSkPonH4.js";
import { S as normalizeAnyChannelId, d as normalizeMessageChannel, f as resolveGatewayMessageChannel, o as isInternalMessageChannel, r as isDeliverableMessageChannel } from "./message-channel-DKMzUOS9.js";
import { t as createSubsystemLogger } from "./subsystem-DX_oTata.js";
import { c as normalizeThinkLevel, n as formatXHighModelHint, u as normalizeVerboseLevel } from "./thinking.shared-CqTfMucU.js";
import { h as resolveModelRefFromString, i as buildModelAliasIndex, p as resolveDefaultModelForAgent } from "./model-selection-JHakuCn9.js";
import { c as normalizeAgentId, l as normalizeMainKey, r as buildAgentMainSessionKey, x as parseAgentSessionKey } from "./session-key-BMb3Kc4r.js";
import { a as resolveAgentDir, i as resolveAgentConfig, m as resolveAgentWorkspaceDir, n as listAgentEntries, p as resolveAgentSkillsFilter, y as resolveSessionAgentId } from "./agent-scope-BfV3ML7Z.js";
import { r as logVerbose } from "./globals-dovsmtt4.js";
import { d as ensureAgentWorkspace, n as DEFAULT_AGENT_WORKSPACE_DIR } from "./workspace-BPG_m9MI.js";
import "./defaults-CF547YAW.js";
import { a as loadConfig } from "./io-BxA9F2P4.js";
import { t as getBundledChannelPlugin } from "./bundled-BK4_aJhU.js";
import { i as normalizeChannelId, n as getLoadedChannelPlugin, r as listChannelPlugins, t as getChannelPlugin } from "./registry-FZxml0NK.js";
import { i as applyMergePatch } from "./schema-validator-GRNuA_Cl.js";
import "./config-BgwTLDRu.js";
import { y as resetRegisteredAgentHarnessSessions } from "./loader-DtbRRnBD.js";
import "./plugins-BUdv0ZMS.js";
import { t as getGlobalHookRunner } from "./hook-runner-global-DG7fawz5.js";
import { m as triggerInternalHook, n as createInternalHookEvent } from "./internal-hooks-CbzQncoV.js";
import { _ as deriveSessionMetaPatch, a as resolveSessionStoreEntry, c as updateSessionStore, x as resolveGroupSessionKey } from "./store-ZWCZ_LZI.js";
import { t as normalizeChatType } from "./chat-type-xxvTT8kQ.js";
import { t as canonicalizeMainSessionAlias } from "./main-session-DIxrImRz.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath, u as resolveStorePath } from "./paths-DgoT9gfU.js";
import { t as DEFAULT_RESET_TRIGGERS } from "./types-CNcb1BI5.js";
import { c as resolveThreadFlag, i as resolveChannelResetConfig, n as evaluateSessionFreshness, o as resolveSessionResetPolicy, s as resolveSessionResetType } from "./reset-B1Ek-7XP.js";
import { n as resolveSessionKey } from "./session-key-CA8qiuFn.js";
import { a as normalizeDeliveryContext, n as deliveryContextKey, o as normalizeSessionDeliveryFields, t as deliveryContextFromSession } from "./delivery-context-ymOZ0DxO.js";
import { t as loadSessionStore } from "./store-load-DlllQPOX.js";
import { t as resolveAndPersistSessionFile } from "./session-file-rIikQBFx.js";
import { i as isInterSessionInputProvenance } from "./input-provenance-BAEcdm8r.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN } from "./tokens-fmnHbQeT.js";
import { i as generateSecureToken } from "./secure-random-DJ9MB_Og.js";
import { o as getQueueSize, r as clearCommandLane } from "./command-queue-DNuzbaFL.js";
import { c as isReasoningTagProvider, r as disposeSessionMcpRuntime } from "./pi-bundle-mcp-tools-DCh_ATf1.js";
import { n as clearBootstrapSnapshotOnSessionRollover } from "./bootstrap-cache-dkjaCy6b.js";
import { n as applyOwnerOnlyToolPolicy } from "./tool-policy-Pf1EE_aO.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BTq2_Pf1.js";
import { i as supportsXHighThinking } from "./thinking-BJJhgwXQ.js";
import { t as collectTextContentBlocks } from "./content-blocks-DwxVPQZO.js";
import { r as enqueueSystemEvent } from "./system-events-Bc8HfhQ3.js";
import { f as fireAndForgetHook, n as deriveInboundMessageHookContext, o as toInternalMessageTranscribedContext, r as toInternalMessagePreprocessedContext } from "./message-hook-mappers-D3Z-srJj.js";
import { n as resolveChannelGroupRequireMention } from "./group-policy-BOK9r2Js.js";
import { t as buildOutboundSessionContext } from "./session-context-D-GeYMNh.js";
import { t as resolveQueueSettings } from "./queue-BfjMkmM1.js";
import { r as getSessionBindingService } from "./session-binding-service-CFQbst7d.js";
import { t as resolveAgentTimeoutMs } from "./timeout-CCmjZeel.js";
import { n as resolveEmbeddedFullAccessState } from "./sandbox-info-CQM-5tGI.js";
import { p as normalizeCommandBody } from "./commands-registry-CuZmchBs.js";
import { i as setAbortMemory, n as isAbortRequestText, t as getAbortMemory } from "./abort-primitives-DR4ciFkv.js";
import { t as hasControlCommand } from "./command-detection-sjcr0KU4.js";
import { t as resolveRunTypingPolicy } from "./typing-policy-ChZltKMA.js";
import { t as normalizeInboundTextNewlines } from "./inbound-text-BxYfXNRw.js";
import { t as finalizeInboundContext } from "./inbound-context-xUb6mT6i.js";
import { a as resolveEnvelopeFormatOptions, n as formatEnvelopeTimestamp, o as resolveSenderLabel } from "./envelope-jjsUhYyN.js";
import { o as stripMentions, s as stripStructuralPrefixes, t as CURRENT_MESSAGE_MARKER } from "./mentions-BBGX5kEf.js";
import { n as createTypingKeepaliveLoop, t as createTypingStartGuard } from "./typing-start-guard-R73o4x8x.js";
import { t as resolveChannelModelOverride } from "./model-overrides-DRL33Qsv.js";
import { t as normalizeGroupActivation } from "./group-activation-DqNpcGuz.js";
import { t as parseInlineDirectives } from "./directive-handling.parse-1yDOpywl.js";
import { t as resolveFastModeState } from "./fast-mode-YXWD-Zyi.js";
import { n as resolveBlockStreamingChunking } from "./block-streaming-CyJSEHOB.js";
import { t as resolveCommandAuthorization } from "./command-auth-DYJ_vQmJ.js";
import { t as buildCommandContext } from "./commands-context-DUFYBcfE.js";
import { t as isDirectiveOnly } from "./directive-handling.directive-only-CVEyXkI0.js";
import { n as extractExplicitGroupId, t as formatElevatedUnavailableMessage } from "./elevated-unavailable-CThAQ1Kx.js";
import { n as resolveSessionAuthProfileOverride } from "./session-override-C1B3ptfh.js";
import { n as createModelSelectionState, r as resolveContextTokens, t as createFastTestModelSelectionState } from "./model-selection-F7PI9cmI.js";
import { n as resolveSkillCommandInvocation, t as listReservedChatSlashCommandNames } from "./skill-commands-base-BVcPdlGk.js";
import { i as resolveAbortCutoffFromContext, o as shouldSkipMessageByAbortCutoff, r as readAbortCutoffFromSessionEntry } from "./abort-cutoff-Tdhlyxf_.js";
import { n as resolveOriginMessageProvider } from "./origin-routing-B9GL6s_J.js";
import { n as resolveTypingMode, r as resolveActiveRunQueueAction } from "./typing-mode-DZmtee8I.js";
import { t as buildBareSessionResetPrompt } from "./session-reset-prompt-DpLCIB_T.js";
import { t as drainFormattedSystemEvents } from "./session-system-events-Bga8bRm4.js";
import { i as resolveConversationBindingContextFromMessage } from "./conversation-binding-input-DyS35s86.js";
import { n as buildSessionStartHookPayload, t as buildSessionEndHookPayload } from "./session-hooks--ybH_l6f.js";
...
function loadCommandsStatus() {
	commandsStatusPromise ??= import("./commands-status.runtime-CVm93ALy.js");
	return commandsStatusPromise;
}
function loadDirectiveLevels() {
	directiveLevelsPromise ??= import("./directive-handling.levels-DKlB_6wA.js");
	return directiveLevelsPromise;
}
function loadDirectiveImpl() {
	directiveImplPromise ??= import("./directive-handling.impl-DCKAaF2-.js");
	return directiveImplPromise;
}
function loadDirectiveFastLane() {
	directiveFastLanePromise ??= import("./directive-handling.fast-lane-CWq1PC4L.js");
	return directiveFastLanePromise;
}
function loadDirectivePersist() {
	directivePersistPromise ??= import("./directive-handling.persist.runtime-DKsKgnlu.js");
...
function resolveFastSessionKey(ctx) {
	...
	return `agent:main:${normalizeOptionalString(ctx.Provider) ?? normalizeOptionalString(ctx.Surface) ?? "main"}:${normalizeOptionalString(ctx.To) ?? normalizeOptionalString(ctx.From) ?? "default"}`;
}
...
function initFastReplySessionState(params) {
	...
	const sessionEntry = {
		sessionId,
		sessionFile: path.join(workspaceDir, ".openclaw", "sessions", `${sessionId}.jsonl`),
		updatedAt: now,
...
function loadGroupsRuntime() {
	groupsRuntimePromise ??= import("./groups.runtime-ULEWyqI5.js");
...
function loadCommandsRegistry() {
	commandsRegistryPromise ??= import("./commands-registry.runtime-CgL3nSV6.js");
	return commandsRegistryPromise;
}
function loadSkillCommands() {
	skillCommandsPromise ??= import("./skill-commands.runtime-IZx46HPH.js");
...
async function handleInlineActions(params) {
	...
	const skillCommands = shouldLoadSkillCommands && params.skillCommands ? params.skillCommands : shouldLoadSkillCommands ? (await import("./skill-commands.runtime-IZx46HPH.js")).listSkillCommandsForWorkspace({
		workspaceDir,
		cfg,
		agentId,
		skillFilter
	...
	if (skillInvocation) {
		...
		if (dispatch?.kind === "tool") {
			...
			const { createOpenClawTools } = await import("./openclaw-tools.runtime-2vzKi8o7.js");
	...
	if (!isStopLikeInbound && targetSessionEntry) {
		...
		if (cutoff) await (await import("./abort-cutoff.runtime-Cq511YOJ.js")).clearAbortCutoffInSessionRuntime({
			sessionEntry: targetSessionEntry,
			sessionStore,
			sessionKey,
			storePath
	...
	if (handleInlineStatus) {
		const { buildStatusReply } = await import("./commands.runtime-3bgyBOkS.js");
	...
	const runCommands = async (commandInput) => {
		const { handleCommands } = await import("./commands.runtime-3bgyBOkS.js");
...
function loadSessionStoreRuntime$1() {
	sessionStoreRuntimePromise$1 ??= import("./store.runtime-DDmFfMXp.js");
...
function resolveInboundChannel(ctx) {
	let channelValue = normalizeOptionalString(ctx.OriginatingChannel) ?? normalizeOptionalString(ctx.Surface);
	if (!channelValue) {
...
function resolveInboundFormattingHints(ctx) {
	...
	return (getLoadedChannelPlugin(normalizedChannel)?.agentPrompt ?? getBundledChannelPlugin(normalizedChannel)?.agentPrompt)?.inboundFormattingHints?.({ accountId: normalizeOptionalString(ctx.AccountId) ?? void 0 });
}
...
function buildInboundUserContextPrefix(ctx, envelope) {
	...
	const conversationInfo = {
		...
		reply_to_id: shouldIncludeConversationInfo ? normalizeOptionalString(ctx.ReplyToId) : void 0,
		sender_id: shouldIncludeConversationInfo ? normalizeOptionalString(ctx.SenderId) : void 0,
		conversation_label: isDirect ? void 0 : normalizeOptionalString(ctx.ConversationLabel),
		sender: shouldIncludeConversationInfo ? normalizeOptionalString(ctx.SenderName) ?? normalizeOptionalString(ctx.SenderE164) ?? normalizeOptionalString(ctx.SenderId) ?? normalizeOptionalString(ctx.SenderUsername) : void 0,
		...
		has_thread_starter: normalizeOptionalString(ctx.ThreadStarterBody) ? true : void 0,
	...
	if (normalizeOptionalString(ctx.ThreadStarterBody)) blocks.push([
...
function loadPiEmbeddedRuntime() {
	piEmbeddedRuntimePromise ??= import("./pi-embedded.runtime-8NdrRjJt.js");
	return piEmbeddedRuntimePromise;
}
function loadAgentRunnerRuntime() {
	agentRunnerRuntimePromise ??= import("./agent-runner.runtime-DpPR0_pV.js");
	return agentRunnerRuntimePromise;
}
function loadSessionUpdatesRuntime() {
	sessionUpdatesRuntimePromise ??= import("./session-updates.runtime-BU8_HVVp.js");
	return sessionUpdatesRuntimePromise;
}
function loadSessionStoreRuntime() {
	sessionStoreRuntimePromise ??= import("./store.runtime-DDmFfMXp.js");
...
function loadDeliverRuntime() {
	deliverRuntimePromise ??= import("./deliver-runtime-IzBbMfH_.js");
...
async function forkSessionFromParent(params) {
	return (await import("./session-fork.runtime-D1Tq1kV7.js")).forkSessionFromParentRuntime(params);
}
//#endregion
...
function loadSessionArchiveRuntime() {
	sessionArchiveRuntimePromise ??= import("./session-archive.runtime-D4h3ORAO.js");
...
function loadSessionResetModelRuntime() {
	sessionResetModelRuntimePromise ??= import("./session-reset-model.runtime-DGkFNKcY.js");
	return sessionResetModelRuntimePromise;
}
function loadStageSandboxMediaRuntime() {
	stageSandboxMediaRuntimePromise ??= import("./stage-sandbox-media.runtime-Cr0Ps3Zi.js");
...
function loadHookRunnerGlobal() {
	hookRunnerGlobalPromise ??= import("./hook-runner-global-DnuG1oii.js");
	return hookRunnerGlobalPromise;
}
function loadOriginRouting() {
	originRoutingPromise ??= import("./origin-routing-luiFSuBx.js");
...
async function applyMediaUnderstandingIfNeeded(params) {
	...
	const { applyMediaUnderstanding } = await import("./apply.runtime-EYOd5R1z.js");
	await applyMediaUnderstanding(params);
	return true;
}
async function applyLinkUnderstandingIfNeeded(params) {
	if (!hasLinkCandidate(params.ctx)) return false;
	const { applyLinkUnderstanding } = await import("./apply.runtime-CVEx1AW8.js");
...
async function getReplyFromConfig(ctx, opts, configOverride) {
	...
	const maybeEmitMissingResetHooks = async () => {
		...
		const { emitResetCommandHooks } = await import("./commands-core.runtime-D8gO9z1t.js");
