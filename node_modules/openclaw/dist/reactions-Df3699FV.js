...
import { t as resolveRequestUrl } from "./request-url-d_Efrjyr.js";
import "./ssrf-runtime-BMVr-ELX.js";
import { A as resolveBlueBubblesEffectiveAllowPrivateNetwork, C as getCachedBlueBubblesPrivateApiStatus, N as blueBubblesFetchWithTimeout, P as buildBlueBubblesApiUrl, T as isBlueBubblesPrivateApiStatusEnabled, f as extractHandleFromChatGuid, j as resolveBlueBubblesPrivateNetworkConfigValue, k as resolveBlueBubblesAccount, t as asRecord, v as normalizeBlueBubblesHandle, x as parseBlueBubblesTarget } from "./monitor-normalize-BEVLZVpu.js";
import "./secret-input-CW0Yh5wE.js";
import { r as warnBlueBubbles, t as getBlueBubblesRuntime } from "./runtime-J8QFVySW.js";
...
async function downloadBlueBubblesAttachment(attachment, opts = {}) {
	...
	const { baseUrl, password, allowPrivateNetwork, allowPrivateNetworkConfig } = resolveAccount$2(opts);
	const url = buildBlueBubblesApiUrl({
		baseUrl,
	...
	try {
		const fetched = await getBlueBubblesRuntime().channel.media.fetchRemoteMedia({
			...
			maxBytes,
			ssrfPolicy: allowPrivateNetwork ? { allowPrivateNetwork: true } : trustedHostname && (allowPrivateNetworkConfig !== false || !trustedHostnameIsPrivate) ? { allowedHostnames: [trustedHostname] } : void 0,
