...
import { N as isRootHelpInvocation, P as isRootVersionInvocation } from "./logger-ChPQoo5e.js";
import { t as resolveCliArgvInvocation } from "./argv-invocation-C-1dPqbo.js";
import { a as parseCliContainerArgs, n as applyCliProfileEnv, o as resolveCliContainerTarget, r as parseCliProfileArgs, t as normalizeWindowsArgv } from "./windows-argv-2aYnnuKC.js";
...
if (!isMainModule({
	...
	const { installGaxiosFetchCompat } = await import("./gaxios-fetch-compat-DBxvKM0w.js");
	...
	function tryHandleRootVersionFastPath(argv) {
		...
		Promise.all([import("./version-Bt7AtnlL.js"), import("./git-commit-DiqUAVAS.js")]).then(([{ VERSION }, { resolveCommitHash }]) => {
...
function tryHandleRootHelpFastPath(argv, deps = {}) {
	...
	import("./root-help-metadata-EzibHaTS.js").then(async ({ outputPrecomputedRootHelpText }) => {
...
function runMainOrRootHelp(argv) {
	...
	import("./run-main-DnvUflns.js").then(({ runCli }) => runCli(argv)).catch((error) => {
