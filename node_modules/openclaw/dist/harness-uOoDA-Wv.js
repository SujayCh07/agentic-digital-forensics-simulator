import { i as formatErrorMessage$1 } from "./errors-DcAstocv.js";
import { m as resolveUserPath } from "./utils-Supr9KvU.js";
import { n as VERSION } from "./version-BnlvIG4z.js";
import { b as isSubagentSessionKey } from "./session-key-BMb3Kc4r.js";
...
import { t as acquireSessionWriteLock } from "./session-write-lock-CKHKyASn.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-ClBXiMUu.js";
import { u as normalizeUsage } from "./chat-envelope-Codj71Jq.js";
import { _ as isMessagingToolSendAction, f as filterToolResultMediaUrls, g as isMessagingTool, i as resolveAttemptSpawnWorkspaceDir, s as normalizeProviderToolSchemas, t as buildEmbeddedAttemptToolRunContext, u as extractToolResultMediaArtifact, v as supportsModelTools } from "./attempt.tool-run-context-CK2XVv0t.js";
import { c as resolveModelAuthMode } from "./model-auth-D5Ak_Bm7.js";
import { t as log } from "./logger-Qw1xQQHw.js";
import { t as callGatewayTool } from "./gateway-BRUlEFvm.js";
import { t as createOpenClawCodingTools } from "./pi-tools-EODHBluC.js";
import { l as setActiveEmbeddedRun, n as clearActiveEmbeddedRun } from "./runs-DuYnP0n5.js";
import { o as resolveSandboxContext } from "./sandbox-DGCZI78L.js";
...
function readCodexVersionFromUserAgent(userAgent) {
	return (userAgent?.match(/^[^/\s]+\/(\d+\.\d+\.\d+(?:[-+][^\s()]*)?)/))?.[1];
}
...
async function listCodexAppServerModels(options = {}) {
	...
	return await withTimeout((async () => {
		return readModelListResult(await (await getSharedCodexAppServerClient({
	...
	})(), timeoutMs, "codex app-server model/list timed out");
}
...
var CodexAppServerEventProjector = class {
	...
	handleItemCompleted(params) {
		...
		if (item?.type === "agentMessage" && typeof item.text === "string" && item.text) this.assistantTextByItem.set(item.id, item.text);
...
//#endregion
export { withTimeout as a, writeCodexAppServerBinding as c, resolveCodexAppServerRuntimeOptions as d, getSharedCodexAppServerClient as i, isJsonObject as l, listCodexAppServerModels as n, CodexAppServerRpcError as o, clearSharedCodexAppServerClient as r, readCodexAppServerBinding as s, createCodexAppServerAgentHarness as t, readCodexPluginConfig as u };
