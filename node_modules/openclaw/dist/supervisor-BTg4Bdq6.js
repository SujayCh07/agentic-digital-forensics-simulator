...
import { o as resolveWindowsCommandShim, s as spawnWithFallback } from "./exec-uTlaAO3l.js";
...
function createProcessSupervisor() {
	...
	const spawn = async (input) => {
		...
		try {
			...
			const { warnProcessSupervisorSpawnFailure } = await import("./supervisor-log.runtime-CYIMIg29.js");
