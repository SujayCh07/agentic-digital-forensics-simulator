import { F as shouldMigrateStateFromPath } from "./logger-ChPQoo5e.js";
...
async function ensureConfigReady(params) {
	...
	if (!didRunDoctorConfigFlow && shouldMigrateStateFromPath(commandPath)) {
		...
		const runDoctorConfigPreflight = async () => (await import("./doctor-config-preflight-DV9Hv-5C.js")).runDoctorConfigPreflight({
			migrateState: false,
	...
	const { formatConfigIssueLines } = await import("./issue-format-DP3xvKxb.js");
	...
	const [{ colorize, isRich, theme }, { shortenHomePath }, { formatCliCommand }] = await Promise.all([
		import("./theme-BytG9qMB.js"),
		import("./utils-DnY7iHd7.js"),
		import("./command-format-C6VhnXH-.js")
	]);
	const rich = isRich();
