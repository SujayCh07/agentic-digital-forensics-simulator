...
import { o as loadAuthProfileStoreForRuntime, u as updateAuthProfileStoreWithLock } from "./store-C6K7theB.js";
import "./auth-profiles-DCfLLJE5.js";
import { n as resolveAgentModelPrimaryValue } from "./model-input-BeL2x3zu.js";
...
import { l as registerMemoryEmbeddingProvider, s as listMemoryEmbeddingProviders } from "./loader-DtbRRnBD.js";
import { n as listProfilesForProvider } from "./profiles-BpuHvuWc.js";
import { a as isLoopbackHost } from "./net-Gtz838RS.js";
import { r as loadModelCatalog } from "./model-catalog-Jxv_Vdyq.js";
import { S as setTtsProvider, b as setTtsEnabled, f as resolveExplicitTtsOverrides, h as resolveTtsPrefsPath, m as resolveTtsConfig, o as getTtsProvider, u as listSpeechVoices, w as textToSpeech } from "./tts-Diwjgt15.js";
import { a as getImageMetadata } from "./image-ops-Bdlr5m93.js";
import { c as normalizeMimeType, n as extensionForMime, t as detectMime } from "./mime-0OurzcCb.js";
import { i as resolveWebFetchDefinition, n as isWebFetchProviderConfigured, r as listWebFetchProviders } from "./openclaw-tools-Co0S582U.js";
import { c as randomIdempotencyKey, r as callGateway } from "./call-CZD7wgnV.js";
import { t as buildGatewayConnectionDetailsWithResolvers } from "./connection-details-BkUtIr4F.js";
...
import { r as buildMediaUnderstandingRegistry } from "./entry-capabilities-C6YwKwow.js";
import { n as listRuntimeVideoGenerationProviders, t as generateVideo } from "./runtime-CAiaB-t1.js";
import { a as runWebSearch, r as listWebSearchProviders, t as isWebSearchProviderConfigured } from "./runtime-DGf183HT.js";
import { t as resolveMemorySearchConfig } from "./memory-search-BgqYjoKP.js";
import { t as createDefaultDeps } from "./deps-Dh9KhZEt.js";
import { n as agentCommand } from "./agent-command-Brv2L_oX.js";
import { r as listSpeechProviders, t as canonicalizeSpeechProviderId } from "./provider-registry-D49B0lvx.js";
import { n as runCommandWithRuntime } from "./cli-utils-CUiAJaWR.js";
import { a as transcribeAudioFile, r as describeVideoFile, t as describeImageFile } from "./runtime-EwZ2si7H.js";
import { i as modelsStatusCommand, v as modelsAuthLoginCommand } from "./models-Bj4czfwM.js";
import { r as registerBuiltInMemoryEmbeddingProviders, t as createEmbeddingProvider } from "./memory-core-bundled-runtime-DDcthUe3.js";
...
async function runImageDescribe(params) {
	...
	const outputs = await Promise.all(params.files.map(async (filePath) => {
		...
		if (!result.text) throw new Error(`No description returned for image: ${path.resolve(filePath)}`);
		return {
			path: path.resolve(filePath),
			text: result.text,
			provider: result.provider,
...
async function runVideoGenerate(params) {
	...
	const outputs = await Promise.all(result.videos.map(async (video, index) => ({ ...await writeOutputAsset({
		buffer: video.buffer,
