...
import { b as truncateUtf16Safe, m as resolveUserPath } from "./utils-Supr9KvU.js";
...
import { t as extractKeywords } from "./query-expansion-DLEtmeHP.js";
import { i as getMemoryMultimodalExtensions, r as classifyMemoryMultimodalPath, t as buildCaseInsensitiveExtensionGlob } from "./multimodal-Cyb7INJh.js";
import { n as listMemoryEmbeddingProviders, r as listRegisteredMemoryEmbeddingProviderAdapters, t as getMemoryEmbeddingProvider } from "./memory-embedding-provider-runtime-BcnTZGbQ.js";
...
import { a as ensureDir, c as listMemoryFiles, d as remapChunkLines, f as runWithConcurrency, h as hasNonTextEmbeddingParts, i as cosineSimilarity, l as normalizeExtraMemoryPaths, n as buildMultimodalChunkForIndexing, o as hashText, p as isFileMissingError, r as chunkMarkdown, t as buildFileEntry, u as parseEmbedding } from "./internal-DEtiWEag.js";
import { r as readMemoryFile } from "./backend-config-Dd45Inug.js";
import { a as runGeminiEmbeddingBatches, c as DEFAULT_VOYAGE_EMBEDDING_MODEL, d as createOpenAiEmbeddingProvider, f as DEFAULT_MISTRAL_EMBEDDING_MODEL, g as createGeminiEmbeddingProvider, h as buildGeminiEmbeddingRequest, i as runOpenAiEmbeddingBatches, l as createVoyageEmbeddingProvider, m as DEFAULT_GEMINI_EMBEDDING_MODEL, n as runVoyageEmbeddingBatches, o as DEFAULT_LOCAL_MODEL, p as createMistralEmbeddingProvider, r as OPENAI_BATCH_ENDPOINT, s as createLocalEmbeddingProvider, t as enforceEmbeddingMaxInputTokens, u as DEFAULT_OPENAI_EMBEDDING_MODEL } from "./engine-embeddings-wD4PeBdA.js";
import "./memory-core-host-engine-embeddings--zHQ6WcE.js";
import "./memory-core-host-engine-foundation-C6OSv4Ni.js";
import { c as buildSessionEntry, l as listSessionFilesForAgent, u as sessionPathForFile } from "./engine-qmd-D-VKvDV8.js";
import "./memory-core-host-engine-qmd-B5VKcq_h.js";
import { n as loadSqliteVecExtension, r as ensureMemoryIndexSchema, t as requireNodeSqlite } from "./engine-storage-CGGr65kV.js";
import "./memory-core-host-engine-storage-d-8i28v-.js";
import "./provider-env-vars-BKP_WZwm.js";
import "./dreaming-shared-vsDF3BVq.js";
	...
	*/
	writeChunks(entry, source, model, chunks, embeddings, vectorReady) {
		...
		if (this.vector.enabled && !vectorReady && chunks.length > 0) {
			...
			log$2.warn(`chunks written for ${entry.path} without vector embeddings — chunks_vec not updated (sqlite-vec unavailable${errDetail}). Vector recall degraded for this file.`);
		}
	...
	async search(query, opts) {
		...
		if (!this.provider) {
			...
			const resultSets = fullQueryResults.length > 0 ? [fullQueryResults] : await Promise.all((() => {
				...
				return (keywords.length > 0 ? keywords : [cleaned]).map((term) => this.searchKeyword(term, candidates).catch(() => []));
			})());
