import { c as readErrorName, i as formatErrorMessage } from "./errors-DcAstocv.js";
import { i as normalizeLowercaseStringOrEmpty, l as normalizeOptionalThreadValue, o as normalizeOptionalLowercaseString, s as normalizeOptionalString } from "./string-coerce-CIT1-v_a.js";
import { n as defaultRuntime } from "./runtime-BXaxArxm.js";
import { a as isGatewayMessageChannel, d as normalizeMessageChannel, o as isInternalMessageChannel, r as isDeliverableMessageChannel, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-DKMzUOS9.js";
import { t as createSubsystemLogger } from "./subsystem-DX_oTata.js";
import { l as normalizeMainKey, u as resolveAgentIdFromSessionKey, y as isCronSessionKey } from "./session-key-BMb3Kc4r.js";
import { n as normalizeAccountId } from "./account-id-BfovDWrj.js";
import { i as runExec } from "./exec-uTlaAO3l.js";
...
import { a as normalizeDeliveryContext$1, i as mergeDeliveryContext$1, n as deliveryContextKey, s as resolveConversationDeliveryTarget } from "./delivery-context-ymOZ0DxO.js";
import { t as loadSessionStore } from "./store-load-DlllQPOX.js";
import { a as countActiveRunsForSessionFromRuns, c as findRunIdsByChildSessionKeyFromRuns, d as listRunsForRequesterFromRuns, f as resolveRequesterForChildSessionFromRuns, i as countActiveDescendantRunsFromRuns, l as listDescendantRunsForRequesterFromRuns, m as subagentRuns, n as persistSubagentRunsToDisk, o as countPendingDescendantRunsExcludingRunFromRuns, p as shouldIgnorePostCompletionAnnounceForSessionFromRuns, r as restoreSubagentRunsFromDisk, s as countPendingDescendantRunsFromRuns, t as getSubagentRunsSnapshotForRead, u as listRunsForControllerFromRuns } from "./subagent-registry-state-BZwOYT_D.js";
import { a as SUBAGENT_ENDED_OUTCOME_KILLED, c as SUBAGENT_ENDED_REASON_ERROR, i as SUBAGENT_ENDED_OUTCOME_ERROR, l as SUBAGENT_ENDED_REASON_KILLED, n as getSubagentSessionStartedAt, o as SUBAGENT_ENDED_OUTCOME_TIMEOUT, r as resolveSubagentSessionStatus, s as SUBAGENT_ENDED_REASON_COMPLETE, t as getSubagentSessionRuntimeMs, u as SUBAGENT_TARGET_KIND_SUBAGENT } from "./subagent-session-metrics-Do2PLr5n.js";
import { a as isSilentReplyText, n as SILENT_REPLY_TOKEN } from "./tokens-fmnHbQeT.js";
import { i as generateSecureToken } from "./secure-random-DJ9MB_Og.js";
import { f as CommandLane } from "./command-queue-DNuzbaFL.js";
import { A as INTERNAL_RUNTIME_CONTEXT_END, j as escapeInternalRuntimeContextDelimiters, k as INTERNAL_RUNTIME_CONTEXT_BEGIN } from "./errors-C4D11NsW.js";
...
import { t as getSubagentDepthFromSessionStore } from "./subagent-depth-DjzgrPm3.js";
import { r as sanitizeTextContent, t as extractAssistantText } from "./chat-history-text-DoPSbUOY.js";
import { a as failTaskRunByRunId, i as createRunningTaskRun, l as setDetachedTaskDeliveryStatusByRunId, r as completeTaskRunByRunId } from "./task-executor-DOYhQe5J.js";
import { c as applyQueueRuntimeSettings, d as clearQueueSummaryState, f as drainCollectQueueStep, g as waitForQueueDebounce, h as previewQueueSummaryPrompt, l as beginQueueDrain, m as hasCrossChannelItems, p as drainNextQueueItem, s as applyQueueDropPolicy, t as resolveQueueSettings, u as buildCollectPrompt } from "./queue-BfjMkmM1.js";
import { c as normalizeConversationRef, r as getSessionBindingService } from "./session-binding-service-CFQbst7d.js";
import { t as resolveConversationIdFromTargets } from "./conversation-id-DvO3LpyQ.js";
import { a as isEmbeddedPiRunActive, f as waitForEmbeddedPiRunEnd, s as queueEmbeddedPiMessage } from "./runs-DuYnP0n5.js";
import { i as waitForAgentRunAndReadUpdatedAssistantReply, r as waitForAgentRun, t as readLatestAssistantReply } from "./run-wait-DYlekpxL.js";
import { t as configureSubagentRegistrySteerRuntime } from "./subagent-registry-steer-runtime-CcJKM59-.js";
...
let subagentRegistryRuntimePromise$1 = null;
function loadSubagentRegistryRuntime$1() {
	subagentRegistryRuntimePromise$1 ??= import("./subagent-announce.registry.runtime-Rt-3fbIL.js");
	return subagentRegistryRuntimePromise$1;
}
...
async function wakeSubagentRunAfterDescendants(params) {
	...
	const { replaceSubagentRunAfterSteer } = await loadSubagentRegistryRuntime$1();
...
async function runSubagentAnnounceFlow(params) {
	...
	try {
		...
		try {
			subagentRegistryRuntime = await loadSubagentRegistryRuntime$1();
		...
		if (requesterIsSubagent) {
			const { isSubagentSessionRunActive, resolveRequesterForChildSession, shouldIgnorePostCompletionAnnounceForSession } = subagentRegistryRuntime ?? await loadSubagentRegistryRuntime$1();
	...
	const markSubagentRunTerminated = (markParams) => {
		...
		if (updated > 0) {
			...
			for (const entry of entriesByChildSessionKey.values()) {
				...
				})).then(() => emitSubagentEndedHookOnce({
					entry,
...
function loadSubagentRegistryRuntime() {
	subagentRegistryRuntimePromise ??= import("./subagent-registry.runtime-DV9xTlTS.js");
...
async function ensureSubagentRegistryPluginRuntimeLoaded(params) {
	...
	(await loadSubagentRegistryRuntime()).ensureRuntimePluginsLoaded(params);
}
...
function scheduleSubagentOrphanRecovery(params) {
	...
	import("./subagent-orphan-recovery-CoFdZXKv.js").then(({ scheduleOrphanRecovery }) => {
...
function resolveRequesterForChildSession(childSessionKey) {
	...
	return {
		...
		requesterOrigin: normalizeDeliveryContext$1(resolved.requesterOrigin)
	};
}
...
//#endregion
export { AGENT_LANE_NESTED as A, closeTrackedBrowserTabsForSessions as C, REPLY_SKIP_TOKEN as D, ANNOUNCE_SKIP_TOKEN as E, resolveExternalBestEffortDeliveryTarget as F, shouldDowngradeDeliveryToSessionOnly as I, resolveNestedAgentLane as M, deliverSubagentAnnouncement as N, isAnnounceSkip as O, formatAgentInternalEventsForPrompt as P, cleanupBrowserSessionsForLifecycleEnd as S, runAgentStep as T, scheduleSubagentOrphanRecovery as _, countPendingDescendantRunsExcludingRun as a, onSessionLifecycleEvent as b, isSubagentSessionRunActive as c, listSubagentRunsForRequester as d, markSubagentRunForSteerRestart as f, resolveRequesterForChildSession as g, replaceSubagentRunAfterSteer as h, countPendingDescendantRuns as i, AGENT_LANE_SUBAGENT as j, isReplySkip as k, listDescendantRunsForRequester as l, registerSubagentRun as m, countActiveDescendantRuns as n, getLatestSubagentRunByChildSessionKey as o, markSubagentRunTerminated as p, countActiveRunsForSession as r, initSubagentRegistry as s, clearSubagentRunSteerRestart as t, listSubagentRunsForController as u, shouldIgnorePostCompletionAnnounceForSession as v, movePathToTrash as w, buildSubagentSystemPrompt as x, emitSessionLifecycleEvent as y };
