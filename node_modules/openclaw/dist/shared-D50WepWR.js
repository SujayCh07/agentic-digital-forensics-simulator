...
import { a as resolveMatrixAuthContext, i as resolveMatrixAuth } from "./config-nHjVeics.js";
import { n as LogService } from "./logger-B0Y33CJs.js";
import { t as awaitMatrixStartupWithAbort } from "./startup-abort-Cxdth4I6.js";
...
async function loadMatrixCreateClientDeps() {
	matrixCreateClientDepsPromise ??= import("./create-client-puvBe8ch.js").then((runtime) => ({ createMatrixClient: runtime.createMatrixClient }));
