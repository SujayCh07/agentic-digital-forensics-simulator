...
import { r as openBoundaryFile } from "./boundary-file-read-wXLXKYbz.js";
import { c as escapeRegExp } from "./utils-Supr9KvU.js";
import { a as isGatewayMessageChannel, d as normalizeMessageChannel, f as resolveGatewayMessageChannel } from "./message-channel-DKMzUOS9.js";
import { b as isSubagentSessionKey, u as resolveAgentIdFromSessionKey, x as parseAgentSessionKey, y as isCronSessionKey } from "./session-key-BMb3Kc4r.js";
import { i as resolveAgentConfig } from "./agent-scope-BfV3ML7Z.js";
import { a as logWarn, r as logInfo } from "./logger-BDhhZXxv.js";
import { s as sanitizeHostExecEnvWithDiagnostics } from "./host-env-security-CFlHILzU.js";
import { i as resolveShellEnvFallbackTimeoutMs, n as getShellPathFromLoginShell } from "./shell-env-B9q5f8cs.js";
import { d as resolveApprovalAuditCandidatePath } from "./exec-safe-bin-trust-Bx-S8dBH.js";
import { t as killProcessTree } from "./kill-tree-CvhumRUa.js";
import { y as getDiagnosticSessionState } from "./diagnostic-s-PNbMuM.js";
import { C as sanitizeUserFacingText, F as parseExecApprovalResultText, N as formatExecDeniedUserMessage, P as isExecDeniedResultText } from "./errors-C4D11NsW.js";
import { _ as PROCESS_TOOL_DISPLAY_SUMMARY, a as expandPolicyWithPluginGroups, f as isKnownCoreToolId, g as EXEC_TOOL_DISPLAY_SUMMARY, i as collectExplicitAllowlist, l as normalizeToolName, n as applyOwnerOnlyToolPolicy, o as mergeAlsoAllowPolicy, r as buildPluginToolGroups, t as analyzeAllowlistByToolType, u as resolveToolProfilePolicy } from "./tool-policy-Pf1EE_aO.js";
import { i as resolveImageSanitizationLimits } from "./tool-images-DmlD3d_S.js";
import { i as copyChannelAgentToolMeta, n as getPluginToolMeta, s as listChannelAgentTools, t as copyPluginToolMeta } from "./tools-VzW23P3y.js";
import { n as normalizeToolParameters } from "./pi-tools.schema-4SwOgh-U.js";
import { u as shouldSuppressManagedWebSearchTool } from "./codex-native-web-search-CLoVnCPq.js";
import { t as bindAbortRelay } from "./fetch-timeout-C9bsfhkZ.js";
import { _ as resolveSubagentToolPolicyForSession, f as resolveToolFsConfig, h as resolveGroupToolPolicy, l as resolveWorkspaceRoot, m as resolveEffectiveToolPolicy, p as filterToolsByPolicy, u as createToolFsPolicy, v as resolvePathFromInput, y as toRelativeSandboxPath } from "./deliver-BA26RCnu.js";
import { C as createSandboxedWriteTool, E as wrapToolWorkspaceRootGuardWithOptions, S as createSandboxedReadTool, T as wrapToolWorkspaceRootGuard, b as createOpenClawReadTool, t as createOpenClawTools, v as createHostWorkspaceEditTool, w as wrapToolMemoryFlushAppendOnlyWrite, x as createSandboxedEditTool, y as createHostWorkspaceWriteTool } from "./openclaw-tools-Co0S582U.js";
import { f as resolveExecApprovalInitiatingSurfaceState, s as buildExecApprovalUnavailableReplyPayload } from "./exec-approval-reply-B4ng3Kgc.js";
import { t as splitShellArgs } from "./shell-argv-A1qxuvMJ.js";
import { B as describeInterpreterInlineEval, C as requiresExecApproval, D as resolveExecApprovalsFromFile, E as resolveExecApprovals, G as buildEnforcedShellCommand, P as evaluateShellAllowlist, V as detectInterpreterInlineEvalArgv, W as analyzeShellCommand, _ as normalizeExecTarget, a as addDurableCommandApproval, b as recordAllowlistMatchesUse, f as minSecurity, g as normalizeExecSecurity, l as loadExecApprovals, m as normalizeExecAsk, s as hasDurableExecApproval, u as maxAsk, v as persistAllowAlwaysPatterns, w as resolveExecApprovalAllowedDecisions } from "./exec-approvals-DT4-ZzBV.js";
import { _ as textResult, a as failedTextResult } from "./common-ub5s4Xdi.js";
import { t as callGatewayTool } from "./gateway-BRUlEFvm.js";
import { i as wrapToolWithBeforeToolCallHook } from "./pi-tools.before-tool-call-CTG1JUPE.js";
import { i as resolveMergedSafeBinProfileFixtures, r as resolveExecSafeBinRuntimePolicy } from "./exec-safe-bin-runtime-policy-CaEkF0Me.js";
import { f as removePathWithinRoot, h as writeFileWithinRoot, l as readFileWithinRoot, o as mkdirPathWithinRoot, t as SafeOpenError } from "./fs-safe-DQfR1Er7.js";
import { t as PATH_ALIAS_POLICIES } from "./path-alias-guards-BSEeveai.js";
import { n as assertSandboxPath } from "./sandbox-paths-CyfULaCc.js";
import { $ as getSession, A as createApprovalSlug, B as coerceEnv, C as DEFAULT_APPROVAL_REQUEST_TIMEOUT_MS, D as DEFAULT_PENDING_MAX_OUTPUT, E as DEFAULT_PATH, F as resolveExecTarget, G as resolveWorkdir, H as pad, I as runExecProcess, J as applyPathPrepend, K as sliceLogLines, M as normalizeNotifyOutput, O as applyShellPath, P as resolveApprovalRunningNoticeMs, Q as getFinishedSession, R as buildSandboxEnv, T as DEFAULT_MAX_OUTPUT, U as readEnvInt, V as deriveSessionName, W as resolveSandboxWorkdir, X as deleteSession, Y as normalizePathPrepend, Z as drainSession, at as tail, et as listFinishedSessions, it as setJobTtlMs, j as execSchema, k as buildApprovalPendingMessage, nt as markBackgrounded, q as truncateMiddle, rt as markExited, tt as listRunningSessions, w as DEFAULT_APPROVAL_TIMEOUT_MS, z as clampWithDefault } from "./exec-defaults-o-BVMrtV.js";
import { t as getProcessSupervisor } from "./supervisor-BTg4Bdq6.js";
import { F as resolveExternalBestEffortDeliveryTarget } from "./subagent-registry-o0amFUMK.js";
import { t as isToolAllowedByPolicies } from "./tool-policy-match-OqU5oSEr.js";
import { t as sendMessage } from "./message-CYBPqitu.js";
import { l as normalizeNonEmptyString, n as resolveSystemRunCommandRequest, s as normalizeSystemRunApprovalPlan, t as formatExecCommand, u as normalizeStringArray } from "./system-run-command-epGu4XTy.js";
import { i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-VlNTLqBf.js";
import { t as formatDurationCompact } from "./format-duration-DEtUcYVv.js";
import { n as recordCommandPoll, r as resetCommandPollCount } from "./command-poll-backoff-DtpoZRc9.js";
		...
		execute: async (_toolCallId, args, _signal, _onUpdate) => {
			...
			switch (params.action) {
				...
				case "send-keys": {
					...
					if (resolved.session.cursorKeyMode === "unknown" && hasCursorModeSensitiveKeys(request)) return failText(`Session ${params.sessionId} cursor key mode is not known yet. Poll or log until startup output appears, then retry send-keys.`);
					const { data, warnings } = encodeKeySequence(request, resolved.session.cursorKeyMode === "unknown" ? void 0 : resolved.session.cursorKeyMode);
					if (!data) return {
						content: [{
							type: "text",
...
//#endregion
export { createExecTool as a, buildDefaultToolPolicyPipelineSteps as i, resolveToolLoopDetectionConfig as n, resolveSystemRunApprovalRequestContext as o, applyToolPolicyPipeline as r, resolveSystemRunApprovalRuntimeContext as s, createOpenClawCodingTools as t };
