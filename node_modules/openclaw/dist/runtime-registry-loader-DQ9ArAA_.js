...
import { n as resolveConfiguredChannelPluginIds, t as resolveChannelPluginIds } from "./channel-plugin-ids-CsKgTdfD.js";
...
function ensurePluginRegistryLoaded(options) {
	...
	if (!scopedLoad && scopeRank(pluginRegistryLoaded) >= scopeRank(scope) && activeRegistrySatisfiesScope(scope, active, expectedChannelPluginIds, expectedChannelPluginIds)) return;
