...
import { d as readStringValue, i as normalizeLowercaseStringOrEmpty, s as normalizeOptionalString, t as hasNonEmptyString } from "./string-coerce-CIT1-v_a.js";
import { n as defaultRuntime } from "./runtime-BXaxArxm.js";
import { f as resolveConfigDir } from "./utils-Supr9KvU.js";
import { o as isInternalMessageChannel, p as resolveMessageChannel, s as isMarkdownCapableMessageChannel } from "./message-channel-DKMzUOS9.js";
import { t as sanitizeForLog } from "./ansi-B_y-Sue5.js";
import { d as resolveResponseUsageMode, u as normalizeVerboseLevel } from "./thinking.shared-CqTfMucU.js";
import { s as isCliProvider } from "./model-selection-JHakuCn9.js";
import { u as resolveAgentIdFromSessionKey } from "./session-key-BMb3Kc4r.js";
import { v as resolveRunModelFallbacksOverride, y as resolveSessionAgentId } from "./agent-scope-BfV3ML7Z.js";
...
import { g as resolveMemoryFlushPlan } from "./memory-state-CsGd2Smq.js";
import { c as updateSessionStore, l as updateSessionStoreEntry, x as resolveGroupSessionKey } from "./store-ZWCZ_LZI.js";
import "./sessions-DmA78qkx.js";
import { a as resolveSessionFilePathOptions, i as resolveSessionFilePath, o as resolveSessionTranscriptPath } from "./paths-DgoT9gfU.js";
import { o as resolveFreshSessionTotalTokens, s as resolveSessionPluginDebugLines } from "./types-CNcb1BI5.js";
import { t as loadSessionStore } from "./store-load-DlllQPOX.js";
import { l as estimateMessagesTokens, t as compactEmbeddedPiSession, u as readPostCompactionContext, v as isLikelyExecutionAckPrompt } from "./compact-CMxQKbp-.js";
import { n as resolveContextTokensForModel } from "./context-DhTpPVRK.js";
import { a as resolveModelCostConfig, i as formatUsd, n as estimateUsageCost, r as formatTokenCount } from "./usage-format-21aUMEjS.js";
import { c as hasNonzeroUsage, o as derivePromptTokens, s as deriveSessionTotalTokens, u as normalizeUsage } from "./chat-envelope-Codj71Jq.js";
import { i as readSessionMessages } from "./session-utils.fs-CRRgWucy.js";
import { a as isSilentReplyText, i as isSilentReplyPrefixText, n as SILENT_REPLY_TOKEN, o as startsWithSilentToken, s as stripLeadingSilentToken } from "./tokens-fmnHbQeT.js";
import { s as stripHeartbeatToken } from "./heartbeat-D2MKveHh.js";
import { a as generateSecureUuid } from "./secure-random-DJ9MB_Og.js";
import { n as isDiagnosticsEnabled, t as emitDiagnosticEvent } from "./diagnostic-events-xIOxw70B.js";
import { n as GatewayDrainingError, t as CommandLaneClearedError } from "./command-queue-DNuzbaFL.js";
...
import { C as sanitizeUserFacingText, E as isRateLimitErrorMessage, T as isOverloadedErrorMessage, b as isTransientHttpError, f as isCompactionFailureError, g as isLikelyContextOverflowError, p as isContextOverflowError, t as BILLING_ERROR_USER_MESSAGE, w as isBillingErrorMessage } from "./errors-C4D11NsW.js";
import { n as resolveSandboxConfigForAgent } from "./config-CoJWsso_.js";
import { n as resolveSandboxRuntimeStatus } from "./runtime-status-BTq2_Pf1.js";
import "./thinking-BJJhgwXQ.js";
import { a as isAudioFileName } from "./mime-0OurzcCb.js";
import { o as resolveBootstrapWarningSignaturesSeen } from "./bootstrap-budget-DjYfMmvw.js";
import { c as resolveModelAuthMode } from "./model-auth-D5Ak_Bm7.js";
import { d as resolveEffectiveToolFsWorkspaceOnly, v as resolvePathFromInput, x as parseReplyDirectives } from "./deliver-BA26RCnu.js";
import { p as resolveSendableOutboundReplyParts, s as hasOutboundReplyContent } from "./reply-payload-CPJQ0UIg.js";
import { i as emitAgentEvent, u as registerAgentRunContext } from "./agent-events-D8cmkVmu.js";
import { c as runWithModelFallback, l as LiveSessionModelSwitchError, s as isFallbackSummaryError } from "./openclaw-tools-Co0S582U.js";
import { n as filterMessagingToolMediaDuplicates, r as shouldSuppressMessagingToolReplies, t as filterMessagingToolDuplicates } from "./reply-payloads-dedupe-wI9J6mgA.js";
import { a as resolveSandboxedMediaSource, t as assertMediaNotDataUrl } from "./sandbox-paths-CyfULaCc.js";
import { r as enqueueSystemEvent } from "./system-events-Bc8HfhQ3.js";
import { i as isRenderablePayload, n as applyReplyThreading, t as applyReplyTagsToPayload } from "./reply-payloads-Cr8zCVTn.js";
import { i as resolveReplyToMode, t as createReplyToModeFilterForChannel } from "./reply-threading-QS0dTXc4.js";
import { u as saveMediaSource } from "./store-dly0-xmm.js";
import { a as scheduleFollowupDrain, n as enqueueFollowupRun, o as refreshQueuedFollowupSession } from "./queue-BfjMkmM1.js";
import { n as routeReply, t as isRoutableChannel } from "./route-reply-BmBJtCw5.js";
import { h as replyRunRegistry, m as createReplyOperation, p as ReplyRunAlreadyActiveError, s as queueEmbeddedPiMessage } from "./runs-DuYnP0n5.js";
import { a as ensureSandboxWorkspaceForSession } from "./sandbox-DGCZI78L.js";
import { t as runEmbeddedPiAgent } from "./pi-embedded-runner-CRRqVG8f.js";
import "./pi-embedded-BQ8E8Nhk.js";
import { n as resolveCronStorePath, t as loadCronStore } from "./store-BizIUbo7.js";
import { r as resolveEffectiveBlockStreamingConfig } from "./block-streaming-CyJSEHOB.js";
import { n as resolveOriginMessageProvider, r as resolveOriginMessageTo, t as resolveOriginAccountId } from "./origin-routing-B9GL6s_J.js";
import { r as resolveActiveRunQueueAction, t as createTypingSignaler } from "./typing-mode-DZmtee8I.js";
import { a as setCliSessionBinding, o as setCliSessionId, r as getCliSessionBinding, t as runCliAgent } from "./cli-runner-DYmrT_Nx.js";
import { i as resolveFallbackTransition, n as buildFallbackNotice, t as buildFallbackClearedNotice } from "./fallback-state-DGexlTCQ.js";
import { a as resolveModelFallbackOptions, c as resolveRunAuthProfile, i as isBunFetchSocketError, o as resolveQueuedReplyExecutionConfig, r as formatBunFetchSocketError, s as resolveQueuedReplyRuntimeConfig, t as buildEmbeddedRunExecutionParams } from "./agent-runner-utils-CZaIG_hg.js";
import { n as createBlockReplyContentKey, r as createBlockReplyPipeline, t as createAudioAsVoiceBuffer } from "./block-reply-pipeline-BAvUPqlF.js";
import { n as incrementCompactionCount } from "./session-updates-Ca0xBliN.js";
...
function loadReplyPayloadsDedupeRuntime() {
	replyPayloadsDedupeRuntimePromise ??= import("./reply-payloads-dedupe.runtime-CWLXms7D.js");
...
async function runReplyAgent(params) {
	...
	try {
		...
		if (verboseEnabled) {
			...
			if (pluginStatusPayload) prefixPayloads.push(pluginStatusPayload);
		}
