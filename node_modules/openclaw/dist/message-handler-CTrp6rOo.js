...
import { b as truncateUtf16Safe } from "./utils-Supr9KvU.js";
...
import { a as shouldLogVerbose, r as logVerbose, t as danger } from "./globals-dovsmtt4.js";
import { t as logDebug } from "./logger-BDhhZXxv.js";
import { a as loadConfig } from "./io-BxA9F2P4.js";
import { n as formatAllowlistMatchMeta } from "./allowlist-match-DooOddfG.js";
import { t as createDedupeCache } from "./dedupe-MmEr1T7f.js";
import { r as readSessionUpdatedAt } from "./store-ZWCZ_LZI.js";
import { u as resolveStorePath } from "./paths-DgoT9gfU.js";
import { i as resolveHumanDelayConfig, t as resolveAckReaction } from "./identity-D_zFlCIB.js";
import { t as resolveAccountEntry } from "./account-lookup-C2YDUubA.js";
import { n as stripInlineDirectiveTagsForDelivery } from "./directive-tags-iiqHtloa.js";
...
import { i as resolveChannelStreamingBlockEnabled, s as resolveChannelStreamingPreviewChunk } from "./channel-streaming-C_umKBSU.js";
import { r as getAgentScopedMediaLocalRoots } from "./local-roots-D0wkyf-C.js";
import { n as resolveBatchedReplyThreadingPolicy } from "./reply-threading-QS0dTXc4.js";
...
import { t as convertMarkdownTables } from "./tables-Db4fYWlm.js";
import "./text-runtime-dYMrRdFH.js";
import { t as KeyedAsyncQueue } from "./keyed-async-queue-BSc5YnAg.js";
import "./routing-DSl48EkU.js";
import "./error-runtime-Huw13EA-.js";
import { y as shouldHandleTextCommands } from "./commands-registry-CuZmchBs.js";
...
import { n as shouldAckReaction } from "./ack-reactions-CW4w1AXt.js";
import { n as resolveControlCommandGate } from "./command-gating-490WNvMI.js";
import { n as resolveInboundMentionDecision, t as implicitMentionKindWhen } from "./mention-gating-BVl28cwK.js";
import { t as recordInboundSession } from "./session-k0H92rYO.js";
import { t as resolveMarkdownTableMode } from "./markdown-tables-DgLnIvPZ.js";
import { n as recordChannelActivity } from "./channel-activity-BBRHt-79.js";
import { i as resolveOpenProviderRuntimeGroupPolicy } from "./runtime-group-policy-Beg3nTTB.js";
...
import "./reply-reference-BhklWkkB.js";
...
import { a as createStatusReactionController, r as DEFAULT_TIMING } from "./channel-feedback-BUm9r02v.js";
import { n as shouldDebounceTextInbound, t as createChannelInboundDebouncer } from "./channel-inbound-DKgmBCwM.js";
import { i as createFinalizableDraftLifecycle, n as createRunStateMachine } from "./channel-lifecycle-BxCvRHUt.js";
import { a as resolveDefaultDiscordAccountId, c as resolveDiscordMaxLinesPerMessage } from "./accounts-CqTJGEO5.js";
import { L as chunkDiscordTextWithMode, O as createDiscordRestClient, k as createDiscordRuntimeAccountContext } from "./send.shared-DOUPBqln.js";
import { h as editMessageDiscord, i as removeReactionDiscord, n as reactMessageDiscord } from "./send-D0F-HRh2.js";
import { i as resolveTimestampMs, n as formatDiscordUserTag, r as resolveDiscordSystemLocation } from "./format-wvcttbDO.js";
...
import { l as isRecentlyUnboundThreadWebhookMessage } from "./thread-bindings.state-DzvPVePi.js";
import { t as resolveDiscordPreviewStreamMode } from "./preview-streaming-B0KbFPmt.js";
import "./thread-bindings-BikE7hUJ.js";
import { l as runDiscordTaskWithTimeout, n as DISCORD_ATTACHMENT_TOTAL_TIMEOUT_MS, s as normalizeDiscordInboundWorkerTimeoutMs, t as DISCORD_ATTACHMENT_IDLE_TIMEOUT_MS } from "./timeouts-CPs0w3-h.js";
import { _ as resolveMediaList, a as resolveDiscordReplyDeliveryPlan, d as buildDiscordMediaPayload, f as hasDiscordMessageStickers, g as resolveForwardedMediaList, h as resolveDiscordMessageText, i as resolveDiscordAutoThreadReplyPlan, l as resolveDiscordThreadStarter, m as resolveDiscordMessageChannelId, p as resolveDiscordChannelInfo } from "./threading-CLFr6XLn.js";
import { t as DISCORD_TEXT_CHUNK_LIMIT } from "./outbound-adapter-BGjp5PIs.js";
import { n as buildDiscordInboundAccessContext, r as createDiscordSupplementalContextAccessChecker } from "./inbound-context-DhjRSY7i.js";
import { a as handleDiscordDmCommandDecision, c as buildDirectLabel, d as resolveDiscordSenderIdentity, f as resolveDiscordWebhookId, i as resolveDiscordEffectiveRoute, l as buildGuildLabel, o as resolveDiscordDmCommandAccess, r as resolveDiscordConversationRoute, s as deliverDiscordReply, t as buildDiscordRoutePeer, u as resolveReplyContext } from "./route-resolution-DolhdPUR.js";
import { t as sendTyping } from "./typing-CWMVpSRD.js";
			...
			if (draftStream && isFinal) {
				...
				if (!finalizedViaPreviewMessage && !hasMedia && typeof previewFinalText === "string" && typeof previewMessageId === "string" && !hasExplicitReplyDirective && !payload.isError) {
					...
					try {
						...
						await editMessageDiscord(deliverChannelId, previewMessageId, { content: previewFinalText }, { rest: deliveryRest });
				...
				if (!finalizedViaPreviewMessage) {
					...
					if (typeof messageIdAfterStop === "string" && typeof previewFinalText === "string" && !hasMedia && !hasExplicitReplyDirective && !payload.isError) try {
						notifyFinalReplyStart();
						await editMessageDiscord(deliverChannelId, messageIdAfterStop, { content: previewFinalText }, { rest: deliveryRest });
						finalizedViaPreviewMessage = true;
						replyReference.markSent();
						observer?.onFinalReplyDelivered?.();
						return;
...
async function loadPluralKitRuntime() {
	pluralkitRuntimePromise ??= import("./pluralkit-DrpY8V5Q.js");
	return await pluralkitRuntimePromise;
}
async function loadDiscordSendRuntime() {
	discordSendRuntimePromise ??= import("./send-D0p4ZOff.js");
	return await discordSendRuntimePromise;
}
async function loadPreflightAudioRuntime() {
	preflightAudioRuntimePromise ??= import("./preflight-audio-CPR1ZQYu.js");
	return await preflightAudioRuntimePromise;
}
async function loadSystemEventsRuntime() {
	systemEventsRuntimePromise ??= import("./system-events-D2_XyI7K.js");
	return await systemEventsRuntimePromise;
}
async function loadDiscordThreadingRuntime() {
	discordThreadingRuntimePromise ??= import("./threading-CU_pnJ2T.js");
