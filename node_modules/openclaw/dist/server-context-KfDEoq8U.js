import { i as formatErrorMessage, r as extractErrorCode } from "./errors-DcAstocv.js";
import { d as readStringValue, i as normalizeLowercaseStringOrEmpty, s as normalizeOptionalString } from "./string-coerce-CIT1-v_a.js";
...
import { a as loadConfig, h as writeConfigFile, r as createConfigIO } from "./io-BxA9F2P4.js";
...
import { a as getImageMetadata, l as resizeToJpeg, r as buildImageResizeSideGrid, t as IMAGE_REDUCE_QUALITY_STEPS } from "./image-ops-Bdlr5m93.js";
import { t as parseBooleanValue } from "./boolean-DO8VExbb.js";
import { a as ensureMediaDir, l as saveMediaBuffer } from "./store-dly0-xmm.js";
import { n as deriveDefaultBrowserCdpPortRange } from "./port-defaults-BzPBTZBw.js";
import "./text-runtime-dYMrRdFH.js";
import "./browser-config-runtime-B2e1AJVp.js";
import "./browser-setup-tools-5RCoP-jj.js";
import { C as ACT_MAX_WAIT_TIME_MS, D as matchBrowserUrlPattern, S as ACT_MAX_CLICK_DELAY_MS, _ as normalizeCdpWsUrl, a as resolveOpenClawUserDataDir, b as normalizeBrowserFormField, d as CONTENT_ROLES, f as INTERACTIVE_ROLES, h as createTargetViaCdp, i as launchOpenClawChrome, l as getRoleSnapshotStats, m as captureScreenshot, n as isChromeCdpReady, o as stopOpenClawChrome, p as STRUCTURAL_ROLES, r as isChromeReachable, v as snapshotAria, w as normalizeActBoundedNonNegativeMs } from "./chrome-By1kRNZR.js";
import { c as DEFAULT_DOWNLOAD_DIR, d as resolveExistingPathsWithinRoot, l as DEFAULT_TRACE_DIR, n as DEFAULT_AI_SNAPSHOT_MAX_CHARS, p as resolveWritablePathWithinRoot, t as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, u as DEFAULT_UPLOAD_DIR } from "./utils-BVQDKN-C.js";
import { n as normalizeString } from "./record-shared-CBQy0AJE.js";
import { A as BrowserValidationError, C as BrowserConflictError, D as BrowserResourceExhaustedError, E as BrowserResetUnsupportedError, F as assertBrowserNavigationResultAllowed, I as requiresInspectableBrowserNavigationRedirects, L as withBrowserNavigationPolicy, M as InvalidBrowserNavigationUrlError, N as assertBrowserNavigationAllowed, O as BrowserTabNotFoundError, T as BrowserProfileUnavailableError, _ as CHROME_MCP_ATTACH_READY_WINDOW_MS, a as fetchOk, c as normalizeCdpHttpBaseForJsonEndpoints, i as fetchJson, j as toBrowserErrorResponse, k as BrowserTargetAmbiguousError, n as assertCdpEndpointAllowed, p as CDP_JSON_NEW_TIMEOUT_MS, t as appendCdpPath, u as parseBrowserHttpUrl, w as BrowserProfileNotFoundError, x as resolveCdpReachabilityTimeouts } from "./cdp.helpers-WDYKRNDl.js";
import { r as resolveBrowserExecutableForPlatform } from "./chrome.executables-nGJfKbdI.js";
import "./control-auth-CvV7Zy98.js";
import { n as resolveProfile, t as resolveBrowserConfig } from "./config-BEm9-1TI.js";
import { t as movePathToTrash } from "./trash-CMA9iZ_4.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CmXkxvEq.js");
	} catch (err) {
...
async function assertExistingSessionPostInteractionNavigationAllowed(params) {
	...
	if (lastObservedUrl) {
		...
		try {
			...
			if (followUpUrl === lastObservedUrl) return;
		} catch {}
	}
...
async function closePlaywrightBrowserConnectionForProfile$1(cdpUrl) {
	try {
		await (await import("./pw-ai-CmXkxvEq.js")).closePlaywrightBrowserConnection(cdpUrl ? { cdpUrl } : void 0);
	} catch {}
}
//#endregion
...
function createProfileSelectionOps({ profile, getProfileState, getSsrFPolicy, ensureBrowserAvailable, listTabs, openTab }) {
	...
	const focusTab = async (targetId) => {
		...
		await fetchOk(appendCdpPath(cdpHttpBase, `/json/activate/${resolvedTargetId}`), void 0, void 0, getSsrFPolicy());
		const profileState = getProfileState();
		profileState.lastTargetId = resolvedTargetId;
	};
	const closeTab = async (targetId) => {
		...
		await fetchOk(appendCdpPath(cdpHttpBase, `/json/close/${resolvedTargetId}`), void 0, void 0, getSsrFPolicy());
	};
	return {
		ensureTabAvailable,
		focusTab,
...
function createProfileTabOps({ profile, state, getProfileState }) {
	...
	const listTabs = async () => {
		...
		return (await fetchJson(appendCdpPath(cdpHttpBase, "/json/list"), void 0, void 0, getSsrFPolicy())).map((t) => ({
			targetId: t.id ?? "",
			title: t.title ?? "",
			url: t.url ?? "",
	...
	const enforceManagedTabLimit = async (keepTargetId) => {
		...
		for (const tab of candidates.slice(0, excessCount)) fetchOk(appendCdpPath(cdpHttpBase, `/json/close/${tab.targetId}`), void 0, void 0, getSsrFPolicy()).catch(() => {});
	};
	...
	const openTab = async (url) => {
		...
		const created = await fetchJson(endpoint, CDP_JSON_NEW_TIMEOUT_MS, { method: "PUT" }, ssrfPolicyOpts.ssrfPolicy).catch(async (err) => {
			if (String(err).includes("HTTP 405")) return await fetchJson(endpoint, CDP_JSON_NEW_TIMEOUT_MS, void 0, ssrfPolicyOpts.ssrfPolicy);
			throw err;
		});
