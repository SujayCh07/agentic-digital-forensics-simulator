...
import { d as qaChannelPlugin, g as setQaChannelRuntime } from "./qa-channel-2PCNb5kI.js";
import "./runtime-api-E6OIz1VZ.js";
import { d as handleQaBusRequest, l as closeQaHttpServer, m as writeJson, p as writeError, r as readQaBootstrapScenarioCatalog } from "./scenario-catalog-Cne09_Rx.js";
import { a as normalizeQaRunSelection, n as createQaRunOutputDir, t as createIdleQaRunnerSnapshot } from "./run-config-CulAzo8y.js";
...
async function startQaLabServer(params) {
	...
	const ensureRunnerModelCatalog = () => {
		...
		runnerModelCatalogPromise = (async () => {
			try {
				const { loadQaRunnerModelOptions } = await import("./model-catalog.runtime-DtZG8GtC.js");
