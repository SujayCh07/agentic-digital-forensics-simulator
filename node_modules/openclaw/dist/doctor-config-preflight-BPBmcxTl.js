import { l as isRecord, p as resolveHomeDir } from "./utils-Supr9KvU.js";
...
import { t as note } from "./note-LcGeKHAC.js";
...
async function runDoctorConfigPreflight(options = {}) {
	if (options.migrateState !== false) {
		const { autoMigrateLegacyStateDir } = await import("./doctor-state-migrations-BNVzVg2h.js");
