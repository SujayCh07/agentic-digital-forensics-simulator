...
import { d as resolveThreadSessionKeys, u as resolveAgentIdFromSessionKey } from "./session-key-BMb3Kc4r.js";
import { n as formatAllowlistMatchMeta } from "./allowlist-match-DooOddfG.js";
import { a as resolveSessionStoreEntry } from "./store-ZWCZ_LZI.js";
...
import { n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-BWZgM2t0.js";
...
import { r as resolveConfiguredAcpBindingRecord, t as ensureConfiguredAcpBindingReady } from "./persistent-bindings.lifecycle-DLsl2Sk4.js";
...
import { i as waitUntilAbort } from "./channel-lifecycle.core-7oS5NFHz.js";
...
import { a as warnMissingProviderGroupPolicyFallbackOnce, n as resolveAllowlistProviderRuntimeGroupPolicy, r as resolveDefaultGroupPolicy, t as GROUP_POLICY_BLOCKED_LABEL } from "./runtime-group-policy-Beg3nTTB.js";
import { n as logInboundDrop, r as logTypingFailure } from "./logging-DqD2afVE.js";
import { n as createReplyPrefixOptions } from "./reply-prefix-CXIVSbe3.js";
import { t as createTypingCallbacks } from "./typing-C9UsWaPp.js";
...
import { l as resolveThreadBindingMaxAgeMsForChannel, o as resolveThreadBindingIdleTimeoutMsForChannel } from "./thread-bindings-policy-CU2O6UPm.js";
...
import { c as createDraftStreamLoop } from "./channel-lifecycle-BxCvRHUt.js";
import { s as resolveMatrixAccountConfig } from "./config-paths-CxAufx1r.js";
import { t as getMatrixRuntime } from "./runtime-DmMklTU8.js";
import { a as resolveMatrixAuthContext, i as resolveMatrixAuth, t as backfillMatrixAuthDeviceIdAfterStartup } from "./config-nHjVeics.js";
import { i as resolveMatrixStateFilePath } from "./storage-DQVJCqpT.js";
import { n as resolveConfiguredMatrixBotUserIds } from "./accounts-DaC6oezE.js";
import "./runtime-api-CgWeNUOg.js";
import { h as resolveMatrixAllowListMatch, m as normalizeMatrixUserId, p as normalizeMatrixAllowList } from "./exec-approvals-D2nOC9DH.js";
import { t as isMatrixQualifiedUserId } from "./target-ids-RfY8DHOv.js";
import { n as resolveMatrixRoomConfig, r as matrixApprovalCapability, t as resolveMatrixStoredSessionMeta } from "./session-store-metadata-Dyl8zDyk.js";
import { r as isMatrixNotFoundError, t as formatMatrixErrorMessage } from "./errors-CvFPKnyw.js";
import { t as isBunRuntime } from "./runtime-B_RwdNcq.js";
import { n as LogService } from "./logger-B0Y33CJs.js";
import { i as throwIfMatrixStartupAborted, r as isMatrixStartupAbortError } from "./startup-abort-Cxdth4I6.js";
import { i as resolveSharedMatrixClient, n as releaseSharedClientInstance } from "./shared-D50WepWR.js";
import "./client-_-MJS8fo.js";
import { i as isMatrixMediaSizeLimitError, r as MatrixMediaSizeLimitError } from "./http-client-Dwtu3ggj.js";
import { t as resolveMatrixTargets } from "./resolve-targets-DPcAxbt-.js";
import { a as sendMessageMatrix, c as sendSingleTextMessageMatrix, g as isPollStartType, h as isPollEventType, i as reactMatrixMessage, l as sendTypingMatrix, n as editMessageMatrix, p as formatPollAsText, r as prepareMatrixSingleText, s as sendReadReceiptMatrix, t as chunkMatrixText, v as parsePollStartContent } from "./send-DzymrkyA.js";
import { c as MsgType, o as MATRIX_OPENCLAW_FINALIZED_PREVIEW_KEY, p as extractMatrixReactionAnnotation, r as promoteMatrixDirectRoomCandidate, u as MATRIX_REACTION_EVENT_TYPE } from "./direct-management-hyly1A6a.js";
import { o as readJoinedMatrixMembers, r as isStrictDirectMembership, t as hasDirectMatrixMemberFlag } from "./direct-room-2Cfo2wCf.js";
import { t as createMatrixThreadBindingManager } from "./thread-bindings-DyqwAy1P.js";
import { a as unregisterMatrixApprovalReactionTarget, i as resolveMatrixApprovalReactionTarget } from "./approval-reactions-C41e_zKb.js";
import { a as resolveMatrixMessageBody, i as resolveMatrixMessageAttachment, n as formatMatrixMediaUnavailableText, r as formatMatrixMessageText, s as fetchMatrixPollSnapshot, t as formatMatrixMediaTooLargeText } from "./media-text-Tv3p0ZL5.js";
import { n as setActiveMatrixClient } from "./active-client-E08evjTv.js";
import { t as formatMatrixEncryptedEventDisabledWarning } from "./encryption-guidance-ENY-bJ0G.js";
import { t as createAsyncLock } from "./async-lock-CVpw2Z5u.js";
import { n as isMatrixReadySyncState, r as isMatrixTerminalSyncState, t as isMatrixDisconnectedSyncState } from "./sync-state-8q-H2yb7.js";
...
async function loadMatrixDirectRoomDeps() {
	matrixDirectRoomDepsPromise ??= Promise.all([import("./direct-management-Db4y6yRW.js"), import("./direct-room-Bleih_yC.js")]).then(([directManagementModule, directRoomModule]) => ({
...
function registerMatrixMonitorEvents(params) {
	const { cfg, client, auth, allowFrom, dmEnabled, dmPolicy, readStoreAllowFrom, directTracker, logVerboseMessage, warnedEncryptedRooms, warnedCryptoMissingRooms, logger, formatNativeDependencyHint, onRoomMessage, runDetachedTask } = params;
...
async function maybeResolveMatrixApprovalReaction(params) {
	...
	if (!matrixApprovalCapability.authorizeActorAction?.({
		cfg: params.cfg,
		accountId: params.accountId,
		senderId: params.senderId,
		action: "approve",
				...
				deliver: async (payload, info) => {
					if (draftStream && info.kind !== "tool" && !payload.isCompactionNotice) {
						...
						if (draftEventId && payload.text && !hasMedia && !payloadReplyMismatch && !mustDeliverFinalNormally) {
							...
							if (textEditOk && payloadText && (quietDraftStreaming || typeof payloadText === "string" && !payloadTextMatchesDraft)) textEditOk = await editMessageMatrix(roomId, draftEventId, payloadText, {
								client,
								cfg,
								threadId: threadTarget,
								accountId: _route.accountId,
...
async function loadMatrixStartupMaintenanceDeps() {
	matrixStartupMaintenanceDepsPromise ??= Promise.all([
		import("./config-update-D5J1fsav.js"),
		import("./device-health-CXl_b0J0.js"),
		import("./profile-C8ZiHQ5F.js"),
		import("./legacy-crypto-restore-OtasD7Sf.js"),
		import("./startup-verification-He-LVGb5.js")
