...
import { t as parseGeminiAuth } from "./gemini-auth-y4T71IVs.js";
import { n as executeWithApiKeyRotation, t as collectProviderApiKeysForExecution } from "./api-key-rotation-DuLAT2YE.js";
import { n as retryAsync } from "./retry-DcseOnly.js";
import "./ollama-runtime-CVJljgxE.js";
import "./memory-embedding-provider-runtime-BcnTZGbQ.js";
import { n as OPENAI_DEFAULT_EMBEDDING_MODEL } from "./provider-model-defaults-PtC5R6Yn.js";
import { _ as estimateUtf8Bytes, f as runWithConcurrency, h as hasNonTextEmbeddingParts, o as hashText, v as splitTextToUtf8ByteLimit } from "./internal-DEtiWEag.js";
import { n as resolveMemorySecretInputString } from "./secret-input-DC3YfVY1.js";
import "node:fs";
...
//#endregion
//#region src/memory-host-sdk/host/embeddings-gemini.ts
...
async function resolveGeminiEmbeddingClient(options) {
	...
	const rawBaseUrl = remoteBaseUrl || normalizeOptionalString(providerConfig?.baseUrl) || "https://generativelanguage.googleapis.com/v1beta";
...
//#endregion
//#region src/memory-host-sdk/host/embeddings-mistral.ts
...
//#endregion
//#region src/memory-host-sdk/host/embeddings-openai.ts
...
//#endregion
//#region src/memory-host-sdk/host/embeddings-voyage.ts
...
//#endregion
//#region src/memory-host-sdk/host/batch-gemini.ts
...
//#endregion
//#region src/memory-host-sdk/host/batch-openai.ts
...
//#endregion
//#region src/memory-host-sdk/host/batch-voyage.ts
...
function resolveEmbeddingMaxInputTokens(provider) {
	...
	const known = KNOWN_EMBEDDING_MAX_INPUT_TOKENS[normalizeLowercaseStringOrEmpty(`${provider.id}:${provider.model}`)];
	if (typeof known === "number") return known;
	if (normalizeLowercaseStringOrEmpty(provider.id) === "gemini") return 2048;
	if (normalizeLowercaseStringOrEmpty(provider.id) === "local") return DEFAULT_LOCAL_EMBEDDING_MAX_INPUT_TOKENS;
...
//#endregion
export { runGeminiEmbeddingBatches as a, DEFAULT_VOYAGE_EMBEDDING_MODEL as c, createOpenAiEmbeddingProvider as d, DEFAULT_MISTRAL_EMBEDDING_MODEL as f, createGeminiEmbeddingProvider as g, buildGeminiEmbeddingRequest as h, runOpenAiEmbeddingBatches as i, createVoyageEmbeddingProvider as l, DEFAULT_GEMINI_EMBEDDING_MODEL as m, runVoyageEmbeddingBatches as n, DEFAULT_LOCAL_MODEL as o, createMistralEmbeddingProvider as p, OPENAI_BATCH_ENDPOINT as r, createLocalEmbeddingProvider as s, enforceEmbeddingMaxInputTokens as t, DEFAULT_OPENAI_EMBEDDING_MODEL as u };
