...
import { r as getActivePluginRegistry } from "./runtime-BrxjAC6F.js";
import { _ as GATEWAY_CLIENT_NAMES, g as GATEWAY_CLIENT_MODES, h as GATEWAY_CLIENT_IDS } from "./message-channel-DKMzUOS9.js";
...
import { n as ENV_SECRET_REF_ID_RE } from "./types.secrets-D-R9X_jm.js";
import { n as FILE_SECRET_REF_ID_PATTERN, r as SECRET_PROVIDER_ALIAS_PATTERN, t as EXEC_SECRET_REF_ID_JSON_SCHEMA_PATTERN } from "./ref-contract-DOTysgVz.js";
import { n as resolveReservedGatewayMethodScope } from "./gateway-method-policy-CVW4Dxnl.js";
import { a as isLoopbackHost, c as isSecureWebSocketUrl } from "./net-Gtz838RS.js";
import { n as normalizeDeviceAuthScopes, t as normalizeDeviceAuthRole } from "./device-auth-CqToLWBY.js";
import { t as safeParseJsonWithSchema } from "./zod-parse-CJnMZ4n1.js";
import { a as signDevicePayload, i as publicKeyRawBase64UrlFromPem, n as loadOrCreateDeviceIdentity } from "./device-identity-DNEx-cD9.js";
import { t as normalizeFingerprint } from "./fingerprint-CMEIy01B.js";
import { t as rawDataToString } from "./ws-mJNtsIhg.js";
import { t as normalizeDeviceMetadataForAuth } from "./device-metadata-normalization-CJFI4B6g.js";
import { t as INPUT_PROVENANCE_KIND_VALUES } from "./input-provenance-BAEcdm8r.js";
import { n as MAX_PLUGIN_APPROVAL_TIMEOUT_MS } from "./plugin-approvals-CDvBRdQD.js";
...
//#endregion
//#region src/gateway/protocol/schema/commands.ts
...
Type.Object({ commands: Type.Array(CommandEntrySchema) }, { additionalProperties: false });
//#endregion
...
//#endregion
export { validateExecApprovalRequestParams as $, validateTalkModeParams as $t, validateCommandsListParams as A, validateSessionsCompactParams as At, validateCronListParams as B, validateSessionsPatchParams as Bt, validateAgentsUpdateParams as C, validatePollParams as Ct, validateChatHistoryParams as D, validateSecretsResolveResult as Dt, validateChatAbortParams as E, validateSecretsResolveParams as Et, validateConfigSchemaLookupResult as F, validateSessionsCreateParams as Ft, validateCronUpdateParams as G, validateSessionsUsageParams as Gt, validateCronRunParams as H, validateSessionsResetParams as Ht, validateConfigSchemaParams as I, validateSessionsDeleteParams as It, validateDevicePairRejectParams as J, validateSkillsInstallParams as Jt, validateDevicePairApproveParams as K, validateSkillsBinsParams as Kt, validateConfigSetParams as L, validateSessionsListParams as Lt, validateConfigGetParams as M, validateSessionsCompactionGetParams as Mt, validateConfigPatchParams as N, validateSessionsCompactionListParams as Nt, validateChatInjectParams as O, validateSendParams as Ot, validateConfigSchemaLookupParams as P, validateSessionsCompactionRestoreParams as Pt, validateExecApprovalGetParams as Q, validateTalkConfigParams as Qt, validateConnectParams as R, validateSessionsMessagesSubscribeParams as Rt, validateAgentsListParams as S, validatePluginApprovalResolveParams as St, validateChannelsStatusParams as T, validateRequestFrame as Tt, validateCronRunsParams as U, validateSessionsResolveParams as Ut, validateCronRemoveParams as V, validateSessionsPreviewParams as Vt, validateCronStatusParams as W, validateSessionsSendParams as Wt, validateDeviceTokenRevokeParams as X, validateSkillsStatusParams as Xt, validateDevicePairRemoveParams as Y, validateSkillsSearchParams as Yt, validateDeviceTokenRotateParams as Z, validateSkillsUpdateParams as Zt, validateAgentsCreateParams as _, getPreauthHandshakeTimeoutMsFromEnv as _n, validateNodePendingAckParams as _t, resolveLeastPrivilegeOperatorScopesForMethod as a, validateWebLoginStartParams as an, validateLogsTailParams as at, validateAgentsFilesListParams as b, validateNodeRenameParams as bt, PAIRING_SCOPE as c, validateWizardNextParams as cn, validateNodeEventParams as ct, WRITE_SCOPE as d, ErrorCodes as dn, validateNodeListParams as dt, validateTalkSpeakParams as en, validateExecApprovalResolveParams as et, GatewayClient as f, errorShape as fn, validateNodePairApproveParams as ft, validateAgentWaitParams as g, resolveDeviceAuthConnectErrorDetailCode as gn, validateNodePairVerifyParams as gt, validateAgentParams as h, resolveAuthConnectErrorDetailCode as hn, validateNodePairRequestParams as ht, isNodeRoleMethod as i, validateWakeParams as in, validateExecApprovalsSetParams as it, validateConfigApplyParams as j, validateSessionsCompactionBranchParams as jt, validateChatSendParams as k, validateSessionsAbortParams as kt, READ_SCOPE as l, validateWizardStartParams as ln, validateNodeInvokeParams as lt, validateAgentIdentityParams as m, ConnectErrorDetailCodes as mn, validateNodePairRejectParams as mt, authorizeOperatorScopesForMethod as n, validateToolsEffectiveParams as nn, validateExecApprovalsNodeGetParams as nt, ADMIN_SCOPE as o, validateWebLoginWaitParams as on, validateModelsListParams as ot, formatValidationErrors as p, parseSessionLabel as pn, validateNodePairListParams as pt, validateDevicePairListParams as q, validateSkillsDetailParams as qt, isAdminOnlyMethod as r, validateUpdateRunParams as rn, validateExecApprovalsNodeSetParams as rt, APPROVALS_SCOPE as s, validateWizardCancelParams as sn, validateNodeDescribeParams as st, CLI_DEFAULT_OPERATOR_SCOPES as t, validateToolsCatalogParams as tn, validateExecApprovalsGetParams as tt, TALK_SECRETS_SCOPE as u, validateWizardStatusParams as un, validateNodeInvokeResultParams as ut, validateAgentsDeleteParams as v, buildDeviceAuthPayload as vn, validateNodePendingDrainParams as vt, validateChannelsLogoutParams as w, validatePushTestParams as wt, validateAgentsFilesSetParams as x, validatePluginApprovalRequestParams as xt, validateAgentsFilesGetParams as y, buildDeviceAuthPayloadV3 as yn, validateNodePendingEnqueueParams as yt, validateCronAddParams as z, validateSessionsMessagesUnsubscribeParams as zt };
