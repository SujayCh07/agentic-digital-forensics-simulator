...
import { n as buildTimeoutAbortSignal } from "./fetch-timeout-C9bsfhkZ.js";
import { t as retainSafeHeadersForCrossOriginRedirect$1 } from "./redirect-headers-eYw0XuZl.js";
import { i as loadUndiciRuntimeDeps, n as createHttp1EnvHttpProxyAgent, r as createHttp1ProxyAgent, t as createHttp1Agent } from "./undici-runtime-C89KOfPY.js";
import { i as createPinnedDispatcher, m as resolvePinnedHostnameWithPolicy, r as closeDispatcher, t as SsrFBlockedError } from "./ssrf-C2YYZEse.js";
...
async function fetchWithRuntimeDispatcher(input, init) {
	const runtimeFetch = loadUndiciRuntimeDeps().fetch;
...
async function fetchWithSsrFGuard(params) {
	...
	while (true) {
		...
		try {
			...
			else if (params.pinDns === false) dispatcher = createPolicyDispatcherWithoutPinnedDns(params.dispatcherPolicy);
