...
import { s as resolveWhatsAppAccount } from "./accounts-DQOrlwDd.js";
import { n as isSelfChatMode } from "./text-runtime-CkBBYW0q.js";
...
async function checkInboundAccessControl(params) {
	...
	const access = resolveDmGroupAccessWithLists({
		...
		isSenderAllowed: (allowEntries) => {
			...
			const normalizedEntrySet = new Set(allowEntries.map((entry) => normalizeE164(entry)).filter((entry) => Boolean(entry)));
