...
import { s as registerUnhandledRejectionHandler } from "./unhandled-rejections-B5n5YHnW.js";
import { i as getChildLogger } from "./logger-ChPQoo5e.js";
import { n as defaultRuntime } from "./runtime-BXaxArxm.js";
import { n as clamp, u as normalizeE164, v as sleep } from "./utils-Supr9KvU.js";
import { t as createSubsystemLogger } from "./subsystem-DX_oTata.js";
import { a as buildGroupHistoryKey, c as normalizeAgentId, n as DEFAULT_MAIN_KEY, r as buildAgentMainSessionKey } from "./session-key-BMb3Kc4r.js";
import { a as shouldLogVerbose, n as info, o as success, r as logVerbose, t as danger } from "./globals-dovsmtt4.js";
import { r as logInfo } from "./logger-BDhhZXxv.js";
...
import { i as recordSessionMetaFromInbound, s as updateLastRoute, x as resolveGroupSessionKey } from "./store-ZWCZ_LZI.js";
import { u as resolveStorePath } from "./paths-DgoT9gfU.js";
import { t as loadSessionStore } from "./store-load-DlllQPOX.js";
import { a as resolveIdentityNamePrefix, o as resolveMessagePrefix } from "./identity-D_zFlCIB.js";
import { n as sleepWithAbort, t as computeBackoff } from "./backoff-B9kdzMlx.js";
import { c as resolveTextChunkLimit, i as chunkMarkdownTextWithMode, s as resolveChunkMode } from "./chunk-BRF5Bnyz.js";
import { d as resolveOutboundMediaUrls, h as sendMediaWithLeadingCaption, p as resolveSendableOutboundReplyParts } from "./reply-payload-CPJQ0UIg.js";
...
import { n as drainPendingDeliveries } from "./delivery-queue-wYNXw79t.js";
import { r as formatDurationPrecise } from "./format-duration-DEtUcYVv.js";
import { l as saveMediaBuffer } from "./store-dly0-xmm.js";
import { t as loadWebMedia } from "./web-media-DqvsPtjN.js";
import { a as resolveInboundLastRouteSessionKey, i as resolveAgentRoute, n as deriveLastRoutePolicy, t as buildAgentSessionKey } from "./resolve-route-BWZgM2t0.js";
import { t as convertMarkdownTables } from "./tables-Db4fYWlm.js";
import "./text-runtime-dYMrRdFH.js";
import "./core-D3WJPvNW.js";
import "./routing-DSl48EkU.js";
import { i as shouldComputeCommandAuthorized, t as hasControlCommand } from "./command-detection-sjcr0KU4.js";
import { t as finalizeInboundContext } from "./inbound-context-xUb6mT6i.js";
import { r as formatInboundEnvelope } from "./envelope-jjsUhYyN.js";
import { n as resolveInboundDebounceMs, t as createInboundDebouncer } from "./inbound-debounce-CCzo2l46.js";
import { a as normalizeMentionText, n as buildMentionRegexes } from "./mentions-BBGX5kEf.js";
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./provider-dispatcher-RhkgL42J.js";
import { r as shouldAckReactionForWhatsApp } from "./ack-reactions-CW4w1AXt.js";
...
import { a as resolveDmGroupAccessWithCommandGate, c as resolvePinnedMainDmOwnerFromAllowlist, n as readStoreAllowFromForDmPolicy } from "./dm-policy-shared-1zVsdEGf.js";
import { r as buildHistoryContextFromEntries, u as recordPendingHistoryEntryIfEnabled } from "./history-CIfU7bDI.js";
...
import { n as filterSupplementalContextItems, t as evaluateSupplementalContextVisibility } from "./context-visibility-Ccoaoyrv.js";
import { t as resolveChannelContextVisibilityMode } from "./context-visibility-BFfgNy9z.js";
import "./config-runtime-MrY1WAZr.js";
import { n as parseActivationCommand, t as normalizeGroupActivation } from "./group-activation-DqNpcGuz.js";
...
import { t as waitForever } from "./wait-BLA-e14P.js";
import "./cli-runtime-6pBuCe6V.js";
import "./markdown-table-runtime-CYKJKCIV.js";
import "./command-detection-NeYLST0X.js";
import "./channel-feedback-BUm9r02v.js";
import "./channel-inbound-DKgmBCwM.js";
import { n as toLocationContext, t as formatLocationText } from "./location-DBQg_X--.js";
import { t as resolveInboundSessionEnvelopeContext } from "./session-envelope-DGbePjFG.js";
import { l as resolveWhatsAppMediaMaxBytes, s as resolveWhatsAppAccount } from "./accounts-DQOrlwDd.js";
import { t as resolveWhatsAppReactionLevel } from "./reaction-level-CvyGPFyo.js";
import { i as setActiveWebListener } from "./active-listener-wQ1RTOW8.js";
import { r as sendReactionWhatsApp } from "./send-BetGDxsT.js";
import { a as resolveJidToE164, i as markdownToWhatsApp, n as isSelfChatMode, o as toWhatsappJid, r as jidToE164 } from "./text-runtime-CkBBYW0q.js";
import { _ as getSenderIdentity, c as readWebSelfId, f as getComparableIdentityValues, g as getSelfIdentity, h as getReplyContext, i as logoutWeb, l as readWebSelfIdentity, m as getPrimaryIdentityId, n as getWebAuthAgeMs, p as getMentionIdentities, v as identitiesOverlap, y as resolveComparableIdentity } from "./auth-store-BBSydNqh.js";
import { n as checkInboundAccessControl } from "./access-control-C8AjijUp.js";
import { n as getStatusCode, t as formatError } from "./session-errors-DeXUQ7Ri.js";
import { a as waitForWaConnection, c as getContentType, d as DisconnectReason, i as waitForCredsSaveQueueWithTimeout, l as normalizeMessageContent, o as downloadMediaMessage, s as extractMessageContent, t as createWaSocket, u as isJidGroup } from "./session-C8ztR8KW.js";
...
async function monitorWebInbox(options) {
	...
	const sendTrackedMessage = async (jid, content) => {
		...
		for (let attempt = 1;; attempt++) {
			...
			logVerbose(`Waiting ${delayMs}ms for WhatsApp reconnect before retrying send to ${jid}: ${formatError(lastErr)}`);
			try {
...
async function resolveWhatsAppCommandAuthorized(params) {
	...
	return resolveDmGroupAccessWithCommandGate({
		...
		isSenderAllowed: (allowEntries) => {
			...
			return allowEntries.map((entry) => normalizeE164(entry)).filter((entry) => Boolean(entry)).includes(senderE164);
		},
		command: {
			useAccessGroups,
...
function loadReplyResolverRuntime() {
	replyResolverRuntimePromise ??= import("./reply-resolver.runtime-B09R0X_r.js");
...
async function monitorWebChannel(verbose, listenerFactory = monitorWebInbox, keepAlive = true, replyResolver, runtime = defaultRuntime, abortSignal, tuning = {}) {
	...
	const stopDisconnectRetries = () => {
		if (!disconnectRetryController.signal.aborted) disconnectRetryController.abort();
	};
	if (abortSignal) if (abortSignal.aborted) stopDisconnectRetries();
	else abortSignal.addEventListener("abort", stopDisconnectRetries, { once: true });
	while (true) {
		...
		const listener = await (listenerFactory ?? monitorWebInbox)({
			...
			shouldDebounce,
			socketRef,
			shouldRetryDisconnect: () => keepAlive && !sigintStop && !stopRequested() && !disconnectRetryController.signal.aborted,
