import { a as normalizePluginsConfig, o as resolveEffectiveEnableState } from "./config-state-HDtzsRYk.js";
import "./browser-config-runtime-B2e1AJVp.js";
import { o as stopOpenClawChrome } from "./chrome-By1kRNZR.js";
import { n as listKnownProfileNames, t as createBrowserRouteContext } from "./server-context-KfDEoq8U.js";
import { t as isPwAiLoaded } from "./pw-ai-state-DODbEgn4.js";
...
async function stopBrowserRuntime(params) {
	...
	try {
		await (await import("./pw-ai-CmXkxvEq.js")).closePlaywrightBrowserConnection();
	} catch {}
}
//#endregion
