...
import { a as formatExecSecretRefIdValidationMessage, l as resolveDefaultSecretProviderAlias, o as isValidExecSecretRefId, s as isValidFileSecretRefId } from "./ref-contract-DOTysgVz.js";
import { t as getProviderEnvVars } from "./provider-env-vars-CJ5VQ_ih.js";
import { t as encodeJsonPointerToken } from "./json-pointer-D83GSoyh.js";
//#region src/plugins/provider-auth-ref.ts
let secretResolvePromise;
function loadSecretResolve() {
	secretResolvePromise ??= import("./resolve-D32czgWk.js");
...
function resolveDefaultProviderEnvVar(provider) {
	return getProviderEnvVars(provider)?.find((candidate) => normalizeOptionalString(candidate) !== void 0);
}
