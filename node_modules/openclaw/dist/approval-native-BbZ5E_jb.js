...
import { n as createApproverRestrictedNativeApprovalCapability } from "./approval-delivery-helpers-00R4J51h.js";
...
import { n as listDiscordAccountIds, o as resolveDiscordAccount } from "./accounts-CqTJGEO5.js";
import { a as isDiscordExecApprovalClientEnabled, i as isDiscordExecApprovalApprover, n as shouldHandleDiscordApprovalRequest, r as getDiscordExecApprovalApprovers } from "./ui-B5rth_NL.js";
...
function createDiscordApprovalCapability(configOverride) {
	return createApproverRestrictedNativeApprovalCapability({
		...
		nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
			...
			load: async () => (await import("./approval-handler.runtime-DN8MgGsY.js")).discordApprovalNativeRuntime
		})
	});
}
