...
import { C as createEmptyPluginRegistry } from "./runtime-BrxjAC6F.js";
import { i as openBoundaryFileSync } from "./boundary-file-read-wXLXKYbz.js";
import { b as truncateUtf16Safe } from "./utils-Supr9KvU.js";
import { n as PLUGIN_MANIFEST_FILENAME } from "./manifest-C9aID5PE.js";
import { o as discoverOpenClawPlugins } from "./ids-BSkPonH4.js";
import { t as createSubsystemLogger } from "./subsystem-DX_oTata.js";
import { i as resolveManifestContractPluginIds, n as loadPluginManifestRegistry } from "./manifest-registry-_lSkajSy.js";
import { g as shouldPreferNativeJiti, l as resolveLoaderPackageRoot, n as buildPluginLoaderJitiOptions, t as buildPluginLoaderAliasMap } from "./sdk-alias-Pc_bYsyi.js";
import { c as resolveBundledPluginScanDir, i as resolveBundledPluginRepoEntryPath, s as normalizeBundledPluginStringList } from "./bundled-plugin-metadata-A29NoUcJ.js";
import { i as normalizeChannelId, t as getChannelPlugin } from "./registry-FZxml0NK.js";
import { n as withBundledPluginEnablementCompat, r as withBundledPluginVitestCompat } from "./bundled-compat-UbHjJ4bk.js";
import { p as inspectProviderToolSchemasWithPlugin, v as normalizeProviderToolSchemasWithPlugin } from "./provider-runtime-CVZlG3kK.js";
import "./plugins-BUdv0ZMS.js";
import { s as joinPresentTextSegments } from "./hook-runner-global-DG7fawz5.js";
import { n as normalizeStructuredPromptSection } from "./prompt-cache-stability-BZRcxqbl.js";
import { l as normalizeToolName } from "./tool-policy-Pf1EE_aO.js";
import { t as log$1 } from "./logger-Qw1xQQHw.js";
import { S as splitMediaFromOutput } from "./deliver-BA26RCnu.js";
import { c as normalizeTargetForProvider } from "./reply-payloads-dedupe-wI9J6mgA.js";
import { n as createCapturedPluginRegistration } from "./captured-registration-Ct3VDfiu.js";
...
//#endregion
export { isMessagingToolSendAction as _, shouldUseOpenAIWebSocketTransport as a, resolveEmbeddedAgentHarnessFallback as b, extractMessagingToolSend as c, extractToolResultText as d, filterToolResultMediaUrls as f, isMessagingTool as g, sanitizeToolResult as h, resolveAttemptSpawnWorkspaceDir as i, extractToolErrorMessage as l, isToolResultTimedOut as m, appendAttemptCacheTtlIfNeeded as n, logProviderToolSchemaDiagnostics as o, isToolResultError as p, composeSystemPromptWithHookContext as r, normalizeProviderToolSchemas as s, buildEmbeddedAttemptToolRunContext as t, extractToolResultMediaArtifact as u, supportsModelTools as v, resolveEmbeddedAgentRuntime as x, normalizeEmbeddedAgentRuntime as y };
