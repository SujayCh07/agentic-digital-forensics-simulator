...
import { a as warnMissingProviderGroupPolicyFallbackOnce, r as resolveDefaultGroupPolicy } from "./runtime-group-policy-Beg3nTTB.js";
...
import { i as resolveDirectDmAuthorizationOutcome, o as resolveSenderCommandAuthorizationWithRuntime } from "./command-auth-CcDSi1HK.js";
import { n as isZaloSenderAllowed, t as evaluateZaloGroupAccess } from "./group-access-CMvgdCUD.js";
import { t as getZaloRuntime } from "./runtime-api-CygH1_k-.js";
import { a as getUpdates, c as sendMessage, l as sendPhoto, n as ZaloApiError, o as getWebhookInfo, r as deleteWebhook, s as sendChatAction, t as resolveZaloProxyFetch, u as setWebhook } from "./proxy-DaVDIPai.js";
...
async function handleZaloWebhookRequest(req, res) {
	const { handleZaloWebhookRequest: handleZaloWebhookRequestInternal } = await import("./monitor.webhook-BAsKOA6F.js");
...
async function monitorZaloProvider(options) {
	...
	try {
		if (useWebhook) {
			const { registerZaloWebhookTarget } = await import("./monitor.webhook-BAsKOA6F.js");
