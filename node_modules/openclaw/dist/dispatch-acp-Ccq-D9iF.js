...
import { s as hasOutboundReplyContent } from "./reply-payload-CPJQ0UIg.js";
import { n as formatToolSummary, r as resolveToolDisplay } from "./tool-display-BDGfIi1u.js";
...
import { r as prefixSystemMessage } from "./system-message-CJoOk1Kx.js";
import { i as toAcpRuntimeError } from "./errors-B33qztHf.js";
import { o as isSessionIdentityPending, u as resolveSessionIdentityFromMeta } from "./session-identity-CanMpoIH.js";
import { t as resolveConfiguredTtsMode } from "./tts-config-DfPFlPQ7.js";
import { r as resolveEffectiveBlockStreamingConfig, t as clampPositiveInteger } from "./block-streaming-CyJSEHOB.js";
import { n as resolveAcpAgentPolicyError, r as resolveAcpDispatchPolicyError } from "./policy-CENSbKYp.js";
import { r as resolveAcpThreadSessionDetailLines } from "./session-identifiers-CWL0Svf1.js";
import { t as formatAcpRuntimeErrorText } from "./error-text-DN9e5vqE.js";
import { r as createBlockReplyPipeline } from "./block-reply-pipeline-BAvUPqlF.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-CqllE8kS.js";
...
function loadDispatchAcpMediaRuntime() {
	dispatchAcpMediaRuntimePromise ??= import("./dispatch-acp-media.runtime-e1tVkRn-.js");
...
async function resolveAcpAttachments(params) {
	...
	const mediaAttachments = runtime.normalizeAttachments(params.ctx).map((attachment) => normalizeOptionalString(attachment.path) ? {
		...attachment,
		url: void 0
	} : attachment);
...
function loadDispatchAcpTtsRuntime$1() {
	dispatchAcpTtsRuntimePromise$1 ??= import("./dispatch-acp-tts.runtime-D0PyPzLw.js");
	return dispatchAcpTtsRuntimePromise$1;
}
function loadChannelPluginRuntime() {
	channelPluginRuntimePromise ??= import("./plugins-w8dw43re.js");
	return channelPluginRuntimePromise;
}
function loadMessageActionRuntime() {
	messageActionRuntimePromise ??= import("./message-action-runner-B8PfJJtC.js");
...
async function shouldTreatDeliveredTextAsVisible(params) {
	...
	if (!params.routed) return channelId === "telegram";
	return false;
}
...
function loadDispatchAcpManagerRuntime() {
	dispatchAcpManagerRuntimePromise ??= import("./dispatch-acp-manager.runtime-B7ZdzH2v.js");
	return dispatchAcpManagerRuntimePromise;
}
function loadDispatchAcpSessionRuntime() {
	dispatchAcpSessionRuntimePromise ??= import("./dispatch-acp-session.runtime-XD3M4E_L.js");
	return dispatchAcpSessionRuntimePromise;
}
function loadDispatchAcpTtsRuntime() {
	dispatchAcpTtsRuntimePromise ??= import("./dispatch-acp-tts.runtime-D0PyPzLw.js");
