...
import { n as isGatewayConfigBypassCommandPath } from "./explicit-connection-policy-6N8wk3re.js";
import { n as resolvePluginRegistryScopeForCommandPath, t as ensureCliPluginRegistryLoaded } from "./plugin-registry-loader-BNc5xeM8.js";
//#region src/cli/command-bootstrap.ts
let configGuardModulePromise;
function loadConfigGuardModule() {
	configGuardModulePromise ??= import("./config-guard-CXdratrj.js");
...
async function applyCliExecutionStartupPresentation(params) {
	...
	const { emitCliBanner } = await import("./banner-CPmxtjkO.js");
	if (params.argv) {
