...
import { t as require_src } from "./src-Ds7WWpUN.js";
import { n as fromStream, r as fromBuffer, t as fromFile } from "./lib-Pp7u46ga.js";
import { n as TrackType, r as TrackTypeValueToKeyMap } from "./types-3Jpkz-CQ.js";
import { C as UINT32_LE, a as UnsupportedFileTypeError, i as InternalParserError, k as textDecode, n as CouldNotDetermineFileTypeError } from "./BasicParser-CTLUeI6Y.js";
import { l as toRatio, n as decodeString } from "./Util-CGQKPCHg.js";
import { c as TimestampFormat, i as LyricsContentType } from "./ID3v2Token-C8r0LeuQ.js";
import { t as APEv2Parser } from "./APEv2Parser-BJCOIIcJ.js";
import { r as hasID3v1Header } from "./ID3v1Parser-CPlp2whO.js";
...
const mpegParserLoader = {
	...
	async load() {
		return (await import("./MpegParser-uqIjJVtu.js")).MpegParser;
	}
};
//#endregion
...
const apeParserLoader = {
	...
	async load() {
		return (await import("./APEv2Parser-DnZCrqEV.js")).APEv2Parser;
	}
};
//#endregion
...
const asfParserLoader = {
	...
	async load() {
		return (await import("./AsfParser-DeVqhiVE.js")).AsfParser;
	}
};
//#endregion
...
const dsdiffParserLoader = {
	...
	async load() {
		return (await import("./DsdiffParser-DeswA61l.js")).DsdiffParser;
	}
};
//#endregion
...
const aiffParserLoader = {
	...
	async load() {
		return (await import("./AiffParser-C3bKrYYy.js")).AIFFParser;
	}
};
//#endregion
...
const dsfParserLoader = {
	...
	mimeTypes: ["audio/dsf"],
	async load() {
		return (await import("./DsfParser-ChQ6WWbd.js")).DsfParser;
	}
};
//#endregion
...
const flacParserLoader = {
	...
	async load() {
		return (await import("./FlacParser-mxCiHeje.js")).FlacParser;
	}
};
//#endregion
...
const matroskaParserLoader = {
	...
	async load() {
		return (await import("./MatroskaParser--qX0uyW_.js")).MatroskaParser;
	}
};
//#endregion
...
const mp4ParserLoader = {
	...
	async load() {
		return (await import("./MP4Parser-tYgbMzuh.js")).MP4Parser;
	}
};
//#endregion
...
const musepackParserLoader = {
	...
	async load() {
		return (await import("./MusepackParser-CYs6Q3IH.js")).MusepackParser;
	}
};
//#endregion
...
const oggParserLoader = {
	...
	async load() {
		return (await import("./OggParser-DmxVy_t4.js")).OggParser;
	}
};
//#endregion
...
const wavpackParserLoader = {
	...
	async load() {
		return (await import("./WavPackParser-Dvf4ru0W.js")).WavPackParser;
	}
};
//#endregion
...
const riffParserLoader = {
	...
	async load() {
		return (await import("./WaveParser-BcARJbQq.js")).WaveParser;
	}
};
//#endregion
