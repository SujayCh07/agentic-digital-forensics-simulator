...
import { s as resolveMergedAccountConfig } from "./account-helpers-B1xr09mz.js";
...
import { h as normalizeFeishuTarget } from "./drive-BTo4aGMu.js";
...
function normalizeFeishuAllowEntry(raw) {
	...
	return normalizeOptionalLowercaseString(normalizeFeishuTarget(withoutProviderPrefix) ?? withoutProviderPrefix) ?? "";
}
