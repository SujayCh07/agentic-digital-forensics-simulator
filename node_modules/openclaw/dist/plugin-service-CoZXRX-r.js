...
import { n as info, t as danger } from "./globals-dovsmtt4.js";
import { a as loadConfig } from "./io-BxA9F2P4.js";
import { t as formatCliCommand } from "./command-format-Ct8eiFod.js";
import { dn as ErrorCodes, fn as errorShape } from "./method-scopes-Cgh_6px_.js";
import { t as parseBooleanValue } from "./boolean-DO8VExbb.js";
import { c as jsonResult, h as readStringParam, s as imageResultFromFile } from "./common-ub5s4Xdi.js";
import { t as callGatewayTool } from "./gateway-BRUlEFvm.js";
import { a as selectDefaultNodeFromList, i as resolveNodeIdFromList, t as listNodes } from "./nodes-utils-VlNTLqBf.js";
import { i as stringEnum, r as optionalStringEnum } from "./typebox-SqwBJCFe.js";
import { s as wrapExternalContent } from "./external-content-DZdKqcfx.js";
import "./text-runtime-dYMrRdFH.js";
import { t as startLazyPluginServiceModule } from "./lazy-service-module-CJYq7qVi.js";
import "./browser-config-runtime-B2e1AJVp.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-CZqo2-ji.js";
import { n as runCommandWithRuntime } from "./cli-utils-CUiAJaWR.js";
import { i as resolveNodeCommandAllowlist, n as isNodeCommandAllowed } from "./node-command-policy-CZnSinzk.js";
import { a as respondUnavailableOnNodeInvokeError, s as safeParseJson } from "./startup-auth-CzulTTBe.js";
import "./browser-node-runtime-uhg_sLaE.js";
...
import { b as normalizeBrowserFormField, x as normalizeBrowserFormFieldValue } from "./chrome-By1kRNZR.js";
import { d as resolveExistingPathsWithinRoot, n as DEFAULT_AI_SNAPSHOT_MAX_CHARS, u as DEFAULT_UPLOAD_DIR } from "./utils-BVQDKN-C.js";
import { d as redactCdpUrl } from "./cdp.helpers-WDYKRNDl.js";
import { i as getBrowserProfileCapabilities } from "./server-context-KfDEoq8U.js";
import { n as resolveProfile, t as resolveBrowserConfig } from "./config-BEm9-1TI.js";
import { c as browserPdfSave, d as browserArmFileChooser, f as browserNavigate, i as isPersistentBrowserProfileMutation, l as browserAct, n as persistBrowserProxyFiles, o as resolveRequestedBrowserProfile, p as browserScreenshotAction, s as browserConsoleMessages, t as applyBrowserProxyPaths, u as browserArmDialog } from "./browser-runtime-WGOhoMU8.js";
import { c as browserOpenTab, d as browserSnapshot, f as browserStart, g as browserTabs, i as browserCloseTab, l as browserProfiles, m as browserStop, n as trackSessionBrowserTab, p as browserStatus, r as untrackSessionBrowserTab, s as browserFocusTab } from "./session-tab-registry-2UpksU_m.js";
import { a as createBrowserRouteDispatcher, r as startBrowserControlServiceFromConfig, t as createBrowserControlContext } from "./control-service-DPYPR6A0.js";
	...
	return {
		...
		start: async () => {
			...
			handle = await startLazyPluginServiceModule({
				...
				loadDefaultModule: async () => await import("./server-C1bVcxLK.js"),
