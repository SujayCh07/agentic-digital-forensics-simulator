...
import { r as stripAnsi, t as sanitizeForLog } from "./ansi-B_y-Sue5.js";
import { t as createSubsystemLogger } from "./subsystem-DX_oTata.js";
import { f as resolveThinkingDefaultForModel } from "./thinking.shared-CqTfMucU.js";
...
import { d as resolveAgentModelFallbacksOverride, i as resolveAgentConfig, o as resolveAgentEffectiveModelPrimary } from "./agent-scope-BfV3ML7Z.js";
import { n as DEFAULT_MODEL, r as DEFAULT_PROVIDER } from "./defaults-CF547YAW.js";
import { n as normalizeStaticProviderModelId, t as modelKey$1 } from "./model-ref-shared-D0K7lruf.js";
...
function loadPluginRuntime() {
	...
	for (const candidate of RUNTIME_MODULE_CANDIDATES) try {
		pluginRuntimeModule = require$2(candidate);
...
function resolveBundledSetupCliBackends() {
	...
	bundledSetupCliBackendsCache = loadPluginManifestRegistry({ cache: true }).plugins.filter((plugin) => plugin.origin === "bundled" && plugin.cliBackends.length > 0).flatMap((plugin) => plugin.cliBackends.map((backendId) => ({
		pluginId: plugin.id,
...
function loadSetupRegistryRuntime() {
	if (setupRegistryRuntimeModule) return setupRegistryRuntimeModule;
	for (const candidate of SETUP_REGISTRY_RUNTIME_CANDIDATES) try {
		setupRegistryRuntimeModule = require$1(candidate);
...
//#endregion
export { legacyModelKey as C, splitTrailingAuthProfile as D, parseModelRef as E, resolveConfiguredProviderFallback as O, resolveThinkingDefault as S, normalizeModelRef as T, resolvePersistedOverrideModelRef as _, getModelRefStatus as a, resolveSubagentConfiguredModelSelection as b, normalizeModelSelection as c, resolveAllowlistModelKey as d, resolveConfiguredModelRef as f, resolvePersistedModelRef as g, resolveModelRefFromString as h, buildModelAliasIndex as i, resolveRuntimeCliBackends as k, normalizeStoredOverrideModel as l, resolveHooksGmailModel as m, buildConfiguredAllowlistKeys as n, inferUniqueProviderFromConfiguredModels as o, resolveDefaultModelForAgent as p, buildConfiguredModelCatalog as r, isCliProvider as s, buildAllowedModelSet as t, resolveAllowedModelRef as u, resolvePersistedSelectedModelRef as v, modelKey as w, resolveSubagentSpawnModelSelection as x, resolveReasoningDefault as y };
