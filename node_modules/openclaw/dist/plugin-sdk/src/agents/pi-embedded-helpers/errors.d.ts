...
export type ProviderRuntimeFailureKind = "auth_scope" | "auth_refresh" | "auth_html_403" | "proxy" | "rate_limit" | "dns" | "timeout" | "schema" | "sandbox_blocked" | "replay_invalid" | "unknown";
