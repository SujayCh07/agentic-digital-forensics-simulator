...
import { a as require_axios, i as require_logging, n as require_lib$2, r as require_http$2, t as require_dist$3 } from "./dist-C1xJX2Vg.js";
import { t as require_jsonwebtoken } from "./jsonwebtoken-Dv8MKwZ1.js";
import { t as require_src } from "./src-DcqrhfTY.js";
...
var require_dist$1 = /* @__PURE__ */ __commonJSMin(((exports) => {
	var i = require_http$2(), y = require_lib$2();
	...
	function f(n, t, e) {
		...
		return `${n}${y__default.default.stringify(r, {
			addQueryPrefix: true,
			arrayFormat: "comma"
		})}`;
	}
	...
	var b = "https://graph.microsoft.com", u = class {
		baseUrlRoot;
		_http;
		betaHttp;
		get http() {
		...
		constructor(t) {
			this.baseUrlRoot = t?.baseUrlRoot ?? b, t ? "request" in t ? this._http = t.clone({
				baseUrl: `${this.baseUrlRoot}/v1.0`,
				headers: {
					"Content-Type": "application/json",
					"User-Agent": "teams.ts[graph]/0.0.0"
				}
			}) : this._http = new i__namespace.Client({
				...t,
				baseUrl: `${this.baseUrlRoot}/v1.0`,
				headers: {
					"Content-Type": "application/json",
		...
		async call(t, ...e) {
			let r = e[e.length - 1], s = e.length > t.length && r && typeof r == "object" && "requestConfig" in r, o = s ? e.slice(0, -1) : e, R = s ? r : void 0, { ver: g = "v1.0", method: a, path: _, paramDefs: p = {}, params: h = {}, body: C } = t(...o), c = f(_, p, h), l = m(p, h, R?.requestConfig), d = this.getHttpClient(g);
			switch (a) {
				case "delete":
				case "get": return (await d[a](c, l)).data;
				case "patch":
				case "post":
				case "put": return (await d[a](c, C, l)).data;
